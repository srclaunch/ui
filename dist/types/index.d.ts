...
export type { BorderColor, BorderDirectionProps, BorderProps, BorderRadiusCornerProps, BorderStyleProps, } from './appearance/border';
export { BorderColors, BorderColorShade, BorderStyle, } from './appearance/border';
export type { BoxShadow, BoxShadowDetails, BoxShadowProps, } from './appearance/box-shadow';
...
export type { DimensionProps, DimensionValue, HeightProps, WidthProps, } from './appearance/dimension';
...
export { TextColors, TextOverflow, TextSize, TextWeight, WhiteSpace, } from './typography/text';
