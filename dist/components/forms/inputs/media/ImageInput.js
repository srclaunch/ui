...
export const ImageInput = memo(({ backgroundColor = BackgroundColors.InputControl, border = {
    ...
    return (_jsxs(_Fragment, { children: [(label || problems.length > 0) && (_jsxs(InputLabel, { error: problems, children: [label, maxImages > 1 && ` (${previewImages.length} of ${maxImages})`] }, void 0)), _jsx(Container, { alignItems: Align.Center, alignContent: Align.Center, backgroundColor: isDragActive ? BackgroundColors.Darker : backgroundColor, border: {
                    ...border,
                    // @ts-ignore
                    color: problems && Array.isArray(problems) && problems.length > 0
                        ...
                        : // @ts-ignore
                            border?.color,
                }, borderRadius: borderRadius, boxShadow: DepthShadow.Low, grow: false, padding: padding, ...rootProps, children: _jsx(Container, { grow: false, children: _jsxs(Container, { alignItems: Align.Center, alignContent: Align.Center, grow: false, padding: Amount.Default, paddingTop: Amount.Least, children: [_jsx("input", { name: name, ...inputProps }, void 0), errorMessage && _jsx(ErrorLabel, { children: errorMessage }, void 0), previewImages && previewImages.length > 0 ? (_jsx(Container, { alignItems: Align.Stretch, 
                                // events={!isDragActive}
                                grow: false, marginBottom: Amount.Less, children: _jsx(Container, { alignItems: Align.Stretch, alignContent: Align.Center, backgroundColor: BackgroundColors.Lightest, borderRadius: Amount.Least, lineWrap: true, opacity: isDragActive ? 50 : 100, orientation: Orientation.Horizontal, paddingBottom: Amount.Least, paddingLeft: Amount.Least, paddingRight: Amount.Least, paddingTop: Amount.Least, children: previewImages.map((image, index) => (_jsxs(Container, { grow: false, marginBottom: Amount.Least, marginLeft: Amount.Least, marginRight: Amount.Least, marginTop: Amount.Least, children: [_jsx(CloseButton, { onClick: () => {
