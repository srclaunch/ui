...
export const LinearGauge = memo(({ amount, color, formatter, showTicks = true, showTickLabels = true, showValue = true, tickCount = 5, total, }) => {
    ...
    return (_jsxs(Container, { children: [showTicks && (_jsxs(Container, { orientation: Orientation.Horizontal, children: [showValue && (_jsx(Container, { border: {
                            ...
                            position: 'absolute',
                            top: '-3px',
                        }, children: _jsx(Text, { alignText: Align.Center, lineHeight: Amount.None, textColor: color, textSize: TextSize.Small, textWeight: TextWeight.More, style: {
                        ...
                        return (_jsx(Container, { border: {
                            ...
                            }, height: 6, children: showTickLabels && (_jsx(Text, { alignText: Align.Left, textColor: amount >= tickValue ? color : TextColors.Dark, textSize: TextSize.Smallest, textWeight: TextWeight.More, style: {
                                    position: 'absolute',
