...
export const Title = memo(({ as = 'h1', children, className = '', lineHeight = Size.Small, textSize = TextSize.Larger, textColor = TextColors.Title, textWeight = TextWeight.Most, ...props }) => {
    return (_jsx(Text, { as: as, className: `${className} title`, inline: false, textColor: textColor, lineHeight: lineHeight, textSize: textSize, textWeight: textWeight, ...props, children: children }, void 0));
});
