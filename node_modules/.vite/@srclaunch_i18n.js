...
function getLocale() {
  ...
  locale = global.navigator && (global.navigator.languages && global.navigator.languages[0] || global.navigator.language || global.navigator.userLanguage);
  ...
  if (!locale) {
    locale = (global.clientInformation || /* @__PURE__ */ Object.create(null)).language;
  }
  if (!locale) {
