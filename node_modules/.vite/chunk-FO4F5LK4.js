...
// node_modules/@srclaunch/themes/dist/index.js
...
var ThemeProvider = (0, import_react.memo)(({
  className = "",
  children,
  theme,
  themes
  ...
  var _a;
  const [currentTheme, setTheme] = (0, import_react.useState)((_a = themes == null ? void 0 : themes.find((t) => t.id === theme)) != null ? _a : AppLabLightTheme);
  ...
  return jsxs("div", {
    ...
    children: [jsx(GlobalStyle, {
      theme: currentTheme
    }), children]
  });
});
var GlobalStyle = We(["", ";"], (props) => props.theme.css);
 ...
 */
//# sourceMappingURL=chunk-FO4F5LK4.js.map
