...
// dep:@srclaunch_validation
init_define_global();

// node_modules/@srclaunch/validation/dist/index.js
init_define_global();
...
var mi = (a, l, c) => l in a ? P(a, l, { enumerable: true, configurable: true, writable: true, value: c }) : a[l] = c;
var oi = (a) => P(a, "__esModule", { value: true });
var U = (a, l) => () => (l || a((l = { exports: {} }).exports, l), l.exports);
var ci = (a, l, c, A) => {
  if (l && typeof l == "object" || typeof l == "function")
    for (let o of ri(l))
      !li.call(a, o) && (c || o !== "default") && P(a, o, { get: () => l[o], enumerable: !(A = ui(l, o)) || A.enumerable });
  return a;
};
var L = (a, l) => ci(oi(P(a != null ? si(ti(a)) : {}, "default", !l && a && a.__esModule ? { get: () => a.default, enumerable: true } : { value: a, enumerable: true })), a);
var h = (a, l, c) => (mi(a, typeof l != "symbol" ? l + "" : l, c), c);
var Ge = U((qe) => {
  "use strict";
...
var xe = U((A_, Ke) => {
  ...
  function B(a, l) {
    if (l && l > 1) {
      let c = parseInt(l, 10);
      return new RegExp(a + "{" + c + ",}").test(this.password) === this.positive;
    }
    return new RegExp(a).test(this.password) === this.positive;
  }
  Ke.exports = { not: function(l) {
    return this.positive = false, l ? B.call(this, l) : true;
  }, has: function(l) {
    return this.positive = true, l ? B.call(this, l) : true;
  }, is: function() {
    return this.positive = true, true;
  }, min: function(l) {
    return this.password.length >= l;
  }, max: function(l) {
    return this.password.length <= l;
  }, digits: function(l) {
    return B.call(this, M.digits, l);
  }, letters: function(l) {
    return B.call(this, M.letters, l);
  }, uppercase: function(l) {
    if (l && l > 1) {
      let c = 0, A = 0;
      for (; A < l && c < this.password.length; ) {
        let o = this.password.charAt(c);
        o !== o.toLowerCase() && A++, c++;
      }
      return A === l === this.positive;
    }
    ...
    return B.call(this, M.symbols, l);
  }, spaces: function(l) {
    return B.call(this, M.spaces, l);
  }, oneOf: function(l) {
    return l.indexOf(this.password) >= 0 === this.positive;
  } };
});
var He = U((d_, Oe) => {
  Oe.exports = function(a, l, c) {
    let A = c ? gi : hi;
    return A[a] && A[a](l);
  };
  var hi = { min: (a) => `The string should have a minimum length of ${a} character${f(a)}`, max: (a) => `The string should have a maximum length of ${a} character${f(a)}`, letters: (a = 1) => `The string should have a minimum of ${a} letter${f(a)}`, digits: (a = 1) => `The string should have a minimum of ${a} digit${f(a)}`, uppercase: (a = 1) => `The string should have a minimum of ${a} uppercase letter${f(a)}`, lowercase: (a = 1) => `The string should have a minimum of ${a} lowercase letter${f(a)}`, symbols: (a = 1) => `The string should have a minimum of ${a} symbol${f(a)}`, spaces: (a = 1) => `The string should have a minimum of ${a} space${f(a)}`, oneOf: (a) => `The string should be ${a.length > 1 ? `one of ${a.slice(0, -1).join(", ")} and ` : ""}${a[a.length - 1]}`, has: (a) => `The string should have pattern '${a}'`, not: (a) => `The string should not have pattern '${a}'` }, gi = { min: (a) => `The string should have a maximum length of ${a} character${f(a)}`, max: (a) => `The string should have a minimum length of ${a} character${f(a)}`, letters: (a = 0) => `The string should ${a === 0 ? "not have" : `have a maximum of ${a}`} letter${f(a)}`, digits: (a = 0) => `The string should ${a === 0 ? "not have" : `have a maximum of ${a}`} digit${f(a)}`, uppercase: (a = 0) => `The string should ${a === 0 ? "not have" : `have a maximum of ${a}`} uppercase letter${f(a)}`, lowercase: (a = 0) => `The string should ${a === 0 ? "not have" : `have a maximum of ${a}`} lowercase letter${f(a)}`, symbols: (a = 0) => `The string should ${a === 0 ? "not have" : `have a maximum of ${a}`} symbol${f(a)}`, spaces: (a = 0) => `The string should ${a === 0 ? "not have" : `have a maximum of ${a}`} space${f(a)}`, oneOf: (a) => `The string should not be ${a.length > 1 ? `one of ${a.slice(0, -1).join(", ")} and ` : ""}${a[a.length - 1]}`, has: (a) => `The string should not have pattern '${a}'`, not: (a) => `The string should have pattern '${a}'` };
  function f(a) {
    return a === 1 ? "" : "s";
  }
});
var We = U((I_, ze) => {
  ...
  function _(a, l, c) {
    return this.properties.push({ method: a, arguments: l, description: c }), this;
  }
  var Ve = class {
    constructor() {
      this.properties = [];
    ...
    validate(l, c) {
      return this.list = Boolean(c && c.list), this.details = Boolean(c && c.details), this.password = String(l), this.positive = true, this.list || this.details ? this.properties.reduce((A, o) => {
        if (!je.call(this, o)) {
          var I = o.method;
          if (this.details) {
            I = { validation: o.method }, o.arguments && o.arguments[0] && (I.arguments = o.arguments[0]), !this.positive && o.method !== "not" && (I.inverted = true);
            var d = o.arguments && o.arguments[1], g = d || Ei(o.method, I.arguments, I.inverted);
            I.message = g;
          }
          return A.concat(I);
        }
    ...
    letters(l) {
      return l && S(l), _.call(this, "letters", arguments);
    }
    digits(l) {
      return l && S(l), _.call(this, "digits", arguments);
    }
    symbols(l) {
      return l && S(l), _.call(this, "symbols", arguments);
    }
    min(l) {
      return S(l), _.call(this, "min", arguments);
    }
    max(l) {
      return S(l), _.call(this, "max", arguments);
    }
    lowercase(l) {
      return l && S(l), _.call(this, "lowercase", arguments);
    }
    uppercase(l) {
      return l && S(l), _.call(this, "uppercase", arguments);
    }
    spaces(l) {
      return l && S(l), _.call(this, "spaces", arguments);
    }
    has() {
...
var ia;
(function(a) {
  a[a.IsHSLColor = i.IsHSLColor] = "IsHSLColor", a[a.IsHexColor = i.IsHexColor] = "IsHexColor", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsRGBColor = i.IsRGBColor] = "IsRGBColor", a[a.IsString = i.IsString] = "IsString";
})(ia || (ia = {}));
var na;
(function(a) {
  a[a.IsBetween = i.IsBetween] = "IsBetween", a[a.IsCurrency = i.IsCurrency] = "IsCurrency", a[a.IsDecimal = i.IsDecimal] = "IsDecimal", a[a.IsDivisibleBy = i.IsDivisibleBy] = "IsDivisibleBy", a[a.IsEvenNumber = i.IsEvenNumber] = "IsEvenNumber", a[a.IsFloat = i.IsFloat] = "IsFloat", a[a.IsGreaterThan = i.IsGreaterThan] = "IsGreaterThan", a[a.IsGreaterThanOrEqual = i.IsGreaterThanOrEqual] = "IsGreaterThanOrEqual", a[a.IsInteger = i.IsInteger] = "IsInteger", a[a.IsISO8601 = i.IsISO8601] = "IsISO8601", a[a.IsLessThan = i.IsLessThan] = "IsLessThan", a[a.IsLessThanOrEqual = i.IsLessThanOrEqual] = "IsLessThanOrEqual", a[a.IsNegativeNumber = i.IsNegativeNumber] = "IsNegativeNumber", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsNumber = i.IsNumber] = "IsNumber", a[a.IsOddNumber = i.IsOddNumber] = "IsOddNumber", a[a.IsPositiveNumber = i.IsPositiveNumber] = "IsPositiveNumber";
})(na || (na = {}));
var sa;
(function(a) {
  a[a.IsBitcoinAddress = i.IsBitcoinAddress] = "IsBitcoinAddress", a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotNull = i.IsNotNull] = "IsNotNull";
})(sa || (sa = {}));
var ua;
(function(a) {
  a[a.IsEthereumAddress = i.IsEthereumAddress] = "IsEthereumAddress", a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotNull = i.IsNotNull] = "IsNotNull";
})(ua || (ua = {}));
var ra;
(function(a) {
  a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsJSON = i.IsJSON] = "IsJSON", a[a.IsLanguage = i.IsLanguage] = "IsLanguage", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotNull = i.IsNotNull] = "IsNotNull";
})(ra || (ra = {}));
var ta;
(function(a) {
  a[a.IsAlpha = i.IsAlpha] = "IsAlpha", a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsInList = i.IsInList] = "IsInList", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotInList = i.IsNotInList] = "IsNotInList", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsString = i.IsString] = "IsString";
})(ta || (ta = {}));
var la;
(function(a) {
  a[a.IsAlpha = i.IsAlpha] = "IsAlpha", a[a.IsCountry = i.IsCountry] = "IsCountry", a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsInList = i.IsInList] = "IsInList", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotInList = i.IsNotInList] = "IsNotInList", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsString = i.IsString] = "IsString";
})(la || (la = {}));
var ma;
(function(a) {
  a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsFloat = i.IsFloat] = "IsFloat", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsNumeric = i.IsNumeric] = "IsNumeric";
})(ma || (ma = {}));
var oa;
(function(a) {
  a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsFloat = i.IsFloat] = "IsFloat", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsNumeric = i.IsNumeric] = "IsNumeric";
...
var ca;
(function(a) {
  a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsPostalCode = i.IsPostalCode] = "IsPostalCode", a[a.IsNotNull = i.IsNotNull] = "IsNotNull";
})(ca || (ca = {}));
var Aa;
(function(a) {
  a[a.IsAlpha = i.IsAlpha] = "IsAlpha", a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsInList = i.IsInList] = "IsInList", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotInList = i.IsNotInList] = "IsNotInList", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsProvince = i.IsProvince] = "IsProvince", a[a.IsString = i.IsString] = "IsString";
})(Aa || (Aa = {}));
var da;
(function(a) {
  a[a.IsAlpha = i.IsAlpha] = "IsAlpha", a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsInList = i.IsInList] = "IsInList", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotInList = i.IsNotInList] = "IsNotInList", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsState = i.IsState] = "IsState", a[a.IsString = i.IsString] = "IsString";
})(da || (da = {}));
var Ia;
(function(a) {
  a[a.IsAlphanumeric = i.IsAlphanumeric] = "IsAlphanumeric", a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsString = i.IsString] = "IsString", a[a.IsStreetAddress = i.IsStreetAddress] = "IsStreetAddress";
})(Ia || (Ia = {}));
var ha;
(function(a) {
  a[a.IsAirport = i.IsAirport] = "IsAirport", a[a.IsAlpha = i.IsAlpha] = "IsAlpha", a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsInList = i.IsInList] = "IsInList", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotInList = i.IsNotInList] = "IsNotInList", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsString = i.IsString] = "IsString";
})(ha || (ha = {}));
var ga;
(function(a) {
  a[a.IsAlgorithmHash = i.IsAlgorithmHash] = "IsAlgorithmHash", a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsInList = i.IsInList] = "IsInList", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotInList = i.IsNotInList] = "IsNotInList", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsString = i.IsString] = "IsString";
})(ga || (ga = {}));
var fa;
(function(a) {
  a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsInList = i.IsInList] = "IsInList", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotInList = i.IsNotInList] = "IsNotInList", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsSemanticVersion = i.IsSemanticVersion] = "IsSemanticVersion", a[a.IsString = i.IsString] = "IsString";
})(fa || (fa = {}));
var _a;
(function(a) {
  a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsInList = i.IsInList] = "IsInList", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotInList = i.IsNotInList] = "IsNotInList", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsString = i.IsString] = "IsString", a[a.IsUUID = i.IsUUID] = "IsUUID";
})(_a || (_a = {}));
var Ea;
(function(a) {
  a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsInList = i.IsInList] = "IsInList", a[a.IsMD5 = i.IsMD5] = "IsMD5", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotInList = i.IsNotInList] = "IsNotInList", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsString = i.IsString] = "IsString";
})(Ea || (Ea = {}));
var Sa;
(function(a) {
  a[a.IsBoolean = i.IsBoolean] = "IsBoolean", a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotNull = i.IsNotNull] = "IsNotNull";
})(Sa || (Sa = {}));
var Ta;
(function(a) {
  a[a.IsAfter = i.IsAfter] = "IsAfter", a[a.IsAfterOrEqual = i.IsAfterOrEqual] = "IsAfterOrEqual", a[a.IsBefore = i.IsBefore] = "IsBefore", a[a.IsBeforeOrEqual = i.IsBeforeOrEqual] = "IsBeforeOrEqual", a[a.IsBetween = i.IsBetween] = "IsBetween", a[a.IsDate = i.IsDate] = "IsDate", a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsNotDate = i.IsNotDate] = "IsNotDate", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsNotToday = i.IsNotToday] = "IsNotToday", a[a.IsThisWeek = i.IsThisWeek] = "IsThisWeek", a[a.IsThisMonth = i.IsThisMonth] = "IsThisMonth", a[a.IsThisQuarter = i.IsThisQuarter] = "IsThisQuarter", a[a.IsThisYear = i.IsThisYear] = "IsThisYear", a[a.IsToday = i.IsToday] = "IsToday", a[a.IsWeekend = i.IsWeekend] = "IsWeekend";
})(Ta || (Ta = {}));
var pa;
(function(a) {
  a[a.IsAfter = i.IsAfter] = "IsAfter", a[a.IsBefore = i.IsBefore] = "IsBefore", a[a.IsBeforeOrAfter = i.IsBeforeOrAfter] = "IsBeforeOrAfter", a[a.IsBetween = i.IsBetween] = "IsBetween", a[a.IsDate = i.IsDate] = "IsDate", a[a.IsDateRange = i.IsDateRange] = "IsDateRange", a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotNull = i.IsNotNull] = "IsNotNull";
})(pa || (pa = {}));
var ba;
(function(a) {
  a[a.IsAfter = i.IsAfter] = "IsAfter", a[a.IsAfterOrEqual = i.IsAfterOrEqual] = "IsAfterOrEqual", a[a.IsBefore = i.IsBefore] = "IsBefore", a[a.IsBeforeOrEqual = i.IsBeforeOrEqual] = "IsBeforeOrEqual", a[a.IsBetween = i.IsBetween] = "IsBetween", a[a.IsDate = i.IsDate] = "IsDate", a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsNotDate = i.IsNotDate] = "IsNotDate", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsNotToday = i.IsNotToday] = "IsNotToday", a[a.IsThisWeek = i.IsThisWeek] = "IsThisWeek", a[a.IsThisMonth = i.IsThisMonth] = "IsThisMonth", a[a.IsThisQuarter = i.IsThisQuarter] = "IsThisQuarter", a[a.IsThisYear = i.IsThisYear] = "IsThisYear", a[a.IsToday = i.IsToday] = "IsToday", a[a.IsWeekend = i.IsWeekend] = "IsWeekend";
...
var Pa;
(function(a) {
  a[a.IsAfter = i.IsAfter] = "IsAfter", a[a.IsAfterOrEqual = i.IsAfterOrEqual] = "IsAfterOrEqual", a[a.IsBefore = i.IsBefore] = "IsBefore", a[a.IsBeforeOrEqual = i.IsBeforeOrEqual] = "IsBeforeOrEqual", a[a.IsBetween = i.IsBetween] = "IsBetween", a[a.IsEvenNumber = i.IsEvenNumber] = "IsEvenNumber", a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsGreaterThan = i.IsGreaterThan] = "IsGreaterThan", a[a.IsGreaterThanOrEqual = i.IsGreaterThanOrEqual] = "IsGreaterThanOrEqual", a[a.IsLessThan = i.IsLessThan] = "IsLessThan", a[a.IsLessThanOrEqual = i.IsLessThanOrEqual] = "IsLessThanOrEqual", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsNumber = i.IsNumber] = "IsNumber", a[a.IsOddNumber = i.IsOddNumber] = "IsOddNumber", a[a.IsWeekday = i.IsWeekday] = "IsWeekday", a[a.IsWeekend = i.IsWeekend] = "IsWeekend";
})(Pa || (Pa = {}));
var ka;
(function(a) {
  a[a.IsAfter = i.IsAfter] = "IsAfter", a[a.IsAfterOrEqual = i.IsAfterOrEqual] = "IsAfterOrEqual", a[a.IsBefore = i.IsBefore] = "IsBefore", a[a.IsBeforeOrEqual = i.IsBeforeOrEqual] = "IsBeforeOrEqual", a[a.IsBetween = i.IsBetween] = "IsBetween", a[a.IsEvenNumber = i.IsEvenNumber] = "IsEvenNumber", a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsGreaterThan = i.IsGreaterThan] = "IsGreaterThan", a[a.IsGreaterThanOrEqual = i.IsGreaterThanOrEqual] = "IsGreaterThanOrEqual", a[a.IsInteger = i.IsInteger] = "IsInteger", a[a.IsLessThan = i.IsLessThan] = "IsLessThan", a[a.IsLessThanOrEqual = i.IsLessThanOrEqual] = "IsLessThanOrEqual", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsNumber = i.IsNumber] = "IsNumber", a[a.IsOddNumber = i.IsOddNumber] = "IsOddNumber", a[a.IsThisYear = i.IsThisYear] = "IsThisYear", a[a.IsYear = i.IsYear] = "IsYear";
})(ka || (ka = {}));
var Ma;
(function(a) {
  a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsHexadecimal = i.IsHexadecimal] = "IsHexadecimal", a[a.IsLengthEqual = i.IsLengthEqual] = "IsLengthEqual", a[a.IsLengthGreaterThan = i.IsLengthGreaterThan] = "IsLengthGreaterThan", a[a.IsLengthGreaterThanOrEqual = i.IsLengthGreaterThanOrEqual] = "IsLengthGreaterThanOrEqual", a[a.IsLengthLessThan = i.IsLengthLessThan] = "IsLengthLessThan", a[a.IsLengthLessThanOrEqual = i.IsLengthLessThanOrEqual] = "IsLengthLessThanOrEqual", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsString = i.IsString] = "IsString";
})(Ma || (Ma = {}));
var ya;
(function(a) {
  a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsJSON = i.IsJSON] = "IsJSON", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotNull = i.IsNotNull] = "IsNotNull";
})(ya || (ya = {}));
var Fa;
(function(a) {
  a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsMarkdown = i.IsMarkdown] = "IsMarkdown", a[a.IsString = i.IsString] = "IsString";
})(Fa || (Fa = {}));
var La;
(function(a) {
  a[a.Contains = i.Contains] = "Contains", a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotNull = i.IsNotNull] = "IsNotNull";
})(La || (La = {}));
var qa;
(function(a) {
  a[a.Contains = i.Contains] = "Contains", a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotNull = i.IsNotNull] = "IsNotNull";
...
var Ga;
(function(a) {
  a[a.Contains = i.Contains] = "Contains", a[a.IsDataURI = i.IsDataURI] = "IsDataURI", a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsString = i.IsString] = "IsString";
})(Ga || (Ga = {}));
var wa;
(function(a) {
  a[a.Contains = i.Contains] = "Contains", a[a.IsDomainName = i.IsDomainName] = "IsDomainName", a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsString = i.IsString] = "IsString";
})(wa || (wa = {}));
var Ka;
(function(a) {
  a[a.Contains = i.Contains] = "Contains", a[a.IsEmailAddress = i.IsEmailAddress] = "IsEmailAddress", a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsInList = i.IsInList] = "IsInList", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotInList = i.IsNotInList] = "IsNotInList", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsString = i.IsString] = "IsString";
})(Ka || (Ka = {}));
var xa;
(function(a) {
  a[a.Contains = i.Contains] = "Contains", a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsIPAddress = i.IsIPAddress] = "IsIPAddress", a[a.IsInIPAddressRange = i.IsInIPAddressRange] = "IsInIPAddressRange", a[a.IsInList = i.IsInList] = "IsInList", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotInList = i.IsNotInList] = "IsNotInList", a[a.IsNotInIPAddressRange = i.IsNotInIPAddressRange] = "IsNotInIPAddressRange", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsString = i.IsString] = "IsString";
})(xa || (xa = {}));
var Oa;
(function(a) {
  a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsIPAddressRange = i.IsIPAddressRange] = "IsIPAddressRange", a[a.IsInList = i.IsInList] = "IsInList", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotInList = i.IsNotInList] = "IsNotInList", a[a.IsNotInIPAddressRange = i.IsNotInIPAddressRange] = "IsNotInIPAddressRange", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsString = i.IsString] = "IsString";
})(Oa || (Oa = {}));
var Ha;
(function(a) {
  a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsGreaterThan = i.IsGreaterThan] = "IsGreaterThan", a[a.IsGreaterThanOrEqual = i.IsGreaterThanOrEqual] = "IsGreaterThanOrEqual", a[a.IsInteger = i.IsInteger] = "IsInteger", a[a.IsLessThan = i.IsLessThan] = "IsLessThan", a[a.IsLessThanOrEqual = i.IsLessThanOrEqual] = "IsLessThanOrEqual", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotNull = i.IsNotNull] = "IsNotNull";
})(Ha || (Ha = {}));
var ja;
(function(a) {
  a[a.Contains = i.Contains] = "Contains", a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsInList = i.IsInList] = "IsInList", a[a.IsMACAddress = i.IsMACAddress] = "IsMACAddress", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotInList = i.IsNotInList] = "IsNotInList", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsString = i.IsString] = "IsString";
})(ja || (ja = {}));
var Va;
(function(a) {
  a[a.Contains = i.Contains] = "Contains", a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsInList = i.IsInList] = "IsInList", a[a.IsMagnetURI = i.IsMagnetURI] = "IsMagnetURI", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotInList = i.IsNotInList] = "IsNotInList", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsString = i.IsString] = "IsString";
})(Va || (Va = {}));
var za;
(function(a) {
  a[a.Contains = i.Contains] = "Contains", a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsInList = i.IsInList] = "IsInList", a[a.IsMimeType = i.IsMimeType] = "IsMimeType", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotInList = i.IsNotInList] = "IsNotInList", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsString = i.IsString] = "IsString";
})(za || (za = {}));
var Wa;
(function(a) {
  a[a.Contains = i.Contains] = "Contains", a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsInList = i.IsInList] = "IsInList", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotInList = i.IsNotInList] = "IsNotInList", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsString = i.IsString] = "IsString", a[a.IsSlug = i.IsSlug] = "IsSlug";
})(Wa || (Wa = {}));
var Ra;
(function(a) {
  a[a.Contains = i.Contains] = "Contains", a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsInList = i.IsInList] = "IsInList", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotInList = i.IsNotInList] = "IsNotInList", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsString = i.IsString] = "IsString", a[a.IsURL = i.IsURL] = "IsURL";
})(Ra || (Ra = {}));
var Ja;
(function(a) {
  a[a.IsAfter = i.IsAfter] = "IsAfter", a[a.IsAfterOrEqual = i.IsAfterOrEqual] = "IsAfterOrEqual", a[a.IsBefore = i.IsBefore] = "IsBefore", a[a.IsBeforeOrEqual = i.IsBeforeOrEqual] = "IsBeforeOrEqual", a[a.IsBetween = i.IsBetween] = "IsBetween", a[a.IsDecimal = i.IsDecimal] = "IsDecimal", a[a.IsDivisibleBy = i.IsDivisibleBy] = "IsDivisibleBy", a[a.IsEAN = i.IsEAN] = "IsEAN", a[a.IsEIN = i.IsEIN] = "IsEIN", a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsEvenNumber = i.IsEvenNumber] = "IsEvenNumber", a[a.IsFloat = i.IsFloat] = "IsFloat", a[a.IsGreaterThan = i.IsGreaterThan] = "IsGreaterThan", a[a.IsGreaterThanOrEqual = i.IsGreaterThanOrEqual] = "IsGreaterThanOrEqual", a[a.IsInt = i.IsInteger] = "IsInt", a[a.IsISBN = i.IsISBN] = "IsISBN", a[a.IsISMN = i.IsISMN] = "IsISMN", a[a.IsISSN = i.IsISSN] = "IsISSN", a[a.IsLatitude = i.IsLatitude] = "IsLatitude", a[a.IsLongitude = i.IsLongitude] = "IsLongitude", a[a.IsLessThan = i.IsLessThan] = "IsLessThan", a[a.IsLessThanOrEqual = i.IsLessThanOrEqual] = "IsLessThanOrEqual", a[a.IsMACAddress = i.IsMACAddress] = "IsMACAddress", a[a.IsNumber = i.IsNumber] = "IsNumber", a[a.IsNegativeNumber = i.IsNegativeNumber] = "IsNegativeNumber", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsOddNumber = i.IsOddNumber] = "IsOddNumber", a[a.IsPassportNumber = i.IsPassportNumber] = "IsPassportNumber", a[a.IsPhoneNumber = i.IsPhoneNumber] = "IsPhoneNumber", a[a.IsPort = i.IsPort] = "IsPort", a[a.IsPositiveNumber = i.IsPositiveNumber] = "IsPositiveNumber", a[a.IsPostalCode = i.IsPostalCode] = "IsPostalCode", a[a.IsSemanticVersion = i.IsSemanticVersion] = "IsSemanticVersion", a[a.IsSSN = i.IsSSN] = "IsSSN", a[a.IsTaxIDNumber = i.IsTaxIDNumber] = "IsTaxIDNumber", a[a.IsUUID = i.IsUUID] = "IsUUID", a[a.IsVATIDNumber = i.IsVATIDNumber] = "IsVATIDNumber";
})(Ja || (Ja = {}));
var Za;
(function(a) {
  a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsFloat = i.IsFloat] = "IsFloat", a[a.IsGreaterThan = i.IsGreaterThan] = "IsGreaterThan", a[a.IsGreaterThanOrEqual = i.IsGreaterThanOrEqual] = "IsGreaterThanOrEqual", a[a.IsLessThan = i.IsLessThan] = "IsLessThan", a[a.IsLessThanOrEqual = i.IsLessThanOrEqual] = "IsLessThanOrEqual", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsNumber = i.IsNumber] = "IsNumber", a[a.IsNumeric = i.IsNumeric] = "IsNumeric";
})(Za || (Za = {}));
var Ya;
(function(a) {
  a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsInteger = i.IsInteger] = "IsInteger", a[a.IsGreaterThan = i.IsGreaterThan] = "IsGreaterThan", a[a.IsGreaterThanOrEqual = i.IsGreaterThanOrEqual] = "IsGreaterThanOrEqual", a[a.IsLessThan = i.IsLessThan] = "IsLessThan", a[a.IsLessThanOrEqual = i.IsLessThanOrEqual] = "IsLessThanOrEqual", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsNumber = i.IsNumber] = "IsNumber", a[a.IsNumeric = i.IsNumeric] = "IsNumeric";
})(Ya || (Ya = {}));
var $a;
(function(a) {
  a[a.IsCreditCard = i.IsCreditCard] = "IsCreditCard", a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsLengthEqual = i.IsLengthEqual] = "IsLengthEqual", a[a.IsLengthGreaterThan = i.IsLengthGreaterThan] = "IsLengthGreaterThan", a[a.IsLengthGreaterThanOrEqual = i.IsLengthGreaterThanOrEqual] = "IsLengthGreaterThanOrEqual", a[a.IsLengthLessThan = i.IsLengthLessThan] = "IsLengthLessThan", a[a.IsLengthLessThanOrEqual = i.IsLengthLessThanOrEqual] = "IsLengthLessThanOrEqual", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsRegexMatch = i.IsRegexMatch] = "IsRegexMatch", a[a.IsNotRegexMatch = i.IsNotRegexMatch] = "IsNotRegexMatch";
})($a || ($a = {}));
var Qa;
(function(a) {
  a[a.isEmailAddress = i.IsEmailAddress] = "isEmailAddress", a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsInList = i.IsInList] = "IsInList", a[a.IsLengthEqual = i.IsLengthEqual] = "IsLengthEqual", a[a.IsLengthGreaterThan = i.IsLengthGreaterThan] = "IsLengthGreaterThan", a[a.IsLengthGreaterThanOrEqual = i.IsLengthGreaterThanOrEqual] = "IsLengthGreaterThanOrEqual", a[a.IsLengthLessThan = i.IsLengthLessThan] = "IsLengthLessThan", a[a.IsLengthLessThanOrEqual = i.IsLengthLessThanOrEqual] = "IsLengthLessThanOrEqual", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotInList = i.IsNotInList] = "IsNotInList", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsRegexMatch = i.IsRegexMatch] = "IsRegexMatch", a[a.IsNotRegexMatch = i.IsNotRegexMatch] = "IsNotRegexMatch";
})(Qa || (Qa = {}));
var Xa;
(function(a) {
  a[a.IsLicensePlateNumber = i.IsLicensePlateNumber] = "IsLicensePlateNumber", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsNotRegexMatch = i.IsNotRegexMatch] = "IsNotRegexMatch", a[a.IsString = i.IsString] = "IsString", a[a.IsRegexMatch = i.IsRegexMatch] = "IsRegexMatch";
})(Xa || (Xa = {}));
var Ca;
(function(a) {
  a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsPassportNumber = i.IsPassportNumber] = "IsPassportNumber", a[a.IsString = i.IsString] = "IsString", a[a.IsRegexMatch = i.IsRegexMatch] = "IsRegexMatch";
})(Ca || (Ca = {}));
var ae;
(function(a) {
  a[a.IsComplexEnough = i.IsComplexEnough] = "IsComplexEnough", a[a.IsInList = i.IsInList] = "IsInList", a[a.IsNotInList = i.IsNotInList] = "IsNotInList", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsNotRegexMatch = i.IsNotRegexMatch] = "IsNotRegexMatch", a[a.IsLengthGreaterThan = i.IsLengthGreaterThan] = "IsLengthGreaterThan", a[a.IsLengthGreaterThanOrEqual = i.IsLengthGreaterThanOrEqual] = "IsLengthGreaterThanOrEqual", a[a.IsLengthLessThan = i.IsLengthLessThan] = "IsLengthLessThan", a[a.IsLengthLessThanOrEqual = i.IsLengthLessThanOrEqual] = "IsLengthLessThanOrEqual", a[a.IsStrongPassword = i.IsStrongPassword] = "IsStrongPassword", a[a.IsString = i.IsString] = "IsString", a[a.IsRegexMatch = i.IsRegexMatch] = "IsRegexMatch";
})(ae || (ae = {}));
var ee;
(function(a) {
  a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsNotRegexMatch = i.IsNotRegexMatch] = "IsNotRegexMatch", a[a.IsNumber = i.IsNumber] = "IsNumber", a[a.IsPhoneNumber = i.IsPhoneNumber] = "IsPhoneNumber", a[a.IsRegexMatch = i.IsRegexMatch] = "IsRegexMatch";
})(ee || (ee = {}));
var ie;
(function(a) {
  a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsSSN = i.IsSSN] = "IsSSN", a[a.IsString = i.IsString] = "IsString", a[a.IsRegexMatch = i.IsRegexMatch] = "IsRegexMatch";
})(ie || (ie = {}));
var ne;
(function(a) {
  a[a.Contains = i.Contains] = "Contains", a[a.IsBIC = i.IsBIC] = "IsBIC", a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsInList = i.IsInList] = "IsInList", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotInList = i.IsNotInList] = "IsNotInList", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsString = i.IsString] = "IsString";
})(ne || (ne = {}));
var se;
(function(a) {
  a[a.Contains = i.Contains] = "Contains", a[a.IsEAN = i.IsEAN] = "IsEAN", a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsInList = i.IsInList] = "IsInList", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotInList = i.IsNotInList] = "IsNotInList", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsString = i.IsString] = "IsString";
})(se || (se = {}));
var ue;
(function(a) {
  a[a.Contains = i.Contains] = "Contains", a[a.IsEIN = i.IsEIN] = "IsEIN", a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsInList = i.IsInList] = "IsInList", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotInList = i.IsNotInList] = "IsNotInList", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsString = i.IsString] = "IsString";
})(ue || (ue = {}));
var re;
(function(a) {
  a[a.Contains = i.Contains] = "Contains", a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsIBAN = i.IsIBAN] = "IsIBAN", a[a.IsInList = i.IsInList] = "IsInList", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotInList = i.IsNotInList] = "IsNotInList", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsString = i.IsString] = "IsString";
})(re || (re = {}));
var te;
(function(a) {
  a[a.Contains = i.Contains] = "Contains", a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsISBN = i.IsISBN] = "IsISBN", a[a.IsInList = i.IsInList] = "IsInList", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotInList = i.IsNotInList] = "IsNotInList", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsString = i.IsString] = "IsString";
})(te || (te = {}));
var le;
(function(a) {
  a[a.Contains = i.Contains] = "Contains", a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsISIN = i.IsISIN] = "IsISIN", a[a.IsInList = i.IsInList] = "IsInList", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotInList = i.IsNotInList] = "IsNotInList", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsString = i.IsString] = "IsString";
})(le || (le = {}));
var me;
(function(a) {
  a[a.Contains = i.Contains] = "Contains", a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsISMN = i.IsISMN] = "IsISMN", a[a.IsInList = i.IsInList] = "IsInList", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotInList = i.IsNotInList] = "IsNotInList", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsString = i.IsString] = "IsString";
})(me || (me = {}));
var oe;
(function(a) {
  a[a.Contains = i.Contains] = "Contains", a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsISSN = i.IsISSN] = "IsISSN", a[a.IsInList = i.IsInList] = "IsInList", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotInList = i.IsNotInList] = "IsNotInList", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsString = i.IsString] = "IsString";
})(oe || (oe = {}));
var ce;
(function(a) {
  a[a.Contains = i.Contains] = "Contains", a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsInList = i.IsInList] = "IsInList", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotInList = i.IsNotInList] = "IsNotInList", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsString = i.IsString] = "IsString", a[a.IsTaxIDNumber = i.IsTaxIDNumber] = "IsTaxIDNumber";
})(ce || (ce = {}));
var Ae;
(function(a) {
  a[a.Contains = i.Contains] = "Contains", a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsInList = i.IsInList] = "IsInList", a[a.IsNotEqual = i.IsNotEqual] = "IsNotEqual", a[a.IsNotInList = i.IsNotInList] = "IsNotInList", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsString = i.IsString] = "IsString", a[a.IsVATIDNumber = i.IsVATIDNumber] = "IsVATIDNumber";
})(Ae || (Ae = {}));
var de;
(function(a) {
  a[a.Contains = i.Contains] = "Contains", a[a.HasNumberCount = i.HasNumberCount] = "HasNumberCount", a[a.HasLowercaseCount = i.HasLowercaseCount] = "HasLowercaseCount", a[a.HasLetterCount = i.HasLetterCount] = "HasLetterCount", a[a.HasSpacesCount = i.HasSpacesCount] = "HasSpacesCount", a[a.HasSymbolCount = i.HasSymbolCount] = "HasSymbolCount", a[a.HasUppercaseCount = i.HasUppercaseCount] = "HasUppercaseCount", a[a.IsAlpha = i.IsAlpha] = "IsAlpha", a[a.IsAlphanumeric = i.IsAlphanumeric] = "IsAlphanumeric", a[a.IsAscii = i.IsAscii] = "IsAscii", a[a.IsBase64 = i.IsBase64] = "IsBase64", a[a.IsColor = i.IsColor] = "IsColor", a[a.IsComplexEnough = i.IsComplexEnough] = "IsComplexEnough", a[a.IsCreditCard = i.IsCreditCard] = "IsCreditCard", a[a.IsDataURI = i.IsDataURI] = "IsDataURI", a[a.IsDomainName = i.IsDomainName] = "IsDomainName", a[a.IsEmailAddress = i.IsEmailAddress] = "IsEmailAddress", a[a.IsEthereumAddress = i.IsEthereumAddress] = "IsEthereumAddress", a[a.IsEAN = i.IsEAN] = "IsEAN", a[a.IsEIN = i.IsEIN] = "IsEIN", a[a.IsEqual = i.IsEqual] = "IsEqual", a[a.IsIBAN = i.IsIBAN] = "IsIBAN", a[a.IsHSLColor = i.IsHSLColor] = "IsHSLColor", a[a.IsHexColor = i.IsHexColor] = "IsHexColor", a[a.IsHexadecimal = i.IsHexadecimal] = "IsHexadecimal", a[a.IsIdentityCardCode = i.IsIdentityCardCode] = "IsIdentityCardCode", a[a.IsIMEI = i.IsIMEI] = "IsIMEI", a[a.IsInList = i.IsInList] = "IsInList", a[a.IsIPAddress = i.IsIPAddress] = "IsIPAddress", a[a.IsInIPAddressRange = i.IsInIPAddressRange] = "IsInIPAddressRange", a[a.IsISBN = i.IsISBN] = "IsISBN", a[a.IsISIN = i.IsISIN] = "IsISIN", a[a.IsISMN = i.IsISMN] = "IsISMN", a[a.IsISRC = i.IsISRC] = "IsISRC", a[a.IsISSN = i.IsISSN] = "IsISSN", a[a.IsLanguage = i.IsLanguage] = "IsLanguage", a[a.IsLatitude = i.IsLatitude] = "IsLatitude", a[a.IsLongitude = i.IsLongitude] = "IsLongitude", a[a.IsLengthEqual = i.IsLengthEqual] = "IsLengthEqual", a[a.IsLengthGreaterThan = i.IsLengthGreaterThan] = "IsLengthGreaterThan", a[a.IsLengthGreaterThanOrEqual = i.IsLengthGreaterThanOrEqual] = "IsLengthGreaterThanOrEqual", a[a.IsLengthLessThan = i.IsLengthLessThan] = "IsLengthLessThan", a[a.IsLengthLessThanOrEqual = i.IsLengthLessThanOrEqual] = "IsLengthLessThanOrEqual", a[a.IsLicensePlateNumber = i.IsLicensePlateNumber] = "IsLicensePlateNumber", a[a.IsLowercase = i.IsLowercase] = "IsLowercase", a[a.IsOctal = i.IsOctal] = "IsOctal", a[a.IsMACAddress = i.IsMACAddress] = "IsMACAddress", a[a.IsMD5 = i.IsMD5] = "IsMD5", a[a.IsMagnetURI = i.IsMagnetURI] = "IsMagnetURI", a[a.IsMarkdown = i.IsMarkdown] = "IsMarkdown", a[a.IsMimeType = i.IsMimeType] = "IsMimeType", a[a.IsMonth = i.IsMonth] = "IsMonth", a[a.IsNotInIPAddressRange = i.IsNotInIPAddressRange] = "IsNotInIPAddressRange", a[a.IsNotInList = i.IsNotInList] = "IsNotInList", a[a.IsNotNull = i.IsNotNull] = "IsNotNull", a[a.IsNotRegexMatch = i.IsNotRegexMatch] = "IsNotRegexMatch", a[a.IsNumber = i.IsNumber] = "IsNumber", a[a.IsNumeric = i.IsNumeric] = "IsNumeric", a[a.IsPassportNumber = i.IsPassportNumber] = "IsPassportNumber", a[a.IsPhoneNumber = i.IsPhoneNumber] = "IsPhoneNumber", a[a.IsPort = i.IsPort] = "IsPort", a[a.IsPostalCode = i.IsPostalCode] = "IsPostalCode", a[a.IsProvince = i.IsProvince] = "IsProvince", a[a.IsRegexMatch = i.IsRegexMatch] = "IsRegexMatch", a[a.IsSemanticVersion = i.IsSemanticVersion] = "IsSemanticVersion", a[a.IsSlug = i.IsSlug] = "IsSlug", a[a.IsSSN = i.IsSSN] = "IsSSN", a[a.IsState = i.IsState] = "IsState", a[a.IsStreetAddress = i.IsStreetAddress] = "IsStreetAddress", a[a.IsString = i.IsString] = "IsString", a[a.IsTaxIDNumber = i.IsTaxIDNumber] = "IsTaxIDNumber", a[a.IsURL = i.IsURL] = "IsURL", a[a.IsUUID = i.IsUUID] = "IsUUID", a[a.IsUppercase = i.IsUppercase] = "IsUppercase", a[a.IsVATIDNumber = i.IsVATIDNumber] = "IsVATIDNumber", a[a.IsWeekday = i.IsWeekday] = "IsWeekday", a[a.IsWeekend = i.IsWeekend] = "IsWeekend", a[a.IsYear = i.IsYear] = "IsYear";
})(de || (de = {}));
var Ie;
(function(a) {
  a[a.Contains = i.Contains] = "Contains", a[a.IsAlpha = i.IsAlpha] = "IsAlpha", a[a.IsAlphanumeric = i.IsAlphanumeric] = "IsAlphanumeric", a[a.IsInList = i.IsInList] = "IsInList", a[a.IsMarkdown = i.IsMarkdown] = "IsMarkdown", a[a.IsNotInList = i.IsNotInList] = "IsNotInList", a[a.IsNumeric = i.IsNumeric] = "IsNumeric", a[a.IsLowercase = i.IsLowercase] = "IsLowercase", a[a.IsString = i.IsString] = "IsString", a[a.IsUppercase = i.IsUppercase] = "IsUppercase";
})(Ie || (Ie = {}));
var he;
(function(a) {
...
var Bi = { dst: { is: false, uses: true }, id: s.AcreTime, name: "Acre Time", offset: n.UTC_MINUS_5 };
var Ni = { dst: { is: false, uses: true }, id: s.AfghanistanTime, name: "Afghanistan Time", offset: n.UTC_PLUS_4_30 };
var Ui = { dst: { is: false, uses: true }, id: s.AIXCentralEuropeanTime, name: "AIX Central European Time", offset: n.UTC_PLUS_1 };
var Di = { dst: { is: true, uses: true }, id: s.AlaskaDaylightTime, name: "Alaska Daylight Time", offset: n.UTC_MINUS_8 };
var Pi = { dst: { is: false, uses: true }, id: s.AlaskaStandardTime, name: "Alaska Standard Time", offset: n.UTC_MINUS_9 };
var ki = { dst: { is: false, uses: true }, id: s.AlmaAtaTime, name: "Alma-Ata Time", offset: n.UTC_PLUS_6 };
var Mi = { dst: { is: false, uses: true }, id: s.AmazonSummerTime, name: "Amazon Summer Time", offset: n.UTC_MINUS_3 };
var yi = { dst: { is: false, uses: true }, id: s.AmazonTime, name: "Amazon Time", offset: n.UTC_MINUS_4 };
var Fi = { dst: { is: false, uses: true }, id: s.AnadyrTime, name: "Anadyr Time", offset: n.UTC_PLUS_12 };
var Li = { dst: { is: false, uses: true }, id: s.AqtobeTime, name: "Aqtobe Time", offset: n.UTC_PLUS_5 };
var qi = { dst: { is: false, uses: true }, id: s.ArabiaStandardTime, name: "Arabia Standard Time", offset: n.UTC_PLUS_3 };
var Gi = { dst: { is: false, uses: true }, id: s.ArgentinaTime, name: "Argentina Time", offset: n.UTC_MINUS_3 };
var wi = { dst: { is: false, uses: true }, id: s.ArmeniaTime, name: "Armenia Time", offset: n.UTC_PLUS_4 };
var Ki = { dst: { is: true, uses: true }, id: s.AtlanticDaylightTime, name: "Atlantic Daylight Time", offset: n.UTC_MINUS_3 };
var xi = { dst: { is: false, uses: true }, id: s.AtlanticStandardTime, name: "Atlantic Standard Time", offset: n.UTC_MINUS_4 };
var Oi = { dst: { is: true, uses: true }, id: s.AustralianCentralDaylightSavingTime, name: "Australian Central Daylight Saving Time", offset: n.UTC_PLUS_10_30 };
var Hi = { dst: { is: false, uses: true }, id: s.AustralianCentralStandardTime, name: "Australian Central Standard Time", offset: n.UTC_PLUS_9_30 };
var ji = { dst: { is: false, uses: true }, id: s.AustralianCentralWesternStandardTime, name: "Australian Central Western Standard Time", offset: n.UTC_PLUS_8_45 };
var Vi = { dst: { is: true, uses: true }, id: s.AustralianEasternDaylightSavingTime, name: "Australian Eastern Daylight Saving Time", offset: n.UTC_PLUS_11 };
var zi = { dst: { is: false, uses: true }, id: s.AustralianEasternStandardTime, name: "Australian Eastern Standard Time", offset: n.UTC_PLUS_10 };
var Wi = { dst: { is: false, uses: true }, id: s.AustralianEasternTime, name: "Australian Eastern Time", offset: n.UTC_PLUS_10 };
var Ri = { dst: { is: false, uses: true }, id: s.AustralianWesternStandardTime, name: "Australian Western Standard Time", offset: n.UTC_PLUS_8 };
var Ji = { dst: { is: false, uses: true }, id: s.AzerbaijanTime, name: "Azerbaijan Time", offset: n.UTC_PLUS_4 };
var Zi = { dst: { is: false, uses: true }, id: s.AzoresStandardTime, name: "Azores Standard Time", offset: n.UTC_MINUS_1 };
var Yi = { dst: { is: true, uses: true }, id: s.AzoresSummerTime, name: "Azores Summer Time", offset: n.UTC_0 };
var $i = { dst: { is: false, uses: true }, id: s.BakerIslandTime, name: "Baker Island Time", offset: n.UTC_MINUS_12 };
var Qi = { dst: { is: false, uses: true }, id: s.BangladeshStandardTime, name: "Bangladesh Standard Time", offset: n.UTC_PLUS_6 };
var Xi = { dst: { is: false, uses: true }, id: s.BhutanTime, name: "Bhutan Time", offset: n.UTC_PLUS_6 };
var Ci = { dst: { is: false, uses: true }, id: s.BoliviaTime, name: "Bolivia Time", offset: n.UTC_MINUS_4 };
var an = { dst: { is: false, uses: true }, id: s.BougainvilleStandardTime, name: "Bougainville Standard Time", offset: n.UTC_PLUS_11 };
var en = { dst: { is: true, uses: true }, id: s.BrasiliaSummerTime, name: "Brasilia Summer Time", offset: n.UTC_MINUS_2 };
var nn = { dst: { is: false, uses: true }, id: s.BrasiliaTime, name: "Brasilia Time", offset: n.UTC_MINUS_3 };
var sn = { dst: { is: false, uses: true }, id: s.BritishIndianOceanTime, name: "British Indian Ocean Time", offset: n.UTC_PLUS_6 };
var un = { dst: { is: true, uses: true }, id: s.BritishSummerTime, name: "British Summer Time", offset: n.UTC_PLUS_1 };
var rn = { dst: { is: false, uses: true }, id: s.BruneiTime, name: "Brunei Time", offset: n.UTC_PLUS_8 };
var tn = { dst: { is: false, uses: true }, id: s.CapeVerdeTime, name: "Cape Verde Time", offset: n.UTC_MINUS_1 };
var ln = { dst: { is: false, uses: true }, id: s.CentralAfricaTime, name: "Central Africa Time", offset: n.UTC_PLUS_2 };
var mn = { dst: { is: true, uses: true }, id: s.CentralDaylightTime, name: "Central Daylight Time", offset: n.UTC_MINUS_5 };
var on = { dst: { is: true, uses: true }, id: s.CentralEuropeanSummerTime, name: "Central European Summer Time", offset: n.UTC_PLUS_2 };
var cn = { dst: { is: false, uses: true }, id: s.CentralEuropeanTime, name: "Central European Time", offset: n.UTC_PLUS_1 };
var An = { dst: { is: false, uses: true }, id: s.CentralIndonesiaTime, name: "Central Indonesia Time", offset: n.UTC_PLUS_8 };
var dn = { dst: { is: false, uses: true }, id: s.CentralStandardTime, name: "Central Standard Time", offset: n.UTC_MINUS_6 };
var In = { dst: { is: false, uses: true }, id: s.CentralTime, name: "Central Time", offset: n.UTC_MINUS_5 };
var hn = { dst: { is: false, uses: true }, id: s.CentralWesternStandardTime, name: "Central Western Standard Time", offset: n.UTC_PLUS_8_45 };
var gn = { dst: { is: false, uses: true }, id: s.ChamorroStandardTime, name: "Chamorro Standard Time", offset: n.UTC_PLUS_10 };
var fn = { dst: { is: true, uses: true }, id: s.ChathamDaylightTime, name: "Chatham Daylight Time", offset: n.UTC_PLUS_13_45 };
var _n = { dst: { is: false, uses: true }, id: s.ChathamStandardTime, name: "Chatham Standard Time", offset: n.UTC_PLUS_12_45 };
var En = { dst: { is: false, uses: true }, id: s.ChileStandardTime, name: "Chile Standard Time", offset: n.UTC_MINUS_4 };
var Sn = { dst: { is: true, uses: true }, id: s.ChileSummerTime, name: "Chile Summer Time", offset: n.UTC_MINUS_3 };
var Tn = { dst: { is: false, uses: true }, id: s.ChinaStandardTime, name: "China Standard Time", offset: n.UTC_PLUS_8 };
var pn = { dst: { is: false, uses: true }, id: s.ChoibalsanStandardTime, name: "Choibalsan Standard Time", offset: n.UTC_PLUS_8 };
var bn = { dst: { is: true, uses: true }, id: s.ChoibalsanSummerTime, name: "Choibalsan Summer Time", offset: n.UTC_PLUS_9 };
var vn = { dst: { is: false, uses: true }, id: s.ChristmasIslandTime, name: "Christmas Island Time", offset: n.UTC_PLUS_7 };
var Bn = { dst: { is: false, uses: true }, id: s.ChuukTime, name: "Chuuk Time", offset: n.UTC_PLUS_10 };
var Nn = { dst: { is: false, uses: true }, id: s.ClipptertonIslandStandardTime, name: "Clippterton Island Standard Time", offset: n.UTC_MINUS_8 };
var Un = { dst: { is: false, uses: true }, id: s.CocosIslandsTime, name: "Cocos Standard Time", offset: n.UTC_PLUS_6_30 };
var Dn = { dst: { is: true, uses: true }, id: s.ColombiaSummerTime, name: "Colombia Summer Time", offset: n.UTC_MINUS_4 };
var Pn = { dst: { is: false, uses: true }, id: s.ColombiaTime, name: "Colombia Time", offset: n.UTC_MINUS_5 };
var kn = { dst: { is: false, uses: true }, id: s.CookIslandTime, name: "Cook Island Time", offset: n.UTC_MINUS_10 };
var Mn = { dst: { is: false, uses: true }, id: s.CoordinatedUniversalTime, name: "Coordinated Universal Time", offset: n.UTC_0 };
var yn = { dst: { is: true, uses: true }, id: s.CubaDaylightTime, name: "Cuba Daylight Time", offset: n.UTC_MINUS_4 };
var Fn = { dst: { is: false, uses: true }, id: s.CubaStandardTime, name: "Cuba Standard Time", offset: n.UTC_MINUS_5 };
var Ln = { dst: { is: false, uses: true }, id: s.DavisTime, name: "Davis Time", offset: n.UTC_PLUS_7 };
var qn = { dst: { is: false, uses: true }, id: s.DumontDUrvilleTime, name: "Dumont D'Urville Time", offset: n.UTC_PLUS_10 };
var Gn = { dst: { is: false, uses: true }, id: s.EastAfricaTime, name: "East Africa Time", offset: n.UTC_PLUS_3 };
var wn = { dst: { is: false, uses: true }, id: s.EasterIslandStandardTime, name: "Easter Island Standard Time", offset: n.UTC_MINUS_6 };
var Kn = { dst: { is: true, uses: true }, id: s.EasterIslandSummerTime, name: "Easter Island Summer Time", offset: n.UTC_MINUS_5 };
var xn = { dst: { is: false, uses: true }, id: s.EasternCaribbeanTime, name: "Eastern Caribbean Time", offset: n.UTC_MINUS_4 };
var On = { dst: { is: true, uses: true }, id: s.EasternDaylightTime, name: "Eastern Daylight Time", offset: n.UTC_MINUS_4 };
var Hn = { dst: { is: true, uses: true }, id: s.EasternEuropeanSummerTime, name: "Eastern European Summer Time", offset: n.UTC_PLUS_3 };
var jn = { dst: { is: false, uses: true }, id: s.EasternEuropeanTime, name: "Eastern European Time", offset: n.UTC_PLUS_2 };
var Vn = { dst: { is: true, uses: true }, id: s.EasternGreenlandSummerTime, name: "Eastern Greenland Summer Time", offset: n.UTC_0 };
var zn = { dst: { is: false, uses: true }, id: s.EasternGreenlandTime, name: "Eastern Greenland Time", offset: n.UTC_MINUS_1 };
var Wn = { dst: { is: false, uses: true }, id: s.EasternIndonesianTime, name: "Eastern Indonesian Time", offset: n.UTC_PLUS_9 };
var Rn = { dst: { is: false, uses: true }, id: s.EasternStandardTime, name: "Eastern Standard Time", offset: n.UTC_MINUS_5 };
var Jn = { dst: { is: false, uses: true }, id: s.EasternTime, name: "Eastern Time", offset: n.UTC_MINUS_5 };
var Zn = { dst: { is: false, uses: true }, id: s.EcuadorTime, name: "Ecuador Time", offset: n.UTC_MINUS_5 };
var Yn = { dst: { is: true, uses: true }, id: s.FalklandIslandsSummerTime, name: "Falkland Islands Summer Time", offset: n.UTC_MINUS_3 };
var $n = { dst: { is: false, uses: true }, id: s.FalklandIslandsTime, name: "Falkland Islands Time", offset: n.UTC_MINUS_4 };
var Qn = { dst: { is: false, uses: true }, id: s.FernandoDeNoronhaTime, name: "Fernando de Noronha Time", offset: n.UTC_MINUS_2 };
var Xn = { dst: { is: false, uses: true }, id: s.FijiTime, name: "Fiji Time", offset: n.UTC_PLUS_12 };
var Cn = { dst: { is: false, uses: true }, id: s.FrenchGuianaTime, name: "French Guiana Time", offset: n.UTC_MINUS_3 };
var as = { dst: { is: false, uses: true }, id: s.FrenchSouthernAndAntarcticTime, name: "French Southern and Antarctic Time", offset: n.UTC_PLUS_5 };
var es = { dst: { is: false, uses: true }, id: s.FurtherEasternEuropeanTime, name: "Further Eastern European Time", offset: n.UTC_PLUS_3 };
var is = { dst: { is: false, uses: true }, id: s.GalapagosTime, name: "Galapagos Time", offset: n.UTC_MINUS_6 };
var ns = { dst: { is: false, uses: true }, id: s.GambierIslandTime, name: "Gambier Island Time", offset: n.UTC_MINUS_9 };
var ss = { dst: { is: false, uses: true }, id: s.GambierIslandsTime, name: "Gambier Islands Time", offset: n.UTC_MINUS_9 };
var us = { dst: { is: false, uses: true }, id: s.GeorgiaStandardTime, name: "Georgia Standard Time", offset: n.UTC_PLUS_4 };
var rs = { dst: { is: false, uses: true }, id: s.GilbertIslandTime, name: "Gilbert Island Time", offset: n.UTC_PLUS_12 };
var ts = { dst: { is: false, uses: true }, id: s.GreenwichMeanTime, name: "Greenwich Mean Time", offset: n.UTC_0 };
var ls = { dst: { is: false, uses: true }, id: s.GulfStandardTime, name: "Gulf Standard Time", offset: n.UTC_PLUS_4 };
var ms = { dst: { is: false, uses: true }, id: s.GuyanaTime, name: "Guyana Time", offset: n.UTC_MINUS_4 };
var os = { dst: { is: true, uses: true }, id: s.HawaiiAleutianDaylightTime, name: "Hawaii-Aleutian Daylight Time", offset: n.UTC_MINUS_9 };
var cs = { dst: { is: false, uses: true }, id: s.HawaiiAleutianStandardTime, name: "Hawaii-Aleutian Standard Time", offset: n.UTC_MINUS_10 };
var As = { dst: { is: false, uses: true }, id: s.HeardAndMcDonaldIslandsTime, name: "Heard and McDonald Islands Time", offset: n.UTC_PLUS_5 };
var ds = { dst: { is: false, uses: true }, id: s.HongKongTime, name: "Hong Kong Time", offset: n.UTC_PLUS_8 };
var Is = { dst: { is: true, uses: true }, id: s.HovdSummerTime, name: "Hovd Summer Time", offset: n.UTC_PLUS_8 };
var hs = { dst: { is: false, uses: true }, id: s.HovdTime, name: "Hovd Time", offset: n.UTC_PLUS_7 };
var gs = { dst: { is: false, uses: true }, id: s.IndianOceanTime, name: "Indian Ocean Time", offset: n.UTC_PLUS_3 };
var fs = { dst: { is: false, uses: true }, id: s.IndianStandardTime, name: "Indian Standard Time", offset: n.UTC_PLUS_5_30 };
var _s = { dst: { is: false, uses: true }, id: s.IndochinaTime, name: "Indochina Time", offset: n.UTC_PLUS_7 };
var Es = { dst: { is: false, uses: true }, id: s.InternationalDayLineWestTime, name: "International Day Line West Time", offset: n.UTC_MINUS_12 };
var Ss = { dst: { is: true, uses: true }, id: s.IranDaylightTime, name: "Iran Daylight Time", offset: n.UTC_PLUS_4_30 };
var Ts = { dst: { is: false, uses: true }, id: s.IranStandardTime, name: "Iran Standard Time", offset: n.UTC_PLUS_3_30 };
var ps = { dst: { is: false, uses: true }, id: s.IrishStandardTime, name: "Irish Standard Time", offset: n.UTC_PLUS_1 };
var bs = { dst: { is: false, uses: true }, id: s.IrkutskTime, name: "Irkutsk Time", offset: n.UTC_PLUS_8 };
var vs = { dst: { is: true, uses: true }, id: s.IsraelDaylightTime, name: "Israel Daylight Time", offset: n.UTC_PLUS_3 };
var Bs = { dst: { is: false, uses: true }, id: s.IsraelStandardTime, name: "Israel Standard Time", offset: n.UTC_PLUS_2 };
var Ns = { dst: { is: false, uses: true }, id: s.JapanStandardTime, name: "Japan Standard Time", offset: n.UTC_PLUS_9 };
var Us = { dst: { is: false, uses: true }, id: s.KaliningradTime, name: "Kaliningrad Time", offset: n.UTC_PLUS_2 };
var Ds = { dst: { is: false, uses: true }, id: s.KamchatkaTime, name: "Kamchatka Time", offset: n.UTC_PLUS_12 };
var Ps = { dst: { is: false, uses: true }, id: s.KoreaStandardTime, name: "Korea Standard Time", offset: n.UTC_PLUS_9 };
var ks = { dst: { is: false, uses: true }, id: s.KosraeTime, name: "Kosrae Time", offset: n.UTC_PLUS_11 };
var Ms = { dst: { is: false, uses: true }, id: s.KrasnoyarskTime, name: "Krasnoyarsk Time", offset: n.UTC_PLUS_7 };
var ys = { dst: { is: false, uses: true }, id: s.KyrgyzstanTime, name: "Kyrgyzstan Time", offset: n.UTC_PLUS_6 };
var Fs = { dst: { is: false, uses: true }, id: s.LineIslandsTime, name: "Line Islands Time", offset: n.UTC_PLUS_14 };
var Ls = { dst: { is: false, uses: true }, id: s.LordHoweStandardTime, name: "Lord Howe Standard Time", offset: n.UTC_PLUS_10_30 };
var qs = { dst: { is: false, uses: true }, id: s.LordHoweSummerTime, name: "Lord Howe Summer Time", offset: n.UTC_PLUS_11 };
var Gs = { dst: { is: false, uses: true }, id: s.MacquarieIslandStationTime, name: "Macquarie Island Station Time", offset: n.UTC_PLUS_11 };
var ws = { dst: { is: false, uses: true }, id: s.MagadanTime, name: "Magadan Time", offset: n.UTC_PLUS_12 };
var Ks = { dst: { is: false, uses: true }, id: s.MalaysiaStandardTime, name: "Malaysia Standard Time", offset: n.UTC_PLUS_8 };
var xs = { dst: { is: false, uses: true }, id: s.MalaysiaTime, name: "Malaysia Time", offset: n.UTC_PLUS_8 };
var Os = { dst: { is: false, uses: true }, id: s.MaldivesTime, name: "Maldives Time", offset: n.UTC_PLUS_5 };
var Hs = { dst: { is: false, uses: true }, id: s.MarquesasIslandsTime, name: "Marquesas Islands Time", offset: n.UTC_PLUS_9_30 };
var js = { dst: { is: false, uses: true }, id: s.MarshallIslandsTime, name: "Marshall Islands Time", offset: n.UTC_PLUS_12 };
var Vs = { dst: { is: false, uses: true }, id: s.MauritiusTime, name: "Mauritius Time", offset: n.UTC_PLUS_4 };
var zs = { dst: { is: false, uses: true }, id: s.MawsonStationTime, name: "Mawson Station Time", offset: n.UTC_PLUS_5 };
var Ws = { dst: { is: false, uses: true }, id: s.MiddleEuropeanSummerTime, name: "Middle European Summer Time", offset: n.UTC_PLUS_2 };
var Rs = { dst: { is: false, uses: true }, id: s.MiddleEuropeanTime, name: "Middle European Time", offset: n.UTC_PLUS_1 };
var Js = { dst: { is: false, uses: true }, id: s.MoscowTime, name: "Moscow Time", offset: n.UTC_PLUS_3 };
var Zs = { dst: { is: false, uses: true }, id: s.MountainDaylightTime, name: "Mountain Daylight Time", offset: n.UTC_MINUS_6 };
var Ys = { dst: { is: false, uses: true }, id: s.MountainStandardTime, name: "Mountain Standard Time", offset: n.UTC_MINUS_7 };
var $s = { dst: { is: false, uses: true }, id: s.MyanmarStandardTime, name: "Myanmar Standard Time", offset: n.UTC_PLUS_6_30 };
var Qs = { dst: { is: false, uses: true }, id: s.NepalTime, name: "Nepal Time", offset: n.UTC_PLUS_5_45 };
var Xs = { dst: { is: false, uses: true }, id: s.NauruTime, name: "Nauru Time", offset: n.UTC_PLUS_12 };
var Cs = { dst: { is: false, uses: true }, id: s.NewCaledoniaTime, name: "New Caledonia Time", offset: n.UTC_PLUS_11 };
var au = { dst: { is: false, uses: true }, id: s.NewZealandDaylightTime, name: "New Zealand Daylight Time", offset: n.UTC_PLUS_13 };
var eu = { dst: { is: false, uses: true }, id: s.NewZealandStandardTime, name: "New Zealand Standard Time", offset: n.UTC_PLUS_12 };
var iu = { dst: { is: false, uses: true }, id: s.NewfoundlandDaylightTime, name: "Newfoundland Daylight Time", offset: n.UTC_MINUS_2_30 };
var nu = { dst: { is: false, uses: true }, id: s.NewfoundlandTime, name: "Newfoundland Time", offset: n.UTC_MINUS_3_30 };
var su = { dst: { is: false, uses: true }, id: s.NiueTime, name: "Niue Time", offset: n.UTC_MINUS_11 };
var uu = { dst: { is: false, uses: true }, id: s.NorfolkIslandTime, name: "Norfolk Island Time", offset: n.UTC_PLUS_11 };
var ru = { dst: { is: false, uses: true }, id: s.NovosibirskTime, name: "Novosibirsk Time", offset: n.UTC_PLUS_7 };
var tu = { dst: { is: false, uses: true }, id: s.OmskTime, name: "Omsk Time", offset: n.UTC_PLUS_6 };
var lu = { dst: { is: false, uses: true }, id: s.OralTime, name: "Oral Time", offset: n.UTC_PLUS_5 };
var mu = { dst: { is: false, uses: true }, id: s.PacificDaylightTime, name: "Pacific Daylight Time", offset: n.UTC_MINUS_7 };
var ou = { dst: { is: false, uses: true }, id: s.PacificStandardTime, name: "Pacific Standard Time", offset: n.UTC_MINUS_8 };
var cu = { dst: { is: false, uses: true }, id: s.PakistanStandardTime, name: "Pakistan Standard Time", offset: n.UTC_PLUS_5 };
var Au = { dst: { is: false, uses: true }, id: s.PalauTime, name: "Palau Time", offset: n.UTC_PLUS_9 };
var du = { dst: { is: false, uses: true }, id: s.PapuaNewGuineaTime, name: "Papua New Guinea Time", offset: n.UTC_PLUS_10 };
var Iu = { dst: { is: false, uses: true }, id: s.ParaguaySummerTime, name: "Paraguay Summer Time", offset: n.UTC_MINUS_3 };
var hu = { dst: { is: false, uses: true }, id: s.ParaguayTime, name: "Paraguay Time", offset: n.UTC_MINUS_4 };
var gu = { dst: { is: false, uses: true }, id: s.PeruTime, name: "Peru Time", offset: n.UTC_MINUS_5 };
var fu = { dst: { is: false, uses: true }, id: s.PhilippineStandardTime, name: "Philippine Standard Time", offset: n.UTC_PLUS_8 };
var _u = { dst: { is: false, uses: true }, id: s.PhilippineTime, name: "Philippine Time", offset: n.UTC_PLUS_8 };
var Eu = { dst: { is: false, uses: true }, id: s.PhoenixIslandTime, name: "Phoenix Island Time", offset: n.UTC_PLUS_13 };
var Su = { dst: { is: false, uses: true }, id: s.PitcairnTime, name: "Pitcairn Time", offset: n.UTC_MINUS_8 };
var Tu = { dst: { is: false, uses: true }, id: s.PohnpeiStandardTime, name: "Pohnpei Standard Time", offset: n.UTC_PLUS_11 };
var pu = { dst: { is: false, uses: true }, id: s.ReunionTime, name: "Reunion Time", offset: n.UTC_PLUS_4 };
var bu = { dst: { is: false, uses: true }, id: s.RotheraResearchStationTime, name: "Rothera Research Station Time", offset: n.UTC_MINUS_3 };
var vu = { dst: { is: false, uses: true }, id: s.SaintPierreAndMiquelonDaylightTime, name: "Saint Pierre and Miquelon Daylight Time", offset: n.UTC_MINUS_2 };
var Bu = { dst: { is: false, uses: true }, id: s.SaintPierreAndMiquelonStandardTime, name: "Saint Pierre and Miquelon Standard Time", offset: n.UTC_MINUS_3 };
var Nu = { dst: { is: false, uses: true }, id: s.SakhalinIslandTime, name: "Sakhalin Island Time", offset: n.UTC_PLUS_11 };
var Uu = { dst: { is: false, uses: true }, id: s.SamaraTime, name: "Samara Time", offset: n.UTC_PLUS_4 };
var Du = { dst: { is: false, uses: true }, id: s.SamoaDaylightTime, name: "Samoa Daylight Time", offset: n.UTC_MINUS_10 };
var Pu = { dst: { is: false, uses: true }, id: s.SamoaStandardTime, name: "Samoa Standard Time", offset: n.UTC_MINUS_11 };
var ku = { dst: { is: false, uses: true }, id: s.SeychellesTime, name: "Seychelles Time", offset: n.UTC_PLUS_4 };
var Mu = { dst: { is: false, uses: true }, id: s.ShowaStationTime, name: "Showa Station Time", offset: n.UTC_PLUS_3 };
var yu = { dst: { is: false, uses: true }, id: s.SingaporeStandardTime, name: "Singapore Standard Time", offset: n.UTC_PLUS_8 };
var Fu = { dst: { is: false, uses: true }, id: s.SingaporeTime, name: "Singapore Time", offset: n.UTC_PLUS_8 };
var Lu = { dst: { is: false, uses: true }, id: s.SolomonIslandsTime, name: "Solomon Islands Time", offset: n.UTC_PLUS_11 };
var qu = { dst: { is: false, uses: true }, id: s.SouthAfricanStandardTime, name: "South African Standard Time", offset: n.UTC_PLUS_2 };
var Gu = { dst: { is: false, uses: true }, id: s.SouthGeorgiaAndTheSouthSandwichIslandsTime, name: "South Georgia and the South Sandwich Islands Time", offset: n.UTC_MINUS_2 };
var wu = { dst: { is: false, uses: true }, id: s.SrednekolymskTime, name: "Srednekolymsk Time", offset: n.UTC_PLUS_11 };
var Ku = { dst: { is: false, uses: true }, id: s.SriLankaStandardTime, name: "Sri Lanka Standard Time", offset: n.UTC_PLUS_5_30 };
var xu = { dst: { is: false, uses: true }, id: s.SurinameTime, name: "Suriname Time", offset: n.UTC_MINUS_3 };
var Ou = { dst: { is: false, uses: true }, id: s.TahitiTime, name: "Tahiti Time", offset: n.UTC_MINUS_10 };
var Hu = { dst: { is: false, uses: true }, id: s.TajikistanTime, name: "Tajikistan Time", offset: n.UTC_PLUS_5 };
var ju = { dst: { is: false, uses: true }, id: s.ThailandStandardTime, name: "Thailand Standard Time", offset: n.UTC_PLUS_7 };
var Vu = { dst: { is: false, uses: true }, id: s.TimorLesteTime, name: "Timor-Leste Time", offset: n.UTC_PLUS_9 };
var zu = { dst: { is: false, uses: true }, id: s.TokelauTime, name: "Tokelau Time", offset: n.UTC_PLUS_13 };
var Wu = { dst: { is: false, uses: true }, id: s.TongaTime, name: "Tonga Time", offset: n.UTC_PLUS_13 };
var Ru = { dst: { is: false, uses: true }, id: s.TurkeyTime, name: "Turkey Time", offset: n.UTC_PLUS_3 };
var Ju = { dst: { is: false, uses: true }, id: s.TurkmenistanTime, name: "Turkmenistan Time", offset: n.UTC_PLUS_5 };
var Zu = { dst: { is: false, uses: true }, id: s.TuvaluTime, name: "Tuvalu Time", offset: n.UTC_PLUS_12 };
var Yu = { dst: { is: false, uses: true }, id: s.UlaanbaatarStandardTime, name: "Ulaanbaatar Standard Time", offset: n.UTC_PLUS_8 };
var $u = { dst: { is: false, uses: true }, id: s.UlaanbaatarSummerTime, name: "Ulaanbaatar Summer Time", offset: n.UTC_PLUS_9 };
var Qu = { dst: { is: false, uses: true }, id: s.UruguayStandardTime, name: "Uruguay Standard Time", offset: n.UTC_MINUS_3 };
var Xu = { dst: { is: false, uses: true }, id: s.UruguaySummerTime, name: "Uruguay Summer Time", offset: n.UTC_MINUS_2 };
var Cu = { dst: { is: false, uses: true }, id: s.UzbekistanTime, name: "Uzbekistan Time", offset: n.UTC_PLUS_5 };
var ar = { dst: { is: false, uses: true }, id: s.VanuatuTime, name: "Vanuatu Time", offset: n.UTC_PLUS_11 };
var er = { dst: { is: false, uses: true }, id: s.VenezuelaStandardTime, name: "Venezuela Standard Time", offset: n.UTC_MINUS_4 };
var ir = { dst: { is: false, uses: true }, id: s.VladivostokTime, name: "Vladivostok Time", offset: n.UTC_PLUS_10 };
var nr = { dst: { is: false, uses: true }, id: s.VolgogradTime, name: "Volgograd Time", offset: n.UTC_PLUS_4 };
var sr = { dst: { is: false, uses: true }, id: s.VostokStationTime, name: "Vostok Station Time", offset: n.UTC_PLUS_6 };
var ur = { dst: { is: false, uses: true }, id: s.WakeIslandTime, name: "Wake Island Time", offset: n.UTC_PLUS_12 };
var rr = { dst: { is: false, uses: true }, id: s.WestAfricaSummerTime, name: "West Africa Summer Time", offset: n.UTC_PLUS_2 };
var tr = { dst: { is: false, uses: true }, id: s.WestAfricaTime, name: "West Africa Time", offset: n.UTC_PLUS_1 };
var lr = { dst: { is: false, uses: true }, id: s.WestGreenlandSummerTime, name: "West Greenland Summer Time", offset: n.UTC_MINUS_2 };
var mr = { dst: { is: false, uses: true }, id: s.WestGreenlandTime, name: "West Greenland Time", offset: n.UTC_MINUS_3 };
var or = { dst: { is: false, uses: true }, id: s.WestKazakhstanTime, name: "West Kazakhstan Time", offset: n.UTC_PLUS_5 };
var cr = { dst: { is: false, uses: true }, id: s.WesternEuropeanSummerTime, name: "Western European Summer Time", offset: n.UTC_PLUS_1 };
var Ar = { dst: { is: false, uses: true }, id: s.WesternEuropeanTime, name: "Western European Time", offset: n.UTC_0 };
var dr = { dst: { is: false, uses: true }, id: s.WesternIndonesianTime, name: "Western Indonesian Time", offset: n.UTC_PLUS_7 };
var Ir = { dst: { is: false, uses: true }, id: s.WesternStandardTime, name: "Western Standard Time", offset: n.UTC_PLUS_8 };
var hr = { dst: { is: false, uses: true }, id: s.YakutskTime, name: "Yakutsk Time", offset: n.UTC_PLUS_9 };
var gr = { dst: { is: false, uses: true }, id: s.YekaterinburgTime, name: "Yekaterinburg Time", offset: n.UTC_PLUS_5 };
var T;
(function(a) {
...
var fr = { Afghanistan: { i18n: { calling_codes: [93], currencies: [m.AfghanistanAfghani], languages: [e.Pashto, e.Dari, e.Turkmen, e.Uzbek], tz: { offsets: [n.UTC_PLUS_4_30], regions: [u.AsiaKabul], timezones: [s.AfghanistanTime] } }, id: r.Afghanistan, info: { flag: { emoji: "\u{1F1E6}\u{1F1EB}", emoji_unicode: "U+1F1E6 U+1F1EB", svg: "https://www.countryflags.io/af/flat/64.svg" }, tld: [".af"] }, iso: { alpha2: r.Afghanistan, alpha3: "AFG", numeric: "004" }, name: { alt_spellings: ["AF", "Af\u0121\u0101nist\u0101n"], demonym: "Afghan", native: { endonym: "\u0627\u0641\u063A\u0627\u0646\u0633\u062A\u0627\u0646" }, official: "Islamic Republic of Afghanistan", short: "Afghanistan", translations: { [e.Afrikaans]: "Afghanistan", [e.Albanian]: "Shqip\xEBri", [e.Amharic]: "\u12A0\u134D\u130B\u1295", [e.Arabic]: "\u0623\u0641\u063A\u0627\u0646\u0633\u062A\u0627\u0646", [e.Armenian]: "\u0540\u0561\u0575\u0561\u057D\u057F\u0561\u0576", [e.Azerbaijani]: "Az\u0259rbaycan", [e.Bashkir]: "\u0410\u0444\u0433\u0430\u043D\u0438\u0441\u0442\u0430\u043D", [e.Basque]: "Afganist\xE1n", [e.Belarusian]: "\u0410\u0444\u0433\u0430\u043D\u0438\u0441\u0442\u0430\u043D", [e.Bengali]: "\u0986\u09AB\u0997\u09BE\u09A8\u09BF\u09B8\u09CD\u09A4\u09BE\u09A8", [e.Berber]: "\u0623\u0641\u063A\u0627\u0646\u0633\u062A\u0627\u0646", [e.Bhutani]: "\u0F60\u0F56\u0FB2\u0F74\u0F42\u0F0B\u0F61\u0F74\u0F63\u0F0B\u0F66\u0FA4\u0FB2\u0F7C\u0F51\u0F0B\u0F40\u0FB1\u0F72\u0F0B\u0F51\u0F7C\u0F53\u0F0B\u0F63\u0F7A\u0F0B\u0F66\u0F90\u0F51\u0F0B\u0F46\u0F0D", [e.Bosnian]: "\u0410\u0444\u0433\u0430\u043D\u0438\u0441\u0442\u0430\u043D", [e.Breton]: "Afganistan", [e.Bulgarian]: "\u0410\u0444\u0433\u0430\u043D\u0438\u0441\u0442\u0430\u043D", [e.Burmese]: "\u1021\u102C\u1019\u1001\u103B\u1004\u103A\u1010\u1031\u102C\u103A", [e.Catalan]: "Afganistan", [e.Chinese]: "\u963F\u5BCC\u6C57", [e.Croatian]: "Afganistan", [e.Czech]: "Afganistan", [e.Danish]: "Afghanistan", [e.Dutch]: "Afghanistan", [e.English]: "Afghanistan", [e.Esperanto]: "Afganistan", [e.Estonian]: "Afganistan", [e.Finnish]: "Afghanistan", [e.French]: "Afghanistan", [e.Frisian]: "Afghanistan", [e.Galician]: "Afganist\xE1n", [e.Georgian]: "\u10D0\u10D5\u10E6\u10D0\u10DC\u10D4\u10D7\u10D8", [e.German]: "Afghanistan", [e.Greenlandic]: "Afghanistan", [e.Greek]: "\u0391\u03C6\u03B3\u03B1\u03BD\u03B9\u03C3\u03C4\u03AC\u03BD", [e.Gujarati]: "\u0A85\u0AAB\u0A97\u0ABE\u0AA8\u0ABF\u0AB8\u0ACD\u0AA4\u0ABE\u0AA8", [e.Haitian]: "Afghanistan", [e.Hausa]: "Afghanistan", [e.Hebrew]: "\u05D0\u05E4\u05D2\u05E0\u05D9\u05E1\u05D8\u05DF", [e.Hindi]: "\u0905\u092B\u0917\u093E\u0928\u093F\u0938\u094D\u0924\u093E\u0928", [e.Hungarian]: "Afganistan", [e.Icelandic]: "Afghanistan", [e.Igbo]: "Afghanistan", [e.Indonesian]: "Afghanistan", [e.Irish]: "Afghanistan", [e.Italian]: "Afghanistan", [e.Japanese]: "\u30A2\u30D5\u30AC\u30CB\u30B9\u30BF\u30F3", [e.Javanese]: "Afghanistan", [e.Kannada]: "\u0C85\u0CAB\u0C97\u0CBE\u0CA8\u0CBF\u0CB8\u0CCD\u0CA4\u0CBE\u0CA8", [e.Kazakh]: "\u0410\u0444\u0433\u0430\u043D\u0438\u0441\u0442\u0430\u043D", [e.Khmer]: "\u17A2\u17B6\u17A0\u17D2\u179C\u17D2\u179A\u17B7\u1780", [e.Korean]: "\uC544\uD504\uAC00\uB2C8\uC2A4\uD0C4", [e.Kurdish]: "Afghanistan", [e.Kyrgyz]: "\u0410\u0444\u0433\u0430\u043D\u0438\u0441\u0442\u0430\u043D", [e.Lao]: "\u0EAD\u0EB2\u0E9F\u0EB2\u0EA5\u0EBD\u0E99", [e.Latin]: "Afghanistan", [e.Latvian]: "Afghanistan", [e.Lithuanian]: "Afganistanas", [e.Luxembourgish]: "Afghanistan", [e.Macedonian]: "\u0410\u0444\u0433\u0430\u043D\u0438\u0441\u0442\u0430\u043D", [e.Malagasy]: "Afghanistan", [e.Malay]: "Afghanistan", [e.Malayalam]: "\u0D05\u0D2B\u0D17\u0D3E\u0D28\u0D3F\u0D38\u0D4D\u0D24\u0D3E\u0D28", [e.Maltese]: "Afghanistan", [e.Maori]: "Afghanistan", [e.Marathi]: "\u0905\u092B\u0917\u093E\u0928\u093F\u0938\u094D\u0924\u093E\u0928", [e.Mongolian]: "\u0410\u0444\u0433\u0430\u043D\u0438\u0441\u0442\u0430\u043D", [e.Nepali]: "\u0905\u092B\u0917\u093E\u0928\u093F\u0938\u094D\u0924\u093E\u0928", [e.Norwegian]: "Afghanistan", [e.Pashto]: "\u0627\u0641\u063A\u0627\u0646\u0633\u062A\u0627\u0646", [e.Persian]: "\u0627\u0641\u063A\u0627\u0646\u0633\u062A\u0627\u0646", [e.Polish]: "Afganistan", [e.Portuguese]: "Afghanistan", [e.Punjabi]: "Afghanistan", [e.Romanian]: "Afghanistan", [e.Polish]: "Afganistan", [e.Russian]: "\u0410\u0444\u0433\u0430\u043D\u0438\u0441\u0442\u0430\u043D", [e.Samoan]: "Afghanistan", [e.Sanskrit]: "\u0905\u092B\u0917\u093E\u0928\u093F\u0938\u094D\u0924\u093E\u0928", [e.Scots]: "Afghanistan", [e.Serbian]: "\u0410\u0444\u0433\u0430\u043D\u0438\u0441\u0442\u0430\u043D", [e.Sesotho]: "Afghanistan", [e.Shona]: "Afghanistan", [e.Sindhi]: "Afghanistan", [e.Sinhala]: "\u0D86\u0D9C\u0DCA\u200D\u0DBB\u0DDC\u0D9A\u0DCA\u0D9A\u0DD2\u0DBA\u0DCF\u0DC0", [e.Slovak]: "Afganistan", [e.Slovenian]: "Afganistan", [e.Somali]: "Afghanistan", [e.Spanish]: "Afganist\xE1n", [e.Sudanese]: "Afghanistan", [e.Swahili]: "Afghanistan", [e.Swedish]: "Afghanistan", [e.Tagalog]: "Afghanistan", [e.Tajik]: "\u0410\u0444\u0433\u0430\u043D\u0438\u0441\u0442\u0430\u043D", [e.Tatar]: "\u0410\u0444\u0433\u0430\u043D\u0438\u0441\u0442\u0430\u043D", [e.Tamil]: "\u0B86\u0BAA\u0BCD\u0BAA\u0B95\u0BBE\u0BA9\u0BBF\u0BB8\u0BCD\u0BA4\u0BBE\u0BA9\u0BCD", [e.Telugu]: "\u0C06\u0C2B\u0C4D\u0C18\u0C28\u0C3F\u0C38\u0C4D\u0C24\u0C3E\u0C28\u0C4D", [e.Thai]: "\u0E2D\u0E31\u0E1F\u0E01\u0E32\u0E19\u0E34\u0E2A\u0E16\u0E32\u0E19", [e.Tibetan]: "\u0F68\u0F55\u0F0B\u0F42\u0F7A\u0F0B\u0F53\u0F72\u0F66\u0F72\u0F0B\u0F4F\u0F7A\u0F53\u0F66\u0F72\u0F0D", [e.Turkish]: "Afganistan", [e.Ukrainian]: "\u0410\u0444\u0433\u0430\u043D\u0438\u0441\u0442\u0430\u043D", [e.Urdu]: "\u0627\u0641\u063A\u0627\u0646\u0633\u062A\u0627\u0646", [e.Uzbek]: "\u0410\u0444\u0433\u0430\u043D\u0438\u0441\u0442\u0430\u043D", [e.Vietnamese]: "Afghanistan", [e.Welsh]: "Afghanistan", [e.Xhosa]: "Afghanistan", [e.Yiddish]: "Afghanistan", [e.Yoruba]: "Afghanistan", [e.Zulu]: "Afghanistan" } }, statistics: { demographics: { age: { distribution: [{ age: "0 to 14 years", percentage: 15.3 }, { age: "15 to 64 years", percentage: 66.7 }, { age: "65 years and over", percentage: 14.6 }], median_age: 35.5 }, population: { largest_city: "Kabul", total: 341e5 } }, geography: { area: 652230, region: T.Asia, sub_region: p.SouthernAsia }, government: { capital: "Kabul", type: "Islamic Emirate" } } }, Albania: { i18n: { calling_codes: [355], currencies: [m.AlbaniaLek], languages: [e.Albanian, e.Greek, e.Turkish], tz: { offsets: [n.UTC_PLUS_1], regions: [u.EuropeBrussels], timezones: [s.CentralEuropeanTime] } }, id: r.Albania, info: { flag: { emoji: "\u{1F1E6}\u{1F1F1}", emoji_unicode: "U+1F1E6 U+1F1F1", svg: "https://www.countryflags.io/al/flat/64.svg" }, tld: [".al"] }, iso: { alpha2: r.Albania, alpha3: "ALB", numeric: "008" }, name: { alt_spellings: ["AL", "Shqip\xEBri", "Shqip\xEBria", "Shqipnia"], demonym: "Albanian", native: { endonym: "Shqip\xEBri" }, official: "Republic of Albania", short: "Albania", translations: { [e.Afrikaans]: "Albania", [e.Albanian]: "Albania", [e.Amharic]: "\u12A0\u120D\u1263\u1295\u12EB", [e.Arabic]: "\u0623\u0644\u0628\u0627\u0646\u064A\u0627", [e.Armenian]: "\u0540\u0561\u0575\u0561\u057D\u057F\u0561\u0576", [e.Azerbaijani]: "Az\u0259rbaycan", [e.Bashkir]: "\u0410\u043B\u0431\u0430\u043D\u0438\u044F", [e.Basque]: "Albania", [e.Belarusian]: "\u0410\u043B\u0431\u0430\u043D\u0438\u044F", [e.Bengali]: "\u0986\u09B2\u09AC\u09BE\u09A8\u09BF\u09AF\u09BC\u09BE", [e.Berber]: "\u0623\u0644\u0628\u0627\u0646\u064A\u0627", [e.Bhutani]: "\u0F60\u0F56\u0FB2\u0F74\u0F42\u0F0B\u0F61\u0F74\u0F63\u0F0B", [e.Bosnian]: "Albanija", [e.Breton]: "Albania", [e.Bulgarian]: "\u0410\u043B\u0431\u0430\u043D\u0438\u044F", [e.Burmese]: "\u1021\u102C\u1019\u1001\u103B\u1004\u103A\u1010\u1031\u102C\u103A", [e.Catalan]: "Alb\xE0nia", [e.Chinese]: "\u963F\u5C14\u5DF4\u5C3C\u4E9A", [e.Croatian]: "Albanija", [e.Czech]: "Alb\xE1nie", [e.Danish]: "Albanien", [e.Dutch]: "Albani\xEB", [e.English]: "Albania", [e.Esperanto]: "Albanio", [e.Estonian]: "Albaania", [e.Finnish]: "Albania", [e.French]: "Albanie", [e.Frisian]: "Albani\xEB", [e.Galician]: "Alb\xE2nia", [e.Georgian]: "\u10D0\u10DA\u10D1\u10D0\u10DC\u10D8\u10D0", [e.German]: "Albanien", [e.Greenlandic]: "Albania", [e.Greek]: "\u0391\u03BB\u03B2\u03B1\u03BD\u03AF\u03B1", [e.Gujarati]: "\u0A85\u0AB2\u0AAC\u0AA8\u0ABF\u0AAF\u0ABE", [e.Haitian]: "Albanais", [e.Hausa]: "Albania", [e.Hebrew]: "\u05D0\u05DC\u05D1\u05E0\u05D9\u05D4", [e.Hindi]: "\u0905\u0932\u094D\u092C\u093E\u0928\u093F\u092F\u093E", [e.Hungarian]: "Alb\xE1nia", [e.Icelandic]: "Alb\xFAnir", [e.Igbo]: "Albania", [e.Indonesian]: "Albania", [e.Irish]: "Alb\xE1in", [e.Italian]: "Albania", [e.Japanese]: "\u30A2\u30EB\u30D0\u30CB\u30A2", [e.Javanese]: "Albania", [e.Kannada]: "\u0C85\u0CB2\u0CCD\u0CAC\u0CBE\u0CA8\u0CBF\u0CAF\u0CBE", [e.Kazakh]: "\u0410\u043B\u0431\u0430\u043D\u0438\u044F", [e.Khmer]: "\u17A2\u17B6\u17A0\u17D2\u179C\u17D2\u179A\u17C1\u179F\u17CA\u17B8", [e.Korean]: "\uC54C\uBC14\uB2C8\uC544", [e.Kurdish]: "\u0622\u0644\u0628\u0627\u0646\u06CC\u0627", [e.Kyrgyz]: "\u0410\u043B\u0431\u0430\u043D\u0438\u044F", [e.Lao]: "\u0EAD\u0EB2\u0EA5\u0EB2\u0E99\u0EB5", [e.Latin]: "Albania", [e.Latvian]: "Alb\u0101nija", [e.Lithuanian]: "Albanija", [e.Luxembourgish]: "Albani\xEB", [e.Macedonian]: "\u0410\u043B\u0431\u0430\u043D\u0438\u0458\u0430", [e.Malagasy]: "Albania", [e.Malay]: "Albania", [e.Malayalam]: "\u0D05\u0D32\u0D4D\u0D2C\u0D3E\u0D28\u0D3F\u0D2F\u0D3E", [e.Maltese]: "Albania", [e.Maori]: "Albania", [e.Marathi]: "\u0905\u0932\u094D\u092C\u093E\u0928\u093F\u092F\u093E", [e.Mongolian]: "\u0410\u043B\u0431\u0430\u043D\u0438\u044F", [e.Nepali]: "\u0905\u0932\u094D\u092C\u093E\u0928\u093F\u092F\u093E", [e.Norwegian]: "Albania", [e.Pashto]: "\u0627\u0627\u0644\u0628\u0627\u0646\u06CC", [e.Persian]: "\u0622\u0644\u0628\u0627\u0646\u06CC", [e.Polish]: "Albania", [e.Portuguese]: "Alb\xE2nia", [e.Punjabi]: "\u0A05\u0A32\u0A2C\u0A28\u0A40\u0A06", [e.Romanian]: "Alb\u0103n", [e.Russian]: "\u0410\u043B\u0431\u0430\u043D\u0438\u044F", [e.Samoan]: "Albania", [e.Sanskrit]: "Albani", [e.Scots]: "Alb\xE0inia", [e.Serbian]: "\u0410\u043B\u0431\u0430\u043D\u0438\u0458\u0430", [e.Sesotho]: "Albania", [e.Shona]: "Albania", [e.Sindhi]: "Albania", [e.Sinhala]: "\u0D87\u0DBD\u0DCA\u0DB6\u0DCF\u0DB1\u0DD2\u0DBA", [e.Slovak]: "Alb\xE1nsko", [e.Slovenian]: "Albanija", [e.Somali]: "Albania", [e.Spanish]: "Albania", [e.Sudanese]: "Albania", [e.Swahili]: "Albania", [e.Swedish]: "Albanien", [e.Tagalog]: "Albania", [e.Tajik]: "\u0410\u043B\u0431\u0430\u043D\u0438\u044F", [e.Tamil]: "\u0B85\u0BB2\u0BCD\u0BAA\u0BBE\u0BA9\u0BBF\u0BAF\u0BBE", [e.Tatar]: "\u0410\u043B\u0431\u0430\u043D\u0438\u044F", [e.Telugu]: "\u0C05\u0C32\u0C4D\u0C2C\u0C3E\u0C28\u0C3F\u0C2F\u0C3E", [e.Thai]: "\u0E2D\u0E31\u0E25\u0E41\u0E1A\u0E19\u0E34\u0E19\u0E35", [e.Tibetan]: "\u0F68\u0F63\u0F0B\u0F56\u0F72\u0F0B\u0F53\u0F72\u0F0B\u0F61\u0F72", [e.Turkish]: "Albaniye", [e.Ukrainian]: "\u0410\u043B\u0431\u0430\u043D\u0456\u044F", [e.Urdu]: "\u0622\u0644\u0628\u0627\u0646\u06CC", [e.Uzbek]: "\u0410\u043B\u0431\u0430\u043D\u0438\u044F", [e.Vietnamese]: "Albanie", [e.Welsh]: "Albania", [e.Xhosa]: "Albania", [e.Yiddish]: "\u05D0\u05DC\u05D1\u05E0\u05D9\u05E9", [e.Yoruba]: "Albania", [e.Zulu]: "Albania" } }, statistics: { demographics: { age: { distribution: [{ age: "0 to 14 years", percentage: 15.3 }, { age: "15 to 64 years", percentage: 66.7 }, { age: "65 years and over", percentage: 14.6 }], median_age: 35.5 }, population: { largest_city: "Tirana", total: 2853e3 } }, geography: { area: 28748, region: T.Europe, sub_region: p.SouthernEurope }, government: { capital: "Tirana", type: "Republic" } } }, Algeria: { i18n: { calling_codes: [213], currencies: [m.AlgeriaDinar], languages: [e.Arabic, e.French, e.Berber, e.Tamazight], tz: { offsets: [n.UTC_PLUS_1, n.UTC_PLUS_2], regions: [u.AfricaAlgiers], timezones: [s.CentralEuropeanTime] } }, id: r.Algeria, info: { flag: { emoji: "\u{1F1E9}\u{1F1FF}", emoji_unicode: "U+1F1E9 U+1F1FF", svg: "https://www.countryflags.io/dz/flat/64.svg" }, tld: [".dz", ".\u062C\u0632\u0627\u0626\u0631"] }, iso: { alpha2: r.Algeria, alpha3: "DZA", numeric: "012" }, name: { alt_spellings: ["DZ", "Dzayer", "Alg\xE9rie"], demonym: "Algerian", native: { endonym: "\u0627\u0644\u062C\u0632\u0627\u0626\u0631" }, official: "People's Democratic Republic of Algeria", short: "Algeria", translations: { [e.Afrikaans]: "Algerije", [e.Albanian]: "Algeria", [e.Amharic]: "\u12A0\u120D\u1300\u122D\u1235", [e.Arabic]: "\u0627\u0644\u062C\u0632\u0627\u0626\u0631", [e.Armenian]: "\u0531\u056C\u0563\u0578\u0580\u056B\u0561", [e.Azerbaijani]: "Az\u0259rbaycan", [e.Bashkir]: "\u0410\u043B\u0436\u0438\u0440", [e.Basque]: "Algeria", [e.Belarusian]: "\u0410\u043B\u0436\u0438\u0440", [e.Bengali]: "\u0986\u09B2\u099C\u09C7\u09B0", [e.Berber]: "\u062C\u0632\u0627\u0626\u0631", [e.Bhutani]: "\u0F62\u0FAB\u0F7C\u0F44\u0F0B\u0F41", [e.Bosnian]: "Al\u017Eir", [e.Breton]: "Algeria", [e.Bulgarian]: "\u0410\u043B\u0436\u0438\u0440", [e.Burmese]: "\u1021\u102C\u101B\u1015\u103A", [e.Catalan]: "Alg\xE8ria", [e.Chinese]: "\u963F\u5C14\u53CA\u5229\u4E9A", [e.Croatian]: "Al\u017Eir", [e.Czech]: "Al\u017E\xEDrsko", [e.Danish]: "Algeriet", [e.Dutch]: "Algerije", [e.English]: "Algeria", [e.Esperanto]: "Al\u011Derio", [e.Estonian]: "Al\u017Eira", [e.Finnish]: "Algeria", [e.French]: "Alg\xE9rie", [e.Frisian]: "Algeri\xEB", [e.Galician]: "Alxeria", [e.Georgian]: "\u10D0\u10DA\u10D2\u10D8\u10E3\u10E0\u10D8", [e.German]: "Algerien", [e.Greenlandic]: "Algeria", [e.Greek]: "\u0391\u03BB\u03B3\u03B5\u03C1\u03AF\u03B1", [e.Gujarati]: "\u0A86\u0AB2\u0AC7\u0A97\u0AB0\u0ABF\u0AAF\u0ABE", [e.Haitian]: "Alg\xE9rie", [e.Hausa]: "Algeria", [e.Hebrew]: "\u05D0\u05DC\u05D2\u05F3\u05D9\u05E8\u05D9\u05D4", [e.Hindi]: "\u0906\u0932\u094D\u0917\u0947\u0930\u093F\u092F\u093E", [e.Hungarian]: "Alg\xE1r", [e.Icelandic]: "Alg\xFAra", [e.Igbo]: "Algeria", [e.Indonesian]: "Aljir", [e.Irish]: "Alg\xE9rie", [e.Italian]: "Algeria", [e.Japanese]: "\u30A2\u30EB\u30B8\u30A7\u30EA\u30A2", [e.Javanese]: "Aljir", [e.Kannada]: "\u0C86\u0CB2\u0CCD\u0C97\u0CC7\u0CB0\u0CBF\u0CAF\u0CA8\u0CCD", [e.Kazakh]: "\u0410\u043B\u0436\u0438\u0440", [e.Khmer]: "\u17A2\u17B6\u179B\u17CB\u1794\u17B6\u1793\u17B8", [e.Korean]: "\uC54C\uC81C\uB9AC", [e.Kurdish]: "\u062C\u0632\u0627\u06CC\u0631 \u0627\u0644\u062C\u0632\u0627\u06CC\u0631", [e.Kyrgyz]: "\u0410\u043B\u0436\u0438\u0440", [e.Lao]: "\u0EAD\u0EB2\u0EA5\u0EB2\u0E88\u0EB5\u0E99", [e.Latin]: "Algeria", [e.Latvian]: "Al\u017E\u012Brija", [e.Lithuanian]: "Al\u017Eyras", [e.Luxembourgish]: "Algeria", [e.Macedonian]: "\u0410\u043B\u0436\u0438\u0440", [e.Malagasy]: "Alg\xE9rie", [e.Malay]: "Aljir", [e.Malayalam]: "\u0D06\u0D32\u0D02\u0D17\u0D47\u0D30\u0D3F\u0D2F\u0D7B", [e.Maltese]: "Alg\xE9rie", [e.Maori]: "Algeria", [e.Marathi]: "\u0906\u0932\u094D\u0917\u0947\u0930\u093F\u092F\u093E", [e.Mongolian]: "\u0410\u043B\u0436\u0438\u0440", [e.Nepali]: "\u0906\u0932\u094D\u0917\u0947\u0930\u093F\u092F\u093E", [e.Norwegian]: "Algeria", [e.Pashto]: "\u0627\u0644\u062C\u0632\u0627\u0626\u0631", [e.Persian]: "\u062C\u0632\u0627\u06CC\u0631 \u0627\u0644\u0639\u0631\u0628", [e.Polish]: "Algieria", [e.Portuguese]: "Alg\xE9ria", [e.Punjabi]: "\u0A06\u0A32\u0A47\u0A17\u0A40\u0A06", [e.Romanian]: "Algeria", [e.Russian]: "\u0410\u043B\u0436\u0438\u0440", [e.Samoan]: "Algeria", [e.Sanskrit]: "\u0906\u0932\u094D\u0917\u0947\u0930\u093F\u092F\u093E", [e.Scots]: "Algeria", [e.Serbian]: "\u0410\u043B\u0436\u0438\u0440", [e.Sesotho]: "Algeria", [e.Shona]: "Algeria", [e.Sindhi]: "Algeria", [e.Sinhala]: "\u0D86\u0DBD\u0DCA\u0DB6\u0DCF\u0DB1\u0DD2\u0DBA", [e.Slovak]: "Al\u017E\xEDrsko", [e.Slovenian]: "Al\u017Eir", [e.Somali]: "Algeria", [e.Spanish]: "Algeria", [e.Sudanese]: "Aljir", [e.Swahili]: "Aljir", [e.Swedish]: "Algeriet", [e.Tagalog]: "Algeria", [e.Tajik]: "\u0410\u043B\u0436\u0438\u0440", [e.Tamil]: "\u0B86\u0BB2\u0BCD\u0B95\u0BC7\u0BB0\u0BBF\u0BAF\u0BBE", [e.Tatar]: "\u0410\u043B\u0436\u0438\u0440", [e.Telugu]: "\u0C06\u0C32\u0C4D\u0C17\u0C47\u0C30\u0C3F\u0C2F\u0C3E", [e.Thai]: "\u0E2D\u0E32\u0E23\u0E32\u0E01\u0E2D\u0E19", [e.Tibetan]: "\u0F68\u0F63\u0F9F\u0F72\u0F0B\u0F62\u0F72\u0F0B\u0F61\u0F72", [e.Turkish]: "Cezayir", [e.Ukrainian]: "\u0410\u043B\u0436\u0438\u0440", [e.Urdu]: "\u0622\u0644\u062C\u06CC\u0631", [e.Uzbek]: "\u0410\u043B\u0436\u0438\u0440", [e.Vietnamese]: "\u1EA2\u0301\u1EA1\u1EA3\u1EAD\u1EB5", [e.Welsh]: "Algeria", [e.Xhosa]: "Algeria", [e.Yiddish]: "\u05D0\u05DC\u05D2\u05F3\u05D9\u05E8\u05D9\u05D4", [e.Yoruba]: "Algeria", [e.Zulu]: "Algeria" } }, statistics: { demographics: { age: { distribution: [{ age: "0 to 14 years", percentage: 15.3 }, { age: "15 to 64 years", percentage: 66.7 }, { age: "65 years and over", percentage: 14.6 }], median_age: 35.5 }, population: { largest_city: "Oran", total: 371e5 } }, geography: { area: 2381740, region: T.Africa, sub_region: p.NorthernAfrica }, government: { capital: "Algiers", type: "Republic" } } }, AmericanSamoa: { i18n: { calling_codes: [1684], currencies: [m.AmericanSamoaTala], languages: [e.English, e.Samoan], tz: { offsets: [n.UTC_MINUS_11], regions: [u.PacificSamoa], timezones: [s.SamoaStandardTime] } }, id: r.AmericanSamoa, info: { flag: { emoji: "\u{1F1E6}\u{1F1F8}", emoji_unicode: "U+1F1E6 U+1F1F8", svg: "https://www.countryflags.io/as/flat/64.svg" }, tld: [".as"] }, iso: { alpha2: r.AmericanSamoa, alpha3: "ASM", numeric: "016" }, name: { alt_spellings: ["AS", "Amerika S\u0101moa", "Amelika S\u0101moa", "S\u0101moa Amelika"], demonym: "American Samoan", native: { endonym: "American Samoa" }, official: "American Samoa", short: "American Samoa", translations: { [e.Afrikaans]: "Amerikaans Samoa", [e.Albanian]: "Samoa Amerikane", [e.Amharic]: "\u1233\u121E\u12A0\u122D", [e.Arabic]: "\u0633\u0627\u0645\u0648\u0627 \u0627\u0644\u0623\u0645\u0631\u064A\u0643\u064A\u0629", [e.Armenian]: "\u054D\u0561\u0570\u0561\u0574\u0561\u056C\u056B\u0561", [e.Azerbaijani]: "Samoa Amerikana", [e.Bashkir]: "\u0410\u043C\u0435\u0440\u0438\u043A\u0430\u043D\u0441\u043A\u0438 \u0421\u0430\u043C\u043E\u0430", [e.Basque]: "Samoa Amerikana", [e.Belarusian]: "\u0410\u043C\u0435\u0440\u0438\u043A\u0430\u043D\u0441\u043A\u0430\u044F \u0421\u0430\u043C\u043E\u0430", [e.Bengali]: "\u0986\u09AE\u09C7\u09B0\u09BF\u0995\u09BE\u09A8 \u09B8\u09BE\u09AE\u09CB\u09AF\u09BC\u09BE", [e.Berber]: "\u062C\u0632\u0631 \u0633\u0627\u0645\u0648\u0627 \u0627\u0644\u0623\u0645\u0631\u064A\u0643\u064A\u0629", [e.Bhutani]: "\u0F68\u0F62\u0F92\u0FB1\u0F0B\u0F58\u0F72\u0F0B\u0F51\u0F58\u0F44\u0F66\u0F0B\u0F66\u0FA4\u0FB2\u0F7C\u0F51\u0F0B\u0F40\u0FB1\u0F72\u0F0B\u0F66\u0F90\u0F56\u0F66\u0F0B\u0F62\u0F92\u0FB1\u0F74\u0F51\u0F0B\u0F46\u0F7A\u0F53\u0F0B\u0F54\u0F7C\u0F0D", [e.Bosnian]: "Ameri\u010Dka Samoa", [e.Breton]: "Samoa Amerikan", [e.Bulgarian]: "\u0410\u043C\u0435\u0440\u0438\u043A\u0430\u043D\u0441\u043A\u0430 \u0421\u0430\u043C\u043E\u0430", [e.Burmese]: "\u1021\u1019\u1039\u1038\u1019\u101B\u102D\u102F\u1018\u102C\u101E\u102C", [e.Catalan]: "Samoa Americana", [e.Chinese]: "\u7F8E\u5C5E\u8428\u6469\u4E9A", [e.Croatian]: "Ameri\u010Dka Samoa", [e.Czech]: "Americk\xE1 Samoa", [e.Danish]: "Amerikansk Samoa", [e.Dutch]: "Amerikaans Samoa", [e.English]: "American Samoa", [e.Esperanto]: "Samoa Amerika", [e.Estonian]: "Ameerika Samoa", [e.Finnish]: "Amerikka Samoa", [e.French]: "American Samoa", [e.Frisian]: "Amerikaans Samoa", [e.Galician]: "Samoa Americana", [e.Georgian]: "\u10D0\u10DB\u10D4\u10E0\u10D8\u10D9\u10D8\u10E1 \u10E1\u10D0\u10DB\u10DD\u10D0", [e.German]: "Amerikanisch-Samoa", [e.Greenlandic]: "Amerikaans Samoa", [e.Greek]: "\u0391\u03BC\u03B5\u03C1\u03B9\u03BA\u03B1\u03BD\u03B9\u03BA\u03AE \u03A3\u03B1\u03BC\u03CC\u03B1", [e.Gujarati]: "\u0A86\u0AAE\u0AC7\u0AB0\u0ABF\u0A95\u0AA8 \u0AB8\u0ABE\u0AAE\u0ACB\u0AAF\u0ABE", [e.Haitian]: "Amerikaans Samoa", [e.Hausa]: "Amerikaans Samoa", [e.Hebrew]: "\u05D0\u05DE\u05E8\u05D9\u05E7\u05E0\u05D9\u05D4 \u05E1\u05DE\u05D5\u05D0\u05D4", [e.Hindi]: "\u0905\u092E\u0947\u0930\u093F\u0915\u093E \u0938\u092E\u094B\u0906", [e.Hungarian]: "Amerikai Szamoa", [e.Icelandic]: "Amerikai Szamoa", [e.Igbo]: "Ikina Amerika", [e.Indonesian]: "Samoa Amerika", [e.Irish]: "Samoa Amerikana", [e.Italian]: "Samoa Americane", [e.Japanese]: "\u30A2\u30E1\u30EA\u30AB\u9818\u30B5\u30E2\u30A2", [e.Javanese]: "Samoa Amerika", [e.Kannada]: "\u0C85\u0CAE\u0CC7\u0CB0\u0CBF\u0C95\u0CA8\u0CCD \u0CB8\u0CAE\u0CCB\u0C86", [e.Kazakh]: "\u0410\u043C\u0435\u0440\u0438\u043A\u0430\u043D\u0441\u043A\u0438\u0439 \u0421\u0430\u043C\u043E\u0430", [e.Khmer]: "\u17A2\u17B6\u1798\u17C9\u17B6\u179A\u17B8\u179F\u17D2\u178F\u1784\u17CB", [e.Korean]: "\uC544\uBA54\uB9AC\uCE74 \uC0AC\uBAA8\uC544", [e.Kurdish]: "Amerikaans Samoa", [e.Kyrgyz]: "\u0410\u043C\u0435\u0440\u0438\u043A\u0430\u043D\u0441\u043A\u0438\u0439 \u0421\u0430\u043C\u043E\u0430", [e.Lao]: "\u0EAD\u0EB2\u0EA1\u0EB2\u0E99\u0EB2\u0E94\u0EB2\u0EA1\u0EB2\u0E99\u0EB2\u0E94", [e.Latin]: "Samoa Amerikana", [e.Latvian]: "Amerikas Samoa", [e.Lithuanian]: "Amerikos Samoa", [e.Luxembourgish]: "Amerikaans Samoa", [e.Macedonian]: "\u0410\u043C\u0435\u0440\u0438\u043A\u0430\u043D\u0441\u043A\u0430 \u0421\u0430\u043C\u043E\u0430", [e.Malagasy]: "Samoa Amerika", [e.Malay]: "Amerika Samo", [e.Malayalam]: "\u0D05\u0D2E\u0D47\u0D30\u0D3F\u0D15\u0D4D\u0D15\u0D28\u0D4D\u0D31\u0D4D \u0D38\u0D2E\u0D4B\u0D06", [e.Maltese]: "Samoa Amerika", [e.Maori]: "Samoa Amerika", [e.Marathi]: "\u0905\u092E\u0947\u0930\u093F\u0915\u093E \u0938\u092E\u094B\u0906", [e.Mongolian]: "\u0410\u043C\u0435\u0440\u0438\u043A\u0430\u043D\u0441\u043A\u0438\u0439 \u0421\u0430\u043C\u043E\u0430", [e.Nepali]: "\u0905\u092E\u0947\u0930\u093F\u0915\u093E \u0938\u092E\u094B\u0906", [e.Norwegian]: "Amerikansk Samoa", [e.Pashto]: "\u0627\u0645\u0631\u06CC\u06A9\u0627\u06CC \u0633\u0645\u0648\u0627", [e.Persian]: "\u0622\u0645\u0631\u06CC\u06A9\u0627\u06CC \u0633\u0645\u0648\u0627", [e.Polish]: "Samoa Ameryka\u0144skie", [e.Portuguese]: "Samoa Americana", [e.Punjabi]: "\u0A05\u0A2E\u0A30\u0A40\u0A15\u0A40 \u0A38\u0A3E\u0A2E\u0A4B\u0A06", [e.Romanian]: "Samoa americane", [e.Russian]: "\u0410\u043C\u0435\u0440\u0438\u043A\u0430\u043D\u0441\u043A\u0430\u044F \u0421\u0430\u043C\u043E\u0430", [e.Samoan]: "Samoa Amerika", [e.Sanskrit]: "\u0905\u092E\u0947\u0930\u093F\u0915\u093E \u0938\u092E\u094B\u0906", [e.Scots]: "Amerikaans Samoa", [e.Serbian]: "\u0410\u043C\u0435\u0440\u0438\u043A\u0430\u043D\u0441\u043A\u0430 \u0421\u0430\u043C\u043E\u0430", [e.Sesotho]: "Amerikaans Samoa", [e.Shona]: "Amerikaans Samoa", [e.Sindhi]: "Amerikaans Samoa", [e.Sinhala]: "\u0D86\u0DBB\u0DCA\u0DA2\u0DD2\u0DB1\u0DCF\u0DB1\u0DD4 \u0DC3\u0DD0\u0DB8\u0DD0\u0DBD\u0DCA\u0DC0", [e.Slovak]: "Amerikaans Samoa", [e.Slovenian]: "Amerikaans Samoa", [e.Somali]: "Amerikaans Samoa", [e.Spanish]: "Samoa Americana", [e.Sudanese]: "Amerikaans Samoa", [e.Swahili]: "Amerikaans Samoa", [e.Swedish]: "Amerikansk Samoa", [e.Tagalog]: "Amerikaans Samoa", [e.Tajik]: "\u0410\u043C\u0435\u0440\u0438\u043A\u0430\u043D\u0441\u043A\u0438 \u0441\u0430\u043C\u043E\u0430", [e.Tamil]: "\u0B85\u0BAE\u0BC6\u0BB0\u0BBF\u0B95\u0BCD \u0B9A\u0BAE\u0BCB\u0BB5\u0BBE", [e.Tatar]: "\u0410\u043C\u0435\u0440\u0438\u043A\u0430\u043D\u0441\u043A\u0438 \u0441\u0430\u043C\u043E\u0430", [e.Telugu]: "\u0C05\u0C2E\u0C46\u0C30\u0C3F\u0C15\u0C4D \u0C38\u0C2E\u0C4B\u0C35\u0C3E", [e.Thai]: "\u0E2A\u0E2B\u0E23\u0E32\u0E0A\u0E2D\u0E32\u0E13\u0E32\u0E08\u0E31\u0E01\u0E23\u0E41\u0E2D\u0E1F\u0E23\u0E34\u0E01\u0E32", [e.Tibetan]: "\u0F68\u0F7A\u0F0B\u0F62\u0F72\u0F0B\u0F40\u0F0B\u0F68\u0F7A\u0F0B\u0F58\u0F72\u0F0B\u0F51\u0F74\u0F0B\u0F61\u0F72\u0F0B\u0F62\u0F72\u0F0B\u0F40", [e.Turkish]: "Amerikan Samoas\u0131", [e.Ukrainian]: "\u0410\u043C\u0435\u0440\u0438\u043A\u0430\u043D\u0441\u044C\u043A\u0430 \u0421\u0430\u043C\u043E\u0430", [e.Urdu]: "\u0627\u0645\u0631\u06CC\u06A9\u06CC \u0633\u0645\u0648\u0627", [e.Uzbek]: "\u0410\u043C\u0435\u0440\u0438\u043A\u0430\u043D\u0441\u043A\u0438 \u0441\u0430\u043C\u043E\u0430", [e.Vietnamese]: "Amerikaans Samoa", [e.Welsh]: "Amerikaans Samoa", [e.Xhosa]: "Amerikaans Samoa", [e.Yiddish]: "Amerikaans Samoa", [e.Yoruba]: "Amerikaans Samoa", [e.Zulu]: "Amerikaans Samoa" } }, statistics: { demographics: { age: { distribution: [{ age: "0 to 14 years", percentage: 15.3 }, { age: "15 to 64 years", percentage: 66.7 }, { age: "65 years and over", percentage: 14.6 }], median_age: 35.5 }, population: { largest_city: "Pago Pago", total: 558e3 } }, geography: { area: 199, region: T.Oceania, sub_region: p.Polynesia }, government: { capital: "Pago Pago", type: "Nonmetropolitan Territory of the US" } } }, Andorra: { i18n: { calling_codes: [376], currencies: [m.Euro], languages: [e.Catalan, e.Spanish], tz: { offsets: [n.UTC_PLUS_1, n.UTC_PLUS_2], regions: [u.EuropeAndorra], timezones: [s.CentralEuropeanTime] } }, id: r.Andorra, info: { flag: { emoji: "\u{1F1E6}\u{1F1F4}", emoji_unicode: "U+1F1E6 U+1F1F4", svg: "https://www.countryflags.io/ad/flat/64.svg" }, tld: [".ad"] }, iso: { alpha2: r.Andorra, alpha3: "AND", numeric: "020" }, name: { alt_spellings: ["AD", "Principality of Andorra", "Principat d'Andorra"], demonym: "Andorran", native: { endonym: "Andorra" }, official: "Principality of Andorra", short: "Andorra", translations: { [e.Afrikaans]: "Andorra", [e.Albanian]: "Andorra", [e.Amharic]: "\u12A0\u1295\u12F6\u122B", [e.Arabic]: "\u0623\u0646\u062F\u0648\u0631\u0627", [e.Armenian]: "\u0540\u0561\u0576\u0564\u0561\u0580\u0561\u057E\u0561\u0575\u0584", [e.Azerbaijani]: "Andorra", [e.Bashkir]: "\u0410\u043D\u0434\u043E\u0440\u0430", [e.Basque]: "Andorra", [e.Belarusian]: "\u0410\u043D\u0434\u043E\u0440\u0440\u0430", [e.Bengali]: "\u0985\u09A8\u09CD\u09A1\u09CB\u09B0\u09BE", [e.Berber]: "\u0623\u0646\u062F\u0648\u0631\u0627", [e.Bhutani]: "\u0F68\u0F53\u0F0B\u0F4C\u0F7C\u0F0B", [e.Bosnian]: "Andora", [e.Breton]: "Andorra", [e.Bulgarian]: "\u0410\u043D\u0434\u043E\u0440\u0430", [e.Burmese]: "\u1021\u1014\u1039\u1010\u102C\u101B\u102D\u102F\u1038", [e.Catalan]: "Andorra", [e.Chinese]: "\u5B89\u9053\u5C14", [e.Croatian]: "Andora", [e.Czech]: "Andorra", [e.Danish]: "Andorra", [e.Dutch]: "Andorra", [e.English]: "Andorra", [e.Esperanto]: "Andora", [e.Estonian]: "Andorra", [e.Finnish]: "Andorra", [e.French]: "Andorra", [e.Frisian]: "Andorra", [e.Galician]: "Andorra", [e.Georgian]: "\u12A0\u1295\u12F6\u122B", [e.German]: "Andorra", [e.Greek]: "\u0391\u03BD\u03B4\u03CC\u03C1\u03B1", [e.Hebrew]: "\u05D0\u05E0\u05D3\u05D5\u05E8\u05D4", [e.Hindi]: "\u0905\u0902\u0921\u094B\u0930\u093E", [e.Hungarian]: "Andorra", [e.Icelandic]: "Andorra", [e.Igbo]: "Andorra", [e.Indonesian]: "Andorra", [e.Irish]: "Andorra", [e.Italian]: "Andorra", [e.Japanese]: "\u30A2\u30F3\u30C9\u30E9", [e.Javanese]: "Andorra", [e.Kannada]: "\u0C85\u0C82\u0CA1\u0CCB\u0CB0\u0CBF\u0CAF\u0CA8\u0CCD", [e.Kazakh]: "\u0410\u043D\u0434\u043E\u0440\u0440\u0430", [e.Khmer]: "\u17A2\u1784\u17CB\u178A\u17B6\u179A\u17B6", [e.Korean]: "\uC548\uB3C4\uB77C", [e.Kurdish]: "Andorra", [e.Kyrgyz]: "\u0410\u043D\u0434\u043E\u0440\u0440\u0430", [e.Lao]: "\u0EAD\u0EB1\u0E99\u0EC2\u0E94\u0EA3\u0EB2", [e.Latin]: "Andorra", [e.Latvian]: "Andora", [e.Lithuanian]: "Andora", [e.Luxembourgish]: "Andorra", [e.Macedonian]: "\u0410\u043D\u0434\u043E\u0440\u0440\u0430", [e.Malagasy]: "Andorra", [e.Malay]: "Andorra", [e.Malayalam]: "\u0D05\u0D02\u0D21\u0D4B\u0D30\u0D3F\u0D2F\u0D28\u0D4D", [e.Maltese]: "Andorra", [e.Maori]: "Andorra", [e.Marathi]: "\u0905\u0902\u0921\u094B\u0930\u093E", [e.Mongolian]: "\u0410\u043D\u0434\u043E\u0440\u0440\u0430", [e.Nepali]: "\u0905\u0902\u0921\u094B\u0930\u093E", [e.Norwegian]: "Andorra", [e.Pashto]: "\u0622\u0646\u062F\u0648\u0631\u0627", [e.Persian]: "\u0622\u0646\u062F\u0648\u0631\u0627", [e.Polish]: "Andora", [e.Portuguese]: "Andorra", [e.Punjabi]: "\u0A05\u0A70\u0A21\u0A4B\u0A30\u0A3E", [e.Romanian]: "Andorra", [e.Russian]: "\u0410\u043D\u0434\u043E\u0440\u0440\u0430", [e.Samoan]: "Andorra", [e.Sanskrit]: "\u0905\u0902\u0921\u094B\u0930\u093E", [e.Scots]: "Andorra", [e.Serbian]: "\u0410\u043D\u0434\u043E\u0440\u0440\u0430", [e.Sesotho]: "Andorra", [e.Shona]: "Andorra", [e.Sindhi]: "\u0905\u0902\u0921\u094B\u0930\u093E", [e.Sinhala]: "\u0D86\u0DB1\u0DCA\u0DAF\u0DDA", [e.Slovak]: "Andorra", [e.Slovenian]: "Andora", [e.Somali]: "Andorra", [e.Spanish]: "Andorra", [e.Sudanese]: "Andorra", [e.Swahili]: "Andorra", [e.Swedish]: "Andorra", [e.Tagalog]: "Andorra", [e.Tajik]: "\u0410\u043D\u0434\u043E\u0440\u0440\u0430", [e.Tamil]: "\u0B85\u0BA9\u0BCB\u0BB0\u0BCD\u0B9F\u0BBE", [e.Tatar]: "\u0410\u043D\u0434\u043E\u0440\u0440\u0430", [e.Telugu]: "\u0C05\u0C02\u0C21\u0C4B\u0C30\u0C4D\u0C30\u0C3E", [e.Thai]: "\u0E2D\u0E31\u0E19\u0E14\u0E2D\u0E23\u0E4C\u0E23\u0E32", [e.Tibetan]: "\u0F68\u0F53\u0F0B\u0F4C\u0F7C\u0F0B", [e.Turkish]: "Andora", [e.Ukrainian]: "\u0410\u043D\u0434\u043E\u0440\u0440\u0430", [e.Urdu]: "\u0622\u0646\u062F\u0648\u0631\u0627", [e.Uzbek]: "\u0410\u043D\u0434\u043E\u0440\u0440\u0430", [e.Vietnamese]: "Andorra", [e.Welsh]: "Andorra", [e.Xhosa]: "Andorra", [e.Yiddish]: "\u05D0\u05E0\u05D3\u05D5\u05E8\u05D4", [e.Yoruba]: "Andorra", [e.Zulu]: "Andorra" } }, statistics: { demographics: { age: { distribution: [{ age: "0 to 14 years", percentage: 15.3 }, { age: "15 to 64 years", percentage: 66.7 }, { age: "65 years and over", percentage: 14.6 }], median_age: 35.5 }, population: { largest_city: "Andorra la Vella", total: 78e3 } }, geography: { area: 468, region: T.Europe, sub_region: p.SouthernEurope }, government: { capital: "Andorra la Vella", type: "Constitutional Monarchy" } } }, Angola: { i18n: { calling_codes: [244], currencies: [m.AngolaKwanza], languages: [e.Portuguese, e.Spanish, e.French, e.Italian, e.German, e.English], tz: { offsets: [n.UTC_0, n.UTC_PLUS_1, n.UTC_PLUS_2], regions: [u.AfricaLuanda], timezones: [s.WestAfricaTime] } }, id: r.Angola, info: { flag: { emoji: "\u{1F1E6}\u{1F1EC}", emoji_unicode: "U+1F1E6 U+1F1EC", svg: "https://www.countryflags.io/ao/flat/64.svg" }, tld: [".ao"] }, iso: { alpha2: r.Angola, alpha3: "AGO", numeric: "024" }, name: { alt_spellings: ["AO", "Rep\xFAblica de Angola", "\u0281\u025Bpublika de an"], demonym: "Angolan", native: { endonym: "Angola" }, official: "Republic of Angola", short: "Angola", translations: { [e.Afrikaans]: "Angola", [e.Albanian]: "Ang\xF2la", [e.Amharic]: "\u12A0\u1295\u130E\u120A\u12EB", [e.Arabic]: "\u0623\u0646\u063A\u0648\u0644\u0627", [e.Armenian]: "\u0540\u0561\u0576\u0563\u0561\u056C\u0561\u056F\u0561", [e.Azerbaijani]: "Ang\u0259l", [e.Bashkir]: "\u0410\u043D\u0433\u043E\u043B\u0430", [e.Basque]: "Angola", [e.Belarusian]: "\u0410\u043D\u0433\u043E\u043B\u0430", [e.Bengali]: "\u0985\u0999\u09CD\u0997\u09B2\u09BE", [e.Berber]: "Angola", [e.Bhutani]: "\u0F60\u0F56\u0FB2\u0F74\u0F42", [e.Bosnian]: "Angola", [e.Breton]: "Angola", [e.Bulgarian]: "\u0410\u043D\u0433\u043E\u043B\u0430", [e.Burmese]: "\u1021\u1004\u103A\u1039\u1002\u101C\u102D\u1010\u103A", [e.Catalan]: "Angola", [e.Chinese]: "\u5B89\u54E5\u62C9", [e.Croatian]: "Angola", [e.Czech]: "Angola", [e.Danish]: "Angola", [e.Dutch]: "Angola", [e.English]: "Angola", [e.Esperanto]: "Angolo", [e.Estonian]: "Angola", [e.Finnish]: "Angola", [e.French]: "Angola", [e.Frisian]: "Angola", [e.Galician]: "Angola", [e.Georgian]: "\u10D0\u10DC\u10D2\u10DD\u10DA\u10D0", [e.German]: "Angola", [e.Greenlandic]: "Angola", [e.Greek]: "\u0391\u03B3\u03BA\u03CC\u03BB\u03B1", [e.Gujarati]: "\u0A85\u0A82\u0A97\u0ACB\u0AB2\u0ABE", [e.Haitian]: "Angola", [e.Hausa]: "Angola", [e.Hebrew]: "\u05D0\u05E0\u05D2\u05D5\u05DC\u05D4", [e.Hindi]: "\u0905\u0919\u094D\u0917\u094B\u0932\u093E", [e.Hungarian]: "Angola", [e.Icelandic]: "Angola", [e.Igbo]: "Angola", [e.Indonesian]: "Angola", [e.Irish]: "Angola", [e.Italian]: "Angola", [e.Japanese]: "\u30A2\u30F3\u30B4\u30E9", [e.Javanese]: "Anggol", [e.Kannada]: "\u0C85\u0C82\u0C97\u0CCB\u0CB2\u0CBE", [e.Kazakh]: "\u0410\u043D\u0433\u043E\u043B\u0430", [e.Khmer]: "\u17A2\u1784\u17CB\u1780\u17B6\u179B\u17A2\u1784\u17CB\u1782\u17D2\u179B\u17C1\u179F", [e.Korean]: "\uC559\uACE8\uB77C", [e.Kurdish]: "Angola", [e.Kyrgyz]: "\u0410\u043D\u0433\u043E\u043B\u0430", [e.Lao]: "\u0EAD\u0EB0\u0E99\u0EB2\u0E94\u0EB2", [e.Latin]: "Angola", [e.Latvian]: "Angola", [e.Lithuanian]: "Angola", [e.Luxembourgish]: "Angola", [e.Macedonian]: "\u0410\u043D\u0433\u043E\u043B\u0430", [e.Malagasy]: "Angola", [e.Malay]: "Angola", [e.Malayalam]: "\u0D05\u0D02\u0D17\u0D4B\u0D33\u0D3E", [e.Maltese]: "Angola", [e.Maori]: "Angola", [e.Marathi]: "\u0905\u0919\u094D\u0917\u094B\u0932\u093E", [e.Mongolian]: "\u0410\u043D\u0433\u043E\u043B\u0430", [e.Nepali]: "\u0905\u0919\u094D\u0917\u094B\u0932\u093E", [e.Norwegian]: "Angola", [e.Pashto]: "\u0627\u0646\u06AB\u0648\u0644\u0627", [e.Persian]: "\u0622\u0646\u06AF\u0648\u0644\u0627", [e.Polish]: "Angola", [e.Portuguese]: "Angola", [e.Punjabi]: "\u0A05\u0A19\u0A4D\u0A17\u0A4B\u0A32\u0A3E", [e.Romanian]: "Angole", [e.Russian]: "\u0410\u043D\u0433\u043E\u043B\u0430", [e.Samoan]: "Angola", [e.Sanskrit]: "\u0905\u0919\u094D\u0917\u094B\u0932\u093E", [e.Scots]: "Angola", [e.Serbian]: "\u0410\u043D\u0433\u043E\u043B\u0430", [e.Sesotho]: "Angola", [e.Shona]: "Angola", [e.Sindhi]: "\u0905\u0919\u094D\u0917\u094B\u0932\u093E", [e.Sinhala]: "\u0D86\u0D9C\u0DBD\u0DD2\u0DBA\u0DCF\u0DC0", [e.Slovak]: "Angola", [e.Slovenian]: "Angola", [e.Somali]: "Angola", [e.Spanish]: "Angola", [e.Sudanese]: "Angola", [e.Swahili]: "Angola", [e.Swedish]: "Angola", [e.Tagalog]: "Angola", [e.Tajik]: "\u0410\u043D\u0433\u043E\u043B\u0430", [e.Tamil]: "\u0B85\u0B99\u0BCD\u0B95\u0BCB\u0BB2\u0BBE", [e.Tatar]: "\u0410\u043D\u0433\u043E\u043B\u0430", [e.Telugu]: "\u0C05\u0C02\u0C17\u0C4B\u0C32\u0C3E", [e.Thai]: "\u0E2D\u0E07\u0E04\u0E4C\u0E01\u0E32\u0E23\u0E2D\u0E32\u0E19\u0E32\u0E21\u0E34\u0E2A\u0E16\u0E32\u0E19", [e.Tibetan]: "\u0F68\u0F44\u0F0B\u0F63\u0F7C\u0F0B", [e.Turkish]: "Angola", [e.Ukrainian]: "\u0410\u043D\u0433\u043E\u043B\u0430", [e.Urdu]: "\u0627\u0646\u06AF\u0648\u0644\u0627", [e.Uzbek]: "Angola", [e.Vietnamese]: "Angola", [e.Xhosa]: "Angola", [e.Welsh]: "Angola", [e.Yiddish]: "\u05D0\u05E0\u05D2\u05D5\u05DC\u05D4", [e.Yoruba]: "Angola", [e.Zulu]: "Angola" } } }, Anguilla: { i18n: { calling_codes: [1264], currencies: [m.DominicaDollar, m.EastCaribbeanDollar, m.Euro, m.UnitedStatesDollar, m.BritishPound], languages: [e.English, e.Spanish], tz: { offsets: [n.UTC_MINUS_4], regions: [u.AmericaAnguilla], timezones: [s.AtlanticStandardTime] } }, id: r.Anguilla, info: { flag: { emoji: "\u{1F1E6}\u{1F1EC}", emoji_unicode: "U+1F1E6 U+1F1EC", svg: "https://www.countryflags.io/ai/flat/64.svg" }, tld: [".ai"] }, iso: { alpha2: r.Anguilla, alpha3: "AIA", numeric: "660" }, name: { alt_spellings: ["AI"], demonym: "Anguillian", native: { endonym: "Anguilla" }, official: "Anguilla", short: "Anguilla", translations: { [e.Afrikaans]: "Anguilla", [e.Albanian]: "Anguilla", [e.Amharic]: "\u12A0\u1295\u1309\u120B", [e.Arabic]: "\u0623\u0646\u063A\u0648\u064A\u0644\u0627", [e.Armenian]: "\u0531\u0576\u0563\u056B\u056C\u0561", [e.Azerbaijani]: "Az\u0259rbaycan", [e.Bashkir]: "\u0410\u043D\u0433\u0438\u043B\u0438", [e.Basque]: "Angila", [e.Belarusian]: "\u0410\u043D\u0433\u0438\u043B\u0438", [e.Bengali]: "\u0985\u0999\u09CD\u0997\u09C0\u09B2\u09BE", [e.Berber]: "\u0623\u0646\u063A\u0648\u064A\u0644\u0627", [e.Bhutani]: "\u0F68\u0F44\u0F0B\u0F63\u0F7C\u0F0B", [e.Bosnian]: "Angila", [e.Breton]: "Angila", [e.Bulgarian]: "\u0410\u043D\u0433\u0438\u043B\u0438", [e.Burmese]: "\u1021\u1004\u103A\u1039\u1002\u101C\u102D\u1010\u103A", [e.Catalan]: "Angilla", [e.Chinese]: "\u5B89\u572D\u62C9", [e.Croatian]: "Angila", [e.Czech]: "Anguilla", [e.Danish]: "Anguilla", [e.Dutch]: "Anguilla", [e.English]: "Anguilla", [e.Esperanto]: "Angila", [e.Estonian]: "Anguilla", [e.Finnish]: "Anguilla", [e.French]: "Anguilla", [e.Frisian]: "Angila", [e.Galician]: "Anguilla", [e.Georgian]: "\u10D0\u10DC\u10D2\u10D8\u10DA\u10D0", [e.German]: "Anguilla", [e.Greenlandic]: "Anguilla", [e.Greek]: "\u0391\u03BD\u03B3\u03BA\u03C5\u03BB\u03AC", [e.Gujarati]: "\u0A85\u0A82\u0A97\u0ACD\u0AAF\u0ABE\u0AB2\u0ABE", [e.Haitian]: "Anguilla", [e.Hausa]: "Anguilla", [e.Hebrew]: "\u05D0\u05E0\u05D2\u05D5\u05D9\u05D0\u05DC\u05D4", [e.Hindi]: "\u0905\u0902\u0917\u094D\u0935\u0947\u0932\u093E", [e.Hungarian]: "Anguilla", [e.Icelandic]: "Anguilla", [e.Igbo]: "Anguilla", [e.Indonesian]: "Anguilla", [e.Irish]: "Anguilla", [e.Italian]: "Anguilla", [e.Japanese]: "\u30A2\u30F3\u30AE\u30E9", [e.Javanese]: "Anguilla", [e.Kannada]: "\u0C85\u0C82\u0C97\u0CCD\u0CB5\u0CC7\u0CB2\u0CBE", [e.Kazakh]: "\u0410\u043D\u0433\u0438\u043B\u0438", [e.Khmer]: "\u17A2\u1784\u17CB\u1780\u17B6\u179A\u17A0\u17D2\u1782\u17B8\u1798", [e.Korean]: "\uC575\uADC8\uB77C", [e.Kurdish]: "Anguilla", [e.Kyrgyz]: "\u0410\u043D\u0433\u0438\u043B\u0438", [e.Lao]: "\u0EAD\u0EB0\u0E99\u0EB0\u0E88\u0EB3", [e.Latin]: "Anguilla", [e.Latvian]: "Anguilla", [e.Lithuanian]: "Anguilla", [e.Luxembourgish]: "Angilla", [e.Macedonian]: "\u0410\u043D\u0433\u0438\u043B\u0438", [e.Malagasy]: "Angila", [e.Malay]: "Anguilla", [e.Malayalam]: "\u0D05\u0D02\u0D17\u0D4D\u0D35\u0D47\u0D32\u0D3E", [e.Maltese]: "Anguilla", [e.Maori]: "Anguilla", [e.Marathi]: "\u0905\u0902\u0917\u094D\u0935\u0947\u0932\u093E", [e.Mongolian]: "\u0410\u043D\u0433\u0438\u043B\u0438", [e.Nepali]: "\u0905\u0902\u0917\u094D\u0935\u0947\u0932\u093E", [e.Norwegian]: "Anguilla", [e.Pashto]: "\u0622\u0646\u06AF\u0648\u0644\u0627", [e.Persian]: "\u0622\u0646\u06AF\u0648\u0644\u0627", [e.Polish]: "Anguilla", [e.Portuguese]: "Anguilla", [e.Punjabi]: "\u0A05\u0A02\u0A17\u0A40\u0A32\u0A3E", [e.Romanian]: "Anguilla", [e.Russian]: "\u0410\u043D\u0433\u0438\u043B\u0438", [e.Samoan]: "Anguilla", [e.Sanskrit]: "\u0905\u0902\u0917\u094D\u0935\u0947\u0932\u093E", [e.Scots]: "Anguilla", [e.Serbian]: "\u0410\u043D\u0433\u0438\u043B\u0438", [e.Sesotho]: "Anguilla", [e.Shona]: "Anguilla", [e.Sindhi]: "\u0905\u0902\u0917\u094D\u0935\u0947\u0932\u093E", [e.Sinhala]: "\u0D86\u0D82\u0D9C\u0DD2\u0DBD\u0DCF\u0DC0", [e.Slovak]: "Anguilla", [e.Slovenian]: "Anguilla", [e.Somali]: "Anguilla", [e.Spanish]: "Anguilla", [e.Sudanese]: "Anguilla", [e.Swahili]: "Anguilla", [e.Swedish]: "Anguilla", [e.Tagalog]: "Anguilla", [e.Tajik]: "\u0410\u043D\u0433\u0438\u043B\u0438", [e.Tamil]: "\u0B85\u0B99\u0BCD\u0B95\u0BC8\u0BB2\u0BBE", [e.Tatar]: "\u0410\u043D\u0433\u0438\u043B\u0438", [e.Telugu]: "\u0C05\u0C02\u0C17\u0C4D\u0C35\u0C47\u0C32\u0C3E", [e.Thai]: "\u0E2D\u0E31\u0E07\u0E01\u0E32\u0E25\u0E32", [e.Tibetan]: "\u0F68\u0F44\u0F0B\u0F63\u0F72\u0F0B", [e.Turkish]: "Anguilla", [e.Ukrainian]: "\u0410\u043D\u0433\u0438\u043B\u0438", [e.Urdu]: "\u0622\u0646\u06AF\u0648\u0644\u0627", [e.Uzbek]: "\u0410\u043D\u0433\u0438\u043B\u0438", [e.Vietnamese]: "Anguilla", [e.Welsh]: "Anguilla", [e.Xhosa]: "Anguilla", [e.Yiddish]: "Anguilla", [e.Yoruba]: "Anguilla", [e.Zulu]: "Anguilla" } } }, Antarctica: { i18n: { calling_codes: [672], currencies: [m.UnitedStatesDollar, m.Euro], languages: [e.English, e.Spanish, e.French, e.Portuguese, e.Italian, e.Dutch, e.German, e.Swedish, e.Norwegian, e.Danish, e.Finnish], tz: { offsets: [n.UTC_PLUS_1, n.UTC_PLUS_2], regions: [u.AntarcticaCasey, u.AntarcticaDavis, u.AntarcticaMcMurdo, u.AntarcticaPalmer, u.AntarcticaRothera], timezones: [s.AtlanticStandardTime, s.CentralTime, s.EasternTime, s.AtlanticStandardTime, s.AzoresStandardTime, s.NewfoundlandStandardTime] } }, id: r.Antarctica, info: { flag: { emoji: "\u{1F1E6}\u{1F1F6}", emoji_unicode: "U+1F1E6 U+1F1F6", svg: "https://www.countryflags.io/aq/flat/64.svg" }, tld: [".aq"] }, iso: { alpha2: r.Antarctica, alpha3: "ATA", numeric: "010" }, name: { alt_spellings: ["AQ"], demonym: "Antarctican", native: { endonym: "Antarctica" }, official: "Antarctica", short: "Antarctica", translations: { [e.Afrikaans]: "Antarctica", [e.Albanian]: "Antarktika", [e.Amharic]: "\u12A0\u1295\u1272\u120D\u12AB\u1293", [e.Arabic]: "\u0623\u0646\u062A\u0627\u0631\u0643\u062A\u064A\u0643\u0627", [e.Armenian]: "\u0540\u0561\u0576\u0561\u0580\u0561\u057F\u056F\u0578", [e.Azerbaijani]: "Az\u0259rbaycan", [e.Bashkir]: "\u0410\u043D\u0442\u0430\u0440\u043A\u0442\u0438\u043A\u0430", [e.Basque]: "Antarktika", [e.Belarusian]: "\u0410\u043D\u0442\u0430\u0440\u043A\u0442\u0438\u043A\u0430", [e.Bengali]: "\u0985\u09A8\u09CD\u09A4\u09B0\u09BE\u09B6\u09CD\u09AC\u09C0", [e.Berber]: "\u0623\u0646\u062A\u0627\u0631\u0643\u062A\u064A\u0643\u0627", [e.Bhutani]: "\u0F68\u0F44\u0F0B\u0F63\u0F72\u0F0B", [e.Bosnian]: "Antarktika", [e.Breton]: "Antarktika", [e.Bulgarian]: "\u0410\u043D\u0442\u0430\u0440\u043A\u0442\u0438\u043A\u0430", [e.Burmese]: "\u1021\u1014\u1039\u1010\u102C\u101B\u102E\u1038\u101A\u102C\u1038", [e.Catalan]: "Ant\xE0rtida", [e.Chinese]: "\u5357\u6781\u6D32", [e.Croatian]: "Antarktika", [e.Czech]: "Antarktida", [e.Danish]: "Antarktis", [e.Dutch]: "Antarctica", [e.English]: "Antarctica", [e.Esperanto]: "Antarktika", [e.Estonian]: "Antarktika", [e.Finnish]: "Antarktis", [e.French]: "Antarctica", [e.Frisian]: "Antarktis", [e.Galician]: "Ant\xE1rtida", [e.Georgian]: "\u10D0\u10DC\u10E2\u10D0\u10E0\u10E5\u10E2\u10D8\u10D9\u10D0", [e.German]: "Antarktis", [e.Greenlandic]: "Antarktis", [e.Greek]: "\u0391\u03BD\u03C4\u03B1\u03C1\u03BA\u03C4\u03B9\u03BA\u03AE", [e.Gujarati]: "\u0A85\u0AA8\u0ACD\u0AA4\u0AB0\u0ABE\u0AB6\u0ACD\u0AB5\u0AC0", [e.Haitian]: "Antarctica", [e.Hausa]: "Antarktika", [e.Hebrew]: "\u05D0\u05E0\u05D8\u05E8\u05E7\u05D8\u05D9\u05E7\u05D4", [e.Hindi]: "\u0905\u0928\u094D\u0924\u0930\u0915\u094D\u0937\u0947\u0924\u094D\u0930", [e.Hungarian]: "Antarktika", [e.Icelandic]: "Antarktis", [e.Igbo]: "Antarktika", [e.Indonesian]: "Antarktika", [e.Irish]: "Antarktika", [e.Italian]: "Antartide", [e.Japanese]: "\u5357\u6975", [e.Javanese]: "Antarktika", [e.Kannada]: "\u0C85\u0CA8\u0CCD\u0CA4\u0CB0\u0CBE\u0CB6\u0CCD\u0CB5\u0CBF", [e.Kazakh]: "\u0410\u043D\u0442\u0430\u0440\u043A\u0442\u0438\u043A\u0430", [e.Khmer]: "\u17A2\u1784\u17CB\u179F\u17D2\u1780\u179A\u17A2\u17B6\u1798\u17C9\u17BB\u1799", [e.Korean]: "\uC564\uD2F0\uCE74\uD1A0\uB2C9", [e.Kurdish]: "Antarktika", [e.Kyrgyz]: "\u0410\u043D\u0442\u0430\u0440\u043A\u0442\u0438\u043A\u0430", [e.Lao]: "\u0EAD\u0EB0\u0E99\u0EAD\u0EA5\u0EB2\u0E81\u0EB4\u0EAA\u0EB0", [e.Latin]: "Antarctica", [e.Latvian]: "Antarktika", [e.Lithuanian]: "Antarktis", [e.Luxembourgish]: "Antarktis", [e.Macedonian]: "\u0410\u043D\u0442\u0430\u0440\u043A\u0442\u0438\u043A\u0430", [e.Malagasy]: "Antarctica", [e.Malay]: "Antarktika", [e.Malayalam]: "\u0D05\u0D28\u0D4D\u0D24\u0D30\u0D3E\u0D36\u0D4D\u0D35\u0D3F", [e.Maltese]: "Antarktika", [e.Maori]: "Antarktika", [e.Marathi]: "\u0905\u0928\u094D\u0924\u0930\u093E\u0936\u094D\u0935\u093F\u0915\u093E", [e.Mongolian]: "\u0410\u043D\u0442\u0430\u0440\u043A\u0442\u0438\u043A\u0430", [e.Nepali]: "\u0905\u0928\u094D\u0924\u0930\u093E\u0936\u094D\u0935\u093F\u0915\u093E", [e.Norwegian]: "Antarktis", [e.Pashto]: "\u0627\u0646\u062A\u0627\u0631\u0643\u062A\u064A\u0643\u0627", [e.Persian]: "\u0622\u0646\u062A\u0627\u0631\u06A9\u062A\u06CC\u06A9\u0627", [e.Polish]: "Antarktyka", [e.Portuguese]: "Ant\xE1rtida", [e.Punjabi]: "\u0A05\u0A28\u0A4D\u0A24\u0A30\u0A3E\u0A36\u0A3F\u0A15\u0A3E", [e.Romanian]: "Antarctica", [e.Russian]: "\u0410\u043D\u0442\u0430\u0440\u043A\u0442\u0438\u043A\u0430", [e.Samoan]: "Antarktika", [e.Sanskrit]: "\u0905\u0928\u094D\u0924\u0930\u093E\u0936\u094D\u0935\u093F\u0915\u093E", [e.Scots]: "Antarktika", [e.Serbian]: "\u0410\u043D\u0442\u0430\u0440\u043A\u0442\u0438\u043A\u0430", [e.Sesotho]: "Antarktika", [e.Shona]: "Antarktika", [e.Sindhi]: "Antarktika", [e.Sinhala]: "\u0D86\u0DB1\u0DCA\u0DA7\u0DCA\u0DA7\u0DD2\u0D9A\u0DCF\u0DC0", [e.Slovak]: "Antarktika", [e.Slovenian]: "Antarktika", [e.Somali]: "Antarktika", [e.Spanish]: "Ant\xE1rtida", [e.Sudanese]: "Antarktika", [e.Swahili]: "Antarktika", [e.Swedish]: "Antarktis", [e.Tagalog]: "Antarktika", [e.Tajik]: "\u0410\u043D\u0442\u0430\u0440\u043A\u0442\u0438\u043A\u0430", [e.Tamil]: "\u0B85\u0BA9\u0BCD\u0BA4\u0BBE\u0BB0\u0BCD\u0B95\u0BCD\u0B95\u0BBF\u0B95\u0BCD", [e.Tatar]: "\u0410\u043D\u0442\u0430\u0440\u043A\u0442\u0438\u043A\u0430", [e.Telugu]: "\u0C05\u0C28\u0C4D\u0C24\u0C30\u0C3E\u0C36\u0C4D\u0C35\u0C3F\u0C15\u0C3E", [e.Thai]: "\u0E20\u0E39\u0E21\u0E34\u0E20\u0E32\u0E04\u0E2D\u0E32\u0E19\u0E31\u0E19\u0E15\u0E34\u0E01\u0E32", [e.Tibetan]: "\u0F68\u0F7A\u0F53\u0F0B\u0F4A\u0F72\u0F4A\u0F7A\u0F53\u0F0B\u0F40\u0F72\u0F66\u0F72\u0F0B\u0F68\u0F7A\u0F53\u0F0B\u0F4A\u0F72\u0F4A\u0F7A\u0F53\u0F0B\u0F40\u0F72\u0F66\u0F72", [e.Turkish]: "Antarktika", [e.Ukrainian]: "\u0410\u043D\u0442\u0430\u0440\u043A\u0442\u0438\u043A\u0430", [e.Urdu]: "\u0627\u0646\u062A\u0627\u0631\u06A9\u062A\u06CC\u06A9\u0627", [e.Uzbek]: "\u0410\u043D\u0442\u0430\u0440\u043A\u0442\u0438\u043A\u0430", [e.Vietnamese]: "\u0110\u1EA5t Antarktik", [e.Welsh]: "Antarktika", [e.Xhosa]: "Antarktika", [e.Yiddish]: "Antarktika", [e.Yoruba]: "Antarktika", [e.Zulu]: "Antarktika" } } }, Armenia: { i18n: { calling_codes: [374], currencies: [m.ArmeniaDram], languages: [e.Armenian], tz: { offsets: [n.UTC_PLUS_4], regions: [u.AsiaJakarta], timezones: [s.ArmeniaTime] } }, id: r.Armenia, info: { flag: { emoji: "\u{1F1E6}\u{1F1F2}", emoji_unicode: "U+1F1E6 U+1F1F2", svg: "https://www.countryflags.io/am/flat/64.svg" }, tld: [".am"] }, iso: { alpha2: r.Armenia, alpha3: "ARM", numeric: "051" }, name: { alt_spellings: ["AM", "Hayastan", "Republic of Armenia", "\u0540\u0561\u0575\u0561\u057D\u057F\u0561\u0576"], demonym: "Armenian", native: { endonym: "\u0540\u0561\u0575\u0561\u057D\u057F\u0561\u0576" }, official: "Republic of Armenia", short: "Armenia", translations: { [e.Afrikaans]: "Armeni\xEB", [e.Albanian]: "Armenia", [e.Amharic]: "\u12A0\u121B\u122D\u129B", [e.Arabic]: "\u0623\u0631\u0645\u064A\u0646\u064A\u0627", [e.Armenian]: "\u0540\u0561\u0575\u0561\u057D\u057F\u0561\u0576", [e.Azerbaijani]: "Az\u0259rbaycan", [e.Bashkir]: "\u0410\u0440\u043C\u0435\u043D\u0438\u044F", [e.Basque]: "Arm\xE9nia", [e.Belarusian]: "\u0410\u0440\u043C\u0435\u043D\u0438\u044F", [e.Bengali]: "\u0986\u09B0\u09CD\u09AE\u09C7\u09A8\u09BF", [e.Berber]: "\u0623\u0631\u0645\u064A\u0646\u064A\u0627", [e.Bhutani]: "\u0F62\u0F92\u0FB1\u0F0B\u0F53\u0F42", [e.Bosnian]: "Armenija", [e.Breton]: "Armeni\xEB", [e.Bulgarian]: "\u0410\u0440\u043C\u0435\u043D\u0438\u044F", [e.Burmese]: "\u1021\u102C\u1019\u1010\u102D\u1010\u1039", [e.Catalan]: "Arm\xE8nia", [e.Chinese]: "\u4E9A\u7F8E\u5C3C\u4E9A", [e.Croatian]: "Armenija", [e.Czech]: "Arm\xE9nie", [e.Danish]: "Armenien", [e.Dutch]: "Armeni\xEB", [e.English]: "Armenia", [e.Esperanto]: "Armenia", [e.Estonian]: "Armeenia", [e.Finnish]: "Armenia", [e.French]: "Armenia", [e.Frisian]: "Armeenia", [e.Galician]: "Arm\xE9nia", [e.Georgian]: "\u10D0\u10E0\u10DB\u10DD\u10DC\u10D8", [e.German]: "Armenien", [e.Greenlandic]: "Armenia", [e.Greek]: "\u0391\u03C1\u03BC\u03B5\u03BD\u03AF\u03B1", [e.Gujarati]: "\u0A85\u0AB0\u0ACD\u0AAE\u0AC7\u0AA8\u0ABF", [e.Haitian]: "Armenia", [e.Hausa]: "Armenia", [e.Hebrew]: "\u05D0\u05E8\u05DE\u05E0\u05D9\u05D4", [e.Hindi]: "\u0905\u05E8\u05DE\u05E0\u093F\u092F\u093E", [e.Hungarian]: "\xD6rm\xE9nyorsz\xE1g", [e.Icelandic]: "Armenia", [e.Igbo]: "Armenia", [e.Indonesian]: "Armenia", [e.Irish]: "Armenia", [e.Italian]: "Armenia", [e.Japanese]: "\u30A2\u30EB\u30E1\u30CB\u30A2", [e.Javanese]: "Armenia", [e.Kannada]: "\u0C85\u0CB0\u0CCD\u0CAE\u0CC7\u0CA8\u0CBF", [e.Kazakh]: "\u0410\u0440\u043C\u0435\u043D\u0438\u044F", [e.Khmer]: "\u17A2\u17B6\u1798\u17C9\u17C1\u179A\u17B8", [e.Korean]: "\uC544\uB974\uBA54\uB2C8\uC544", [e.Kurdish]: "Armenia", [e.Kyrgyz]: "\u0410\u0440\u043C\u0435\u043D\u0438\u044F", [e.Lao]: "\u0EAD\u0EB2\u0EAB\u0EBC\u0E99\u0EB2", [e.Latin]: "Armenia", [e.Latvian]: "Armeenia", [e.Lithuanian]: "Arm\u0117nija", [e.Luxembourgish]: "Armenien", [e.Macedonian]: "\u0410\u0440\u043C\u0435\u043D\u0438\u0458\u0430", [e.Malagasy]: "Armenia", [e.Malay]: "Armenia", [e.Malayalam]: "\u0D05\u0D30\u0D4D\u200D\u0D2E\u0D47\u0D28\u0D3F", [e.Maltese]: "Armenia", [e.Maori]: "Armenia", [e.Marathi]: "\u0905\u0930\u094D\u092E\u0947\u0928\u093F", [e.Mongolian]: "\u0410\u0440\u043C\u0435\u043D\u0438\u044F", [e.Nepali]: "\u0905\u0930\u094D\u092E\u0947\u0928\u093F", [e.Norwegian]: "Armenia", [e.Pashto]: "\u0622\u0631\u0645\u06CC\u0646\u06CC\u0627", [e.Persian]: "\u0627\u0631\u0645\u0646\u0633\u062A\u0627\u0646", [e.Polish]: "Armenia", [e.Portuguese]: "Armenia", [e.Punjabi]: "\u0A05\u0A30\u0A2E\u0A40\u0A28\u0A40", [e.Romanian]: "Armenia", [e.Russian]: "\u0410\u0440\u043C\u0435\u043D\u0438\u044F", [e.Samoan]: "Armenia", [e.Sanskrit]: "Armenia", [e.Scots]: "Armenia", [e.Serbian]: "\u0410\u0440\u043C\u0435\u043D\u0438\u0458\u0430", [e.Sesotho]: "Armenia", [e.Shona]: "Armenia", [e.Sindhi]: "Armenia", [e.Sinhala]: "\u0D86\u0DBB\u0DCA\u0DB8\u0DD3\u0DB1\u0DD2", [e.Slovak]: "Armenia", [e.Slovenian]: "Armenija", [e.Somali]: "Armenia", [e.Spanish]: "Armenia", [e.Sudanese]: "Armenia", [e.Swahili]: "Armenia", [e.Swedish]: "Armenien", [e.Tagalog]: "Armenia", [e.Tajik]: "\u0410\u0440\u043C\u0435\u043D\u0438\u044F", [e.Tamil]: "\u0B85\u0BB0\u0BCD\u0BAE\u0BC7\u0BA9\u0BBF\u0BAF\u0BA9\u0BCD", [e.Tatar]: "\u0410\u0440\u043C\u0435\u043D\u0438\u044F", [e.Telugu]: "\u0C05\u0C30\u0C4D\u0C2E\u0C47\u0C28\u0C3F", [e.Thai]: "\u0E2D\u0E32\u0E23\u0E4C\u0E40\u0E21\u0E19\u0E34\u0E2A\u0E16\u0E32\u0E19", [e.Tibetan]: "\u0F68\u0F62\u0F0B\u0F58\u0F7A\u0F0B\u0F53\u0F72\u0F0B\u0F61\u0F74\u0F0D", [e.Turkish]: "Ermenistan", [e.Ukrainian]: "\u0410\u0440\u043C\u0435\u043D\u0456\u044F", [e.Urdu]: "\u0627\u0631\u0645\u0646\u0633\u062A\u0627\u0646", [e.Uzbek]: "\u0410\u0440\u043C\u0435\u043D\u0438\u044F", [e.Vietnamese]: "Armenia", [e.Welsh]: "Armenia", [e.Xhosa]: "Armenia", [e.Yiddish]: "\u05D0\u05E8\u05DE\u05E0\u05D9\u05D4", [e.Yoruba]: "Armenia", [e.Zulu]: "Armenia" } } }, SomeCountry: { i18n: { calling_codes: [], currencies: [], languages: [], tz: { offsets: [], regions: [], timezones: [] } }, id: r.AmericanSamoa, info: { flag: { emoji: "", emoji_unicode: "", svg: "" }, tld: [] }, iso: { alpha2: r.AmericanSamoa, alpha3: "", numeric: "" }, name: { alt_spellings: [], demonym: "", native: { endonym: "" }, official: "", short: "", translations: { [e.Afrikaans]: "", [e.Albanian]: "", [e.Amharic]: "", [e.Arabic]: "", [e.Armenian]: "", [e.Azerbaijani]: "", [e.Bashkir]: "", [e.Basque]: "", [e.Belarusian]: "", [e.Bengali]: "", [e.Berber]: "", [e.Bhutani]: "", [e.Bosnian]: "", [e.Breton]: "", [e.Bulgarian]: "", [e.Burmese]: "", [e.Catalan]: "", [e.Chinese]: "", [e.Croatian]: "", [e.Czech]: "", [e.Danish]: "", [e.Dutch]: "", [e.English]: "", [e.Esperanto]: "", [e.Estonian]: "", [e.Finnish]: "", [e.French]: "", [e.Frisian]: "", [e.Galician]: "", [e.Georgian]: "", [e.German]: "", [e.Greenlandic]: "", [e.Greek]: "", [e.Gujarati]: "", [e.Haitian]: "", [e.Hausa]: "", [e.Hebrew]: "", [e.Hindi]: "", [e.Hungarian]: "", [e.Icelandic]: "", [e.Igbo]: "", [e.Indonesian]: "", [e.Irish]: "", [e.Italian]: "", [e.Japanese]: "", [e.Javanese]: "", [e.Kannada]: "", [e.Kazakh]: "", [e.Khmer]: "", [e.Korean]: "", [e.Kurdish]: "", [e.Kyrgyz]: "", [e.Lao]: "", [e.Latin]: "", [e.Latvian]: "", [e.Lithuanian]: "", [e.Luxembourgish]: "", [e.Macedonian]: "", [e.Malagasy]: "", [e.Malay]: "", [e.Malayalam]: "", [e.Maltese]: "", [e.Maori]: "", [e.Marathi]: "", [e.Mongolian]: "", [e.Nepali]: "", [e.Norwegian]: "", [e.Pashto]: "", [e.Persian]: "", [e.Polish]: "", [e.Portuguese]: "", [e.Punjabi]: "", [e.Romanian]: "", [e.Russian]: "", [e.Samoan]: "", [e.Sanskrit]: "", [e.Scots]: "", [e.Serbian]: "", [e.Sesotho]: "", [e.Shona]: "", [e.Sindhi]: "", [e.Sinhala]: "", [e.Slovak]: "", [e.Slovenian]: "", [e.Somali]: "", [e.Spanish]: "", [e.Sudanese]: "", [e.Swahili]: "", [e.Swedish]: "", [e.Tagalog]: "", [e.Tajik]: "", [e.Tamil]: "", [e.Tatar]: "", [e.Telugu]: "", [e.Thai]: "", [e.Tibetan]: "", [e.Turkish]: "", [e.Ukrainian]: "", [e.Urdu]: "", [e.Uzbek]: "", [e.Vietnamese]: "", [e.Welsh]: "", [e.Xhosa]: "", [e.Yiddish]: "", [e.Yoruba]: "", [e.Zulu]: "" } } } };
var _r = { id: e.Afrikaans, language: { code: t.Afrikaans, name: "Afrikaans", native: "Afrikaans" }, name: "Afrikaans", native_name: "Afrikaans", rtl: false };
var Er = { country: { code: r.SouthAfrica, name: "South Africa", native: "South Africa" }, id: e.AfrikaansSouthAfrica, language: { code: t.Afrikaans, name: "Afrikaans", native: "Afrikaans" }, name: "Afrikaans (South Africa)", native_name: "Afrikaans (Suid-Afrika)", rtl: false };
var Sr = { id: e.Albanian, language: { code: t.Albanian, name: "Albanian", native: "Shqip" }, name: "Albanian", native_name: "Shqip", rtl: false };
var Tr = { country: { code: r.Albania, name: "Albania", native: "Shqip\xEBria" }, id: e.AlbanianAlbania, language: { code: t.Albanian, name: "Albanian", native: "Shqip" }, name: "Albanian (Albania)", native_name: "Shqip (Shqip\xEBria)", rtl: false };
var pr = { id: e.Amharic, language: { code: t.Amharic, name: "Amharic", native: "\u12A0\u121B\u122D\u129B" }, name: "Amharic", native_name: "\u12A0\u121B\u122D\u129B", rtl: false };
var br = { country: { code: r.Ethiopia, name: "Ethiopia", native: "\u12A2\u1275\u12EE\u1335\u12EB" }, id: e.AmharicEthiopia, language: { code: t.Amharic, name: "Amharic", native: "\u12A0\u121B\u122D\u129B" }, name: "Amharic (Ethiopia)", native_name: "\u12A0\u121B\u122D\u129B (\u12A2\u1275\u12EE\u1335\u12EB)", rtl: false };
var vr = { id: e.Arabic, language: { code: t.Arabic, name: "Arabic", native: "\u0627\u0644\u0639\u0631\u0628\u064A\u0629" }, name: "Arabic", native_name: "\u0627\u0644\u0639\u0631\u0628\u064A\u0629", rtl: true };
var Br = { country: { code: r.Algeria, name: "Algeria", native: "\u0627\u0644\u062C\u0632\u0627\u0626\u0631" }, id: e.ArabicAlgeria, language: { code: t.Arabic, name: "Arabic", native: "\u0627\u0644\u0639\u0631\u0628\u064A\u0629" }, name: "Arabic (Algeria)", native_name: "\u0627\u0644\u0639\u0631\u0628\u064A\u0629 (\u0627\u0644\u062C\u0632\u0627\u0626\u0631)", rtl: true };
var Nr = { country: { code: r.Bahrain, name: "Bahrain", native: "\u0627\u0644\u0628\u062D\u0631\u064A\u0646" }, id: e.ArabicBahrain, language: { code: t.Arabic, name: "Arabic", native: "\u0627\u0644\u0639\u0631\u0628\u064A\u0629" }, name: "Arabic (Bahrain)", native_name: "\u0627\u0644\u0639\u0631\u0628\u064A\u0629 (\u0627\u0644\u0628\u062D\u0631\u064A\u0646)", rtl: true };
var Ur = { country: { code: r.Egypt, name: "Egypt", native: "\u0645\u0635\u0631" }, id: e.ArabicEgypt, language: { code: t.Arabic, name: "Arabic", native: "\u0627\u0644\u0639\u0631\u0628\u064A\u0629" }, name: "Arabic (Egypt)", native_name: "\u0627\u0644\u0639\u0631\u0628\u064A\u0629 (\u0645\u0635\u0631)", rtl: true };
var Dr = { country: { code: r.Iraq, name: "Iraq", native: "\u0627\u0644\u0639\u0631\u0627\u0642" }, id: e.ArabicIraq, language: { code: t.Arabic, name: "Arabic", native: "\u0627\u0644\u0639\u0631\u0628\u064A\u0629" }, name: "Arabic (Iraq)", native_name: "\u0627\u0644\u0639\u0631\u0628\u064A\u0629 (\u0627\u0644\u0639\u0631\u0627\u0642)", rtl: true };
var Pr = { country: { code: r.Jordan, name: "Jordan", native: "\u0627\u0644\u0623\u0631\u062F\u0646" }, id: e.ArabicJordan, language: { code: t.Arabic, name: "Arabic", native: "\u0627\u0644\u0639\u0631\u0628\u064A\u0629" }, name: "Arabic (Jordan)", native_name: "\u0627\u0644\u0639\u0631\u0628\u064A\u0629 (\u0627\u0644\u0623\u0631\u062F\u0646)", rtl: true };
var kr = { country: { code: r.Kuwait, name: "Kuwait", native: "\u0627\u0644\u0643\u0648\u064A\u062A" }, id: e.ArabicKuwait, language: { code: t.Arabic, name: "Arabic", native: "\u0627\u0644\u0639\u0631\u0628\u064A\u0629" }, name: "Arabic (Kuwait)", native_name: "\u0627\u0644\u0639\u0631\u0628\u064A\u0629 (\u0627\u0644\u0643\u0648\u064A\u062A)", rtl: true };
var Mr = { country: { code: r.Lebanon, name: "Lebanon", native: "\u0644\u0628\u0646\u0627\u0646" }, id: e.ArabicLebanon, language: { code: t.Arabic, name: "Arabic", native: "\u0627\u0644\u0639\u0631\u0628\u064A\u0629" }, name: "Arabic (Lebanon)", native_name: "\u0627\u0644\u0639\u0631\u0628\u064A\u0629 (\u0644\u0628\u0646\u0627\u0646)", rtl: true };
var yr = { country: { code: r.Libya, name: "Libya", native: "\u0644\u064A\u0628\u064A\u0627" }, id: e.ArabicLibya, language: { code: t.Arabic, name: "Arabic", native: "\u0627\u0644\u0639\u0631\u0628\u064A\u0629" }, name: "Arabic (Libya)", native_name: "\u0627\u0644\u0639\u0631\u0628\u064A\u0629 (\u0644\u064A\u0628\u064A\u0627)", rtl: true };
var Fr = { country: { code: r.Morocco, name: "Morocco", native: "\u0627\u0644\u0645\u063A\u0631\u0628" }, id: e.ArabicMorocco, language: { code: t.Arabic, name: "Arabic", native: "\u0627\u0644\u0639\u0631\u0628\u064A\u0629" }, name: "Arabic (Morocco)", native_name: "\u0627\u0644\u0639\u0631\u0628\u064A\u0629 (\u0627\u0644\u0645\u063A\u0631\u0628)", rtl: true };
var Lr = { country: { code: r.Oman, name: "Oman", native: "\u0639\u0645\u0627\u0646" }, id: e.ArabicOman, language: { code: t.Arabic, name: "Arabic", native: "\u0627\u0644\u0639\u0631\u0628\u064A\u0629" }, name: "Arabic (Oman)", native_name: "\u0627\u0644\u0639\u0631\u0628\u064A\u0629 (\u0639\u0645\u0627\u0646)", rtl: true };
var qr = { country: { code: r.Qatar, name: "Qatar", native: "\u0642\u0637\u0631" }, id: e.ArabicQatar, language: { code: t.Arabic, name: "Arabic", native: "\u0627\u0644\u0639\u0631\u0628\u064A\u0629" }, name: "Arabic (Qatar)", native_name: "\u0627\u0644\u0639\u0631\u0628\u064A\u0629 (\u0642\u0637\u0631)", rtl: true };
var Gr = { country: { code: r.SaudiArabia, name: "Saudi Arabia", native: "\u0627\u0644\u0645\u0645\u0644\u0643\u0629 \u0627\u0644\u0639\u0631\u0628\u064A\u0629 \u0627\u0644\u0633\u0639\u0648\u062F\u064A\u0629" }, id: e.ArabicSaudiArabia, language: { code: t.Arabic, name: "Arabic", native: "\u0627\u0644\u0639\u0631\u0628\u064A\u0629" }, name: "Arabic (Saudi Arabia)", native_name: "\u0627\u0644\u0639\u0631\u0628\u064A\u0629 (\u0627\u0644\u0645\u0645\u0644\u0643\u0629 \u0627\u0644\u0639\u0631\u0628\u064A\u0629 \u0627\u0644\u0633\u0639\u0648\u062F\u064A\u0629)", rtl: true };
var wr = { country: { code: r.Tunisia, name: "Tunisia", native: "\u062A\u0648\u0646\u0633" }, id: e.ArabicTunisia, language: { code: t.Arabic, name: "Arabic", native: "\u0627\u0644\u0639\u0631\u0628\u064A\u0629" }, name: "Arabic (Tunisia)", native_name: "\u0627\u0644\u0639\u0631\u0628\u064A\u0629 (\u062A\u0648\u0646\u0633)", rtl: true };
var Kr = { country: { code: r.UnitedArabEmirates, name: "United Arab Emirates", native: "\u0627\u0644\u0625\u0645\u0627\u0631\u0627\u062A \u0627\u0644\u0639\u0631\u0628\u064A\u0629 \u0627\u0644\u0645\u062A\u062D\u062F\u0629" }, id: e.ArabicUnitedArabEmirates, language: { code: t.Arabic, name: "Arabic", native: "\u0627\u0644\u0639\u0631\u0628\u064A\u0629" }, name: "Arabic (United Arab Emirates)", native_name: "\u0627\u0644\u0639\u0631\u0628\u064A\u0629 (\u0627\u0644\u0625\u0645\u0627\u0631\u0627\u062A \u0627\u0644\u0639\u0631\u0628\u064A\u0629 \u0627\u0644\u0645\u062A\u062D\u062F\u0629)", rtl: true };
var xr = { country: { code: r.Yemen, name: "Yemen", native: "\u0627\u0644\u064A\u0645\u0646" }, id: e.ArabicYemen, language: { code: t.Arabic, name: "Arabic", native: "\u0627\u0644\u0639\u0631\u0628\u064A\u0629" }, name: "Arabic (Yemen)", native_name: "\u0627\u0644\u0639\u0631\u0628\u064A\u0629 (\u0627\u0644\u064A\u0645\u0646)", rtl: true };
var Or = { id: e.Armenian, language: { code: t.Armenian, name: "Armenian", native: "\u0540\u0561\u0575\u0565\u0580\u0565\u0576" }, name: "Armenian", native_name: "\u0540\u0561\u0575\u0565\u0580\u0565\u0576", rtl: false };
var Hr = { country: { code: r.Armenia, name: "Armenia", native: "\u0540\u0561\u0575\u0561\u057D\u057F\u0561\u0576" }, id: e.ArmenianArmenia, language: { code: t.Armenian, name: "Armenian", native: "\u0570\u0561\u0575\u0565\u0580\u0565\u0576" }, name: "Armenian (Armenia)", native_name: "\u0570\u0561\u0575\u0565\u0580\u0565\u0576 (\u0540\u0561\u0575\u0561\u057D\u057F\u0561\u0576)", rtl: false };
var jr = { id: e.Azerbaijani, language: { code: t.Azerbaijani, name: "Azeribaijani", native: "Az\u0259rbaycan" }, name: "Azeri", native_name: "Az\u0259rbaycan", rtl: false };
var Vr = { country: { code: r.Azerbaijan, name: "Azerbaijan", native: "Az\u0259rbaycan" }, id: e.AzerbaijaniAzerbaijan, language: { code: t.Azerbaijani, name: "Azerbaijani", native: "Az\u0259rbaycan" }, name: "Azeri (Azerbaijan)", native_name: "Az\u0259rbaycan (Az\u0259rbaycan)", rtl: false };
var zr = { id: e.Basque, language: { code: t.Basque, name: "Basque", native: "Euskara" }, name: "Basque", native_name: "Euskara", rtl: false };
var Wr = { country: { code: r.Spain, name: "Spain", native: "Espa\xF1a" }, id: e.BasqueSpain, language: { code: t.Basque, name: "Basque", native: "Euskara" }, name: "Basque (Spain)", native_name: "Euskara (Espa\xF1a)", rtl: false };
var Rr = { id: e.Belarusian, language: { code: t.Belarusian, name: "Belarusian", native: "\u0411\u0435\u043B\u0430\u0440\u0443\u0441\u043A\u0430\u044F" }, name: "Belarusian", native_name: "\u0411\u0435\u043B\u0430\u0440\u0443\u0441\u043A\u0430\u044F", rtl: false };
var Jr = { country: { code: r.Belarus, name: "Belarus", native: "\u0411\u0435\u043B\u0430\u0440\u0443\u0441\u044C" }, id: e.BelarusianBelarus, language: { code: t.Belarusian, name: "Belarusian", native: "\u0431\u0435\u043B\u0430\u0440\u0443\u0441\u043A\u0430\u044F" }, name: "Belarusian (Belarus)", native_name: "\u0431\u0435\u043B\u0430\u0440\u0443\u0441\u043A\u0430\u044F (\u0411\u0435\u043B\u0430\u0440\u0443\u0441\u044C)", rtl: false };
var Zr = { id: e.Bengali, language: { code: t.Bengali, name: "Bengali", native: "\u09AC\u09BE\u0982\u09B2\u09BE" }, name: "Bengali", native_name: "\u09AC\u09BE\u0982\u09B2\u09BE", rtl: false };
var Yr = { country: { code: r.Bangladesh, name: "Bangladesh", native: "\u09AC\u09BE\u0982\u09B2\u09BE\u09A6\u09C7\u09B6" }, id: e.BengaliBangladesh, language: { code: t.Bengali, name: "Bengali", native: "\u09AC\u09BE\u0982\u09B2\u09BE" }, name: "Bengali (Bangladesh)", native_name: "\u09AC\u09BE\u0982\u09B2\u09BE (\u09AC\u09BE\u0982\u09B2\u09BE\u09A6\u09C7\u09B6)", rtl: false };
var $r = { id: e.Bhutani, language: { code: t.Bhutani, name: "Bhutani", native: "\u0F56\u0F7C\u0F51\u0F0B\u0F61\u0F72\u0F42" }, name: "Bhutani", native_name: "\u0F56\u0F7C\u0F51\u0F0B\u0F61\u0F72\u0F42", rtl: false };
var Qr = { country: { code: r.Bhutan, name: "Bhutan", native: "\u0F60\u0F56\u0FB2\u0F74\u0F42" }, id: e.BhutaniBhutan, language: { code: t.Bhutani, name: "Bhutani", native: "\u0F56\u0F7C\u0F51\u0F0B\u0F61\u0F72\u0F42" }, name: "Bhutani (Bhutan)", native_name: "\u0F56\u0F7C\u0F51\u0F0B\u0F61\u0F72\u0F42 (\u0F60\u0F56\u0FB2\u0F74\u0F42)", rtl: false };
var Xr = { id: e.Bulgarian, language: { code: t.Bulgarian, name: "Bulgarian", native: "\u0411\u044A\u043B\u0433\u0430\u0440\u0441\u043A\u0438" }, name: "Bulgarian", native_name: "\u0411\u044A\u043B\u0433\u0430\u0440\u0441\u043A\u0438", rtl: false };
var Cr = { country: { code: r.Bulgaria, name: "Bulgaria", native: "\u0411\u044A\u043B\u0433\u0430\u0440\u0438\u044F" }, id: e.BulgarianBulgaria, language: { code: t.Bulgarian, name: "Bulgarian", native: "\u0431\u044A\u043B\u0433\u0430\u0440\u0441\u043A\u0438" }, name: "Bulgarian (Bulgaria)", native_name: "\u0431\u044A\u043B\u0433\u0430\u0440\u0441\u043A\u0438 (\u0411\u044A\u043B\u0433\u0430\u0440\u0438\u044F)", rtl: false };
var at = { id: e.Burmese, language: { code: t.Burmese, name: "Burmese", native: "\u1017\u1019\u102C\u1005\u102C" }, name: "Burmese", native_name: "\u1017\u1019\u102C\u1005\u102C", rtl: false };
var et = { country: { code: r.Myanmar, name: "Myanmar", native: "\u1019\u103C\u1014\u103A\u1019\u102C" }, id: e.BurmeseMyanmar, language: { code: t.Burmese, name: "Burmese", native: "\u1017\u1019\u102C\u1005\u102C" }, name: "Burmese (Myanmar)", native_name: "\u1017\u1019\u102C\u1005\u102C (\u1019\u103C\u1014\u103A\u1019\u102C)", rtl: false };
var it = { id: e.Cantonese, language: { code: t.Cantonese, name: "Cantonese", native: "\u5EE3\u6771\u8A71" }, name: "Cantonese", native_name: "\u5EE3\u6771\u8A71", rtl: false };
var nt = { country: { code: r.HongKong, name: "Hong Kong", native: "\u9999\u6E2F" }, id: e.CantoneseHongKong, language: { code: t.Cantonese, name: "Cantonese", native: "\u5EE3\u6771\u8A71" }, name: "Cantonese (Hong Kong)", native_name: "\u5EE3\u6771\u8A71 (\u9999\u6E2F)", rtl: false };
var st = { id: e.Catalan, language: { code: t.Catalan, name: "Catalan", native: "Catal\xE0" }, name: "Catalan", native_name: "Catal\xE0", rtl: false };
var ut = { country: { code: r.Spain, name: "Spain", native: "Espa\xF1a" }, id: e.CatalanSpain, language: { code: t.Catalan, name: "Catalan", native: "Catal\xE0" }, name: "Catalan (Spain)", native_name: "Catal\xE0 (Espanya)", rtl: false };
var rt = { id: e.ChineseSimplified, language: { code: t.Chinese, name: "Chinese", native: "\u4E2D\u6587" }, name: "Chinese (Simplified)", native_name: "\u4E2D\u6587", rtl: false };
var tt = { country: { code: r.China, name: "China", native: "\u4E2D\u56FD" }, id: e.ChineseSimplifiedChina, language: { code: t.Chinese, name: "Chinese", native: "\u4E2D\u6587" }, name: "Chinese (Simplified/China)", native_name: "\u4E2D\u6587 (\u4E2D\u56FD)", rtl: false };
var lt = { country: { code: r.HongKong, name: "Hong Kong", native: "\u9999\u6E2F" }, id: e.ChineseSimplifiedHongKong, language: { code: t.Chinese, name: "Chinese", native: "\u4E2D\u6587" }, name: "Chinese (Simplified/Hong Kong)", native_name: "\u4E2D\u6587 (\u9999\u6E2F)", rtl: false };
var mt = { country: { code: r.Macau, name: "Macau", native: "\u6FB3\u9580" }, id: e.ChineseSimplifiedMacau, language: { code: t.Chinese, name: "Chinese", native: "\u4E2D\u6587" }, name: "Chinese (Simplified/Macau)", native_name: "\u4E2D\u6587 (\u6FB3\u9580)", rtl: false };
var ot = { country: { code: r.Singapore, name: "Singapore", native: "\u65B0\u52A0\u5761" }, id: e.ChineseSimplifiedSingapore, language: { code: t.Chinese, name: "Chinese", native: "\u4E2D\u6587" }, name: "Chinese (Simplified/Singapore)", native_name: "\u4E2D\u6587 (\u65B0\u52A0\u5761)", rtl: false };
var ct = { id: e.ChineseTraditional, language: { code: t.Chinese, name: "Chinese", native: "\u4E2D\u6587" }, name: "Chinese (Traditional)", native_name: "\u4E2D\u6587", rtl: false };
var At = { country: { code: r.HongKong, name: "Hong Kong", native: "\u9999\u6E2F" }, id: e.ChineseTraditionalHongKong, language: { code: t.Chinese, name: "Chinese (Traditional/Hong Kong)", native: "\u4E2D\u6587" }, name: "Chinese (Hong Kong)", native_name: "\u4E2D\u6587 (\u9999\u6E2F)", rtl: false };
var dt = { country: { code: r.Macau, name: "Macau", native: "\u6FB3\u9580" }, id: e.ChineseTraditionalMacau, language: { code: t.Chinese, name: "Chinese (Traditional/Macau)", native: "\u4E2D\u6587" }, name: "Chinese (Macau)", native_name: "\u4E2D\u6587 (\u6FB3\u9580)", rtl: false };
var It = { country: { code: r.Singapore, name: "Singapore", native: "\u65B0\u52A0\u5761" }, id: e.ChineseTraditionalSingapore, language: { code: t.Chinese, name: "Chinese (Traditional/Singapore)", native: "\u4E2D\u6587" }, name: "Chinese (Singapore)", native_name: "\u4E2D\u6587 (\u65B0\u52A0\u5761)", rtl: false };
var ht = { id: e.Croatian, language: { code: t.Croatian, name: "Croatian", native: "Hrvatski" }, name: "Croatian", native_name: "Hrvatski", rtl: false };
var gt = { country: { code: r.BosniaAndHerzegovina, name: "Bosnia and Herzegovina", native: "Bosna i Hercegovina" }, id: e.CroatianBosniaAndHerzegovina, language: { code: t.Croatian, name: "Croatian", native: "Hrvatski" }, name: "Croatian (Bosnia and Herzegovina)", native_name: "Hrvatski (Bosna i Hercegovina)", rtl: false };
var ft = { country: { code: r.Croatia, name: "Croatia", native: "Hrvatska" }, id: e.CroatianCroatia, language: { code: t.Croatian, name: "Croatian", native: "Hrvatski" }, name: "Croatian (Croatia)", native_name: "Hrvatski (Hrvatska)", rtl: false };
var _t = { id: e.Czech, language: { code: t.Czech, name: "Czech", native: "\u010Ce\u0161tina" }, name: "Czech", native_name: "\u010Ce\u0161tina", rtl: false };
var Et = { country: { code: r.CzechRepublic, name: "Czech Republic", native: "\u010Cesk\xE1 republika" }, id: e.CzechCzechRepublic, language: { code: t.Czech, name: "Czech", native: "\u010Ce\u0161tina" }, name: "Czech (Czech Republic)", native_name: "\u010Ce\u0161tina (\u010Cesk\xE1 republika)", rtl: false };
var St = { id: e.Danish, language: { code: t.Danish, name: "Danish", native: "Dansk" }, name: "Danish", native_name: "Dansk", rtl: false };
var Tt = { country: { code: r.Denmark, name: "Denmark", native: "Danmark" }, id: e.DanishDenmark, language: { code: t.Danish, name: "Danish", native: "Dansk" }, name: "Danish (Denmark)", native_name: "Dansk (Danmark)", rtl: false };
var pt = { id: e.Divehi, language: { code: t.Divehi, name: "Divehi", native: "\u078B\u07A8\u0788\u07AC\u0780\u07A8\u0784\u07A6\u0790\u07B0" }, name: "Divehi", native_name: "\u078B\u07A8\u0788\u07AC\u0780\u07A8\u0784\u07A6\u0790\u07B0", rtl: true };
var bt = { country: { code: r.Maldives, name: "Maldives", native: "\u078B\u07A8\u0788\u07AC\u0780\u07A8 \u0783\u07A7\u0787\u07B0\u0796\u07AC" }, id: e.DivehiMaldives, language: { code: t.Divehi, name: "Divehi", native: "\u078B\u07A8\u0788\u07AC\u0780\u07A8\u0784\u07A6\u0790\u07B0" }, name: "Divehi (Maldives)", native_name: "\u078B\u07A8\u0788\u07AC\u0780\u07A8\u0784\u07A6\u0790\u07B0 (\u078B\u07A8\u0788\u07AC\u0780\u07A8 \u0783\u07A7\u0787\u07B0\u0796\u07AC)", rtl: true };
var vt = { id: e.Dutch, language: { code: t.Dutch, name: "Dutch", native: "Nederlands" }, name: "Dutch", native_name: "Nederlands", rtl: false };
var Bt = { country: { code: r.Belgium, name: "Belgium", native: "Belgi\xEB" }, id: e.DutchBelgium, language: { code: t.Dutch, name: "Dutch", native: "Nederlands" }, name: "Dutch (Belgium)", native_name: "Nederlands (Belgi\xEB)", rtl: false };
var Nt = { country: { code: r.Netherlands, name: "Netherlands", native: "Nederland" }, id: e.DutchNetherlands, language: { code: t.Dutch, name: "Dutch", native: "Nederlands" }, name: "Dutch (Netherlands)", native_name: "Nederlands (Nederland)", rtl: false };
var Ut = { id: e.English, language: { code: t.English, name: "English", native: "English" }, name: "English", native_name: "English", rtl: false };
var Dt = { country: { code: r.Australia, name: "Australia", native: "Australia" }, id: e.EnglishAustralia, language: { code: t.English, name: "English", native: "English" }, name: "English (Australia)", native_name: "English (Australia)", rtl: false };
var Pt = { country: { code: r.Belgium, name: "Belgium", native: "Belgi\xEB" }, id: e.EnglishBelgium, language: { code: t.English, name: "English", native: "English" }, name: "English (Belgium)", native_name: "English (Belgi\xEB)", rtl: false };
var kt = { country: { code: r.Canada, name: "Canada", native: "Canada" }, id: e.EnglishCanada, language: { code: t.English, name: "English", native: "English" }, name: "English (Canada)", native_name: "English (Canada)", rtl: false };
var Mt = { country: { code: r.Ireland, name: "Ireland", native: "\xC9ire" }, id: e.EnglishIreland, language: { code: t.English, name: "English", native: "English" }, name: "English (Ireland)", native_name: "English (\xC9ire)", rtl: false };
var yt = { country: { code: r.Jamaica, name: "Jamaica", native: "Jamaica" }, id: e.EnglishJamaica, language: { code: t.English, name: "English", native: "English" }, name: "English (Jamaica)", native_name: "English (Jamaica)", rtl: false };
var Ft = { country: { code: r.NewZealand, name: "New Zealand", native: "New Zealand" }, id: e.EnglishNewZealand, language: { code: t.English, name: "English", native: "English" }, name: "English (New Zealand)", native_name: "English (New Zealand)", rtl: false };
var Lt = { country: { code: r.Philippines, name: "Philippines", native: "Philippines" }, id: e.EnglishPhilippines, language: { code: t.English, name: "English", native: "English" }, name: "English (Philippines)", native_name: "English (Philippines)", rtl: false };
var qt = { country: { code: r.Singapore, name: "Singapore", native: "Singapore" }, id: e.EnglishSingapore, language: { code: t.English, name: "English", native: "English" }, name: "English (Singapore)", native_name: "English (Singapore)", rtl: false };
var Gt = { country: { code: r.SouthAfrica, name: "South Africa", native: "South Africa" }, id: e.EnglishSouthAfrica, language: { code: t.English, name: "English", native: "English" }, name: "English (South Africa)", native_name: "English (South Africa)", rtl: false };
var wt = { country: { code: r.TrinidadAndTobago, name: "Trinidad and Tobago", native: "Trinidad and Tobago" }, id: e.EnglishTrinidadAndTobago, language: { code: t.English, name: "English", native: "English" }, name: "English (Trinidad and Tobago)", native_name: "English (Trinidad and Tobago)", rtl: false };
var Kt = { country: { code: r.UnitedKingdom, name: "United Kingdom", native: "United Kingdom" }, id: e.EnglishUnitedKingdom, language: { code: t.English, name: "English", native: "English" }, name: "English (United Kingdom)", native_name: "English (United Kingdom)", rtl: false };
var xt = { country: { code: r.UnitedStates, name: "United States", native: "United States" }, id: e.EnglishUnitedStates, language: { code: t.English, name: "English", native: "English" }, name: "English (United States)", native_name: "English (United States)", rtl: false };
var Ot = { country: { code: r.Zimbabwe, name: "Zimbabwe", native: "Zimbabwe" }, id: e.EnglishZimbabwe, language: { code: t.English, name: "English", native: "English" }, name: "English (Zimbabwe)", native_name: "English (Zimbabwe)", rtl: false };
var Ht = { id: e.Esperanto, language: { code: t.Esperanto, name: "Esperanto", native: "Esperanto" }, name: "Esperanto", native_name: "Esperanto", rtl: false };
var jt = { id: e.Estonian, language: { code: t.Estonian, name: "Estonian", native: "Eesti" }, name: "Estonian", native_name: "Eesti", rtl: false };
var Vt = { country: { code: r.Estonia, name: "Estonia", native: "Eesti" }, id: e.EstonianEstonia, language: { code: t.Estonian, name: "Estonian", native: "Eesti" }, name: "Estonian (Estonia)", native_name: "Eesti (Eesti)", rtl: false };
var zt = { id: e.Faroese, language: { code: t.Faroese, name: "Faroese", native: "F\xF8royskt" }, name: "Faroese", native_name: "F\xF8royskt", rtl: false };
var Wt = { country: { code: r.FaroeIslands, name: "Faroe Islands", native: "F\xF8royar" }, id: e.FaroeseFaroeIslands, language: { code: t.Faroese, name: "Faroese", native: "F\xF8royskt" }, name: "Faroese (Faroe Islands)", native_name: "F\xF8royskt (F\xF8royar)", rtl: false };
var Rt = { id: e.Farsi, language: { code: t.Farsi, name: "Farsi", native: "\u0641\u0627\u0631\u0633\u06CC" }, name: "Farsi", native_name: "\u0641\u0627\u0631\u0633\u06CC", rtl: true };
var Jt = { country: { code: r.Iran, name: "Iran", native: "\u0627\u06CC\u0631\u0627\u0646" }, id: e.FarsiIran, language: { code: t.Farsi, name: "Farsi", native: "\u0641\u0627\u0631\u0633\u06CC" }, name: "Farsi (Iran)", native_name: "\u0641\u0627\u0631\u0633\u06CC (\u0627\u06CC\u0631\u0627\u0646)", rtl: true };
var Zt = { id: e.Filipino, language: { code: t.Filipino, name: "Filipino", native: "Filipino" }, name: "Filipino", native_name: "Filipino", rtl: false };
var Yt = { country: { code: r.Philippines, name: "Philippines", native: "Pilipinas" }, id: e.FilipinoPhilippines, language: { code: t.Filipino, name: "Filipino", native: "Filipino" }, name: "Filipino (Philippines)", native_name: "Filipino (Pilipinas)", rtl: false };
var $t = { id: e.Finnish, language: { code: t.Finnish, name: "Finnish", native: "Suomi" }, name: "Finnish", native_name: "Suomi", rtl: false };
var Qt = { country: { code: r.Finland, name: "Finland", native: "Suomi" }, id: e.FinnishFinland, language: { code: t.Finnish, name: "Finnish", native: "Suomi" }, name: "Finnish (Finland)", native_name: "Suomi (Suomi)", rtl: false };
var Xt = { id: e.French, language: { code: t.French, name: "French", native: "Fran\xE7ais" }, name: "French", native_name: "Fran\xE7ais", rtl: false };
var Ct = { country: { code: r.Belgium, name: "Belgium", native: "Belgique" }, id: e.FrenchBelgium, language: { code: t.French, name: "French", native: "Fran\xE7ais" }, name: "French (Belgium)", native_name: "Fran\xE7ais (Belgique)", rtl: false };
var al = { country: { code: r.Canada, name: "Canada", native: "Canada" }, id: e.FrenchCanada, language: { code: t.French, name: "French", native: "Fran\xE7ais" }, name: "French (Canada)", native_name: "Fran\xE7ais (Canada)", rtl: false };
var el = { country: { code: r.France, name: "France", native: "France" }, id: e.FrenchFrance, language: { code: t.French, name: "French", native: "Fran\xE7ais" }, name: "French (France)", native_name: "Fran\xE7ais (France)", rtl: false };
var il = { country: { code: r.Luxembourg, name: "Luxembourg", native: "Luxembourg" }, id: e.FrenchLuxembourg, language: { code: t.French, name: "French", native: "Fran\xE7ais" }, name: "French (Luxembourg)", native_name: "Fran\xE7ais (Luxembourg)", rtl: false };
var nl = { country: { code: r.Monaco, name: "Monaco", native: "Monaco" }, id: e.FrenchMonaco, language: { code: t.French, name: "French", native: "Fran\xE7ais" }, name: "French (Monaco)", native_name: "Fran\xE7ais (Monaco)", rtl: false };
var sl = { country: { code: r.Reunion, name: "Reunion", native: "La R\xE9union" }, id: e.FrenchReunion, language: { code: t.French, name: "French", native: "Fran\xE7ais" }, name: "French (Reunion)", native_name: "Fran\xE7ais (La R\xE9union)", rtl: false };
var ul = { country: { code: r.Switzerland, name: "Switzerland", native: "Suisse" }, id: e.FrenchSwitzerland, language: { code: t.French, name: "French", native: "Fran\xE7ais" }, name: "French (Switzerland)", native_name: "Fran\xE7ais (Suisse)", rtl: false };
var rl = { id: e.Frisian, language: { code: t.Frisian, name: "Frisian", native: "Frysk" }, name: "Frisian", native_name: "Frysk", rtl: false };
var tl = { country: { code: r.Netherlands, name: "Netherlands", native: "Nederland" }, id: e.FrisianNetherlands, language: { code: t.Frisian, name: "Frisian", native: "Frysk" }, name: "Frisian (Netherlands)", native_name: "Frysk (Nederland)", rtl: false };
var ll = { id: e.Galician, language: { code: t.Galician, name: "Galician", native: "Galego" }, name: "Galician", native_name: "Galego", rtl: false };
var ml = { country: { code: r.Spain, name: "Spain", native: "Espa\xF1a" }, id: e.GalicianSpain, language: { code: t.Galician, name: "Galician", native: "Galego" }, name: "Galician (Spain)", native_name: "Galego (Espa\xF1a)", rtl: false };
var ol = { id: e.Georgian, language: { code: t.Georgian, name: "Georgian", native: "\u10E5\u10D0\u10E0\u10D7\u10E3\u10DA\u10D8" }, name: "Georgian", native_name: "\u10E5\u10D0\u10E0\u10D7\u10E3\u10DA\u10D8", rtl: false };
var cl = { country: { code: r.Georgia, name: "Georgia", native: "\u10E1\u10D0\u10E5\u10D0\u10E0\u10D7\u10D5\u10D4\u10DA\u10DD" }, id: e.GeorgianGeorgia, language: { code: t.Georgian, name: "Georgian", native: "\u10E5\u10D0\u10E0\u10D7\u10E3\u10DA\u10D8" }, name: "Georgian (Georgia)", native_name: "\u10E5\u10D0\u10E0\u10D7\u10E3\u10DA\u10D8 (\u10E1\u10D0\u10E5\u10D0\u10E0\u10D7\u10D5\u10D4\u10DA\u10DD)", rtl: false };
var Al = { id: e.German, language: { code: t.German, name: "German", native: "Deutsch" }, name: "German", native_name: "Deutsch", rtl: false };
var dl = { country: { code: r.Austria, name: "Austria", native: "\xD6sterreich" }, id: e.GermanAustria, language: { code: t.German, name: "German", native: "Deutsch" }, name: "German (Austria)", native_name: "Deutsch (\xD6sterreich)", rtl: false };
var Il = { country: { code: r.Belgium, name: "Belgium", native: "Belgi\xEB" }, id: e.GermanBelgium, language: { code: t.German, name: "German", native: "Deutsch" }, name: "German (Belgium)", native_name: "Deutsch (Belgi\xEB)", rtl: false };
var hl = { country: { code: r.Switzerland, name: "Switzerland", native: "Suisse" }, id: e.GermanSwitzerland, language: { code: t.German, name: "German", native: "Deutsch" }, name: "German (Switzerland)", native_name: "Deutsch (Suisse)", rtl: false };
var gl = { country: { code: r.Liechtenstein, name: "Liechtenstein", native: "Liechtenstein" }, id: e.GermanLiechtenstein, language: { code: t.German, name: "German", native: "Deutsch" }, name: "German (Liechtenstein)", native_name: "Deutsch (Liechtenstein)", rtl: false };
var fl = { country: { code: r.Luxembourg, name: "Luxembourg", native: "Luxembourg" }, id: e.GermanLuxembourg, language: { code: t.German, name: "German", native: "Deutsch" }, name: "German (Luxembourg)", native_name: "Deutsch (Luxembourg)", rtl: false };
var _l = { id: e.Greek, language: { code: t.Greek, name: "Greek", native: "\u0395\u03BB\u03BB\u03B7\u03BD\u03B9\u03BA\u03AC" }, name: "Greek", native_name: "\u0395\u03BB\u03BB\u03B7\u03BD\u03B9\u03BA\u03AC", rtl: false };
var El = { country: { code: r.Greece, name: "Greece", native: "\u0395\u03BB\u03BB\u03AC\u03B4\u03B1" }, id: e.GreekGreece, language: { code: t.Greek, name: "Greek", native: "\u0395\u03BB\u03BB\u03B7\u03BD\u03B9\u03BA\u03AC" }, name: "Greek (Greece)", native_name: "\u0395\u03BB\u03BB\u03B7\u03BD\u03B9\u03BA\u03AC (\u0395\u03BB\u03BB\u03AC\u03B4\u03B1)", rtl: false };
var Sl = { id: e.Greenlandic, language: { code: t.Greenlandic, name: "Greenlandic", native: "Kalaallisut" }, name: "Greenlandic", native_name: "Kalaallisut", rtl: false };
var Tl = { country: { code: r.Greenland, name: "Greenland", native: "Kalaallit Nunaat" }, id: e.GreenlandicGreenland, language: { code: t.Greenlandic, name: "Greenlandic", native: "Kalaallisut" }, name: "Greenlandic (Greenland)", native_name: "Kalaallisut (Kalaallit Nunaat)", rtl: false };
var pl = { id: e.Gujarati, language: { code: t.Gujarati, name: "Gujarati", native: "\u0A97\u0AC1\u0A9C\u0AB0\u0ABE\u0AA4\u0AC0" }, name: "Gujarati", native_name: "\u0A97\u0AC1\u0A9C\u0AB0\u0ABE\u0AA4\u0AC0", rtl: false };
var bl = { country: { code: r.India, name: "India", native: "\u092D\u093E\u0930\u0924" }, id: e.GujaratiIndia, language: { code: t.Gujarati, name: "Gujarati", native: "\u0A97\u0AC1\u0A9C\u0AB0\u0ABE\u0AA4\u0AC0" }, name: "Gujarati (India)", native_name: "\u0A97\u0AC1\u0A9C\u0AB0\u0ABE\u0AA4\u0AC0 (\u092D\u093E\u0930\u0924)", rtl: false };
var vl = { id: e.Hausa, language: { code: t.Hausa, name: "Hausa", native: "\u0647\u064E\u0648\u064F\u0633\u064E" }, name: "Hausa", native_name: "\u0647\u064E\u0648\u064F\u0633\u064E", rtl: false };
var Bl = { country: { code: r.Ghana, name: "Ghana", native: "Ghana" }, id: e.HausaGhana, language: { code: t.Hausa, name: "Hausa", native: "\u0647\u064E\u0648\u064F\u0633\u064E" }, name: "Hausa (Ghana)", native_name: "\u0647\u064E\u0648\u064F\u0633\u064E (Ghana)", rtl: false };
var Nl = { country: { code: r.Niger, name: "Niger", native: "Niger" }, id: e.HausaNiger, language: { code: t.Hausa, name: "Hausa", native: "\u0647\u064E\u0648\u064F\u0633\u064E" }, name: "Hausa (Niger)", native_name: "\u0647\u064E\u0648\u064F\u0633\u064E (Niger)", rtl: false };
var Ul = { country: { code: r.Nigeria, name: "Nigeria", native: "Nigeria" }, id: e.HausaNigeria, language: { code: t.Hausa, name: "Hausa", native: "\u0647\u064E\u0648\u064F\u0633\u064E" }, name: "Hausa (Nigeria)", native_name: "\u0647\u064E\u0648\u064F\u0633\u064E (Nigeria)", rtl: false };
var Dl = { id: e.Hebrew, language: { code: t.Hebrew, name: "Hebrew", native: "\u05E2\u05D1\u05E8\u05D9\u05EA" }, name: "Hebrew", native_name: "\u05E2\u05D1\u05E8\u05D9\u05EA", rtl: true };
var Pl = { country: { code: r.Israel, name: "Hebrew", native: "" }, id: e.HebrewIsrael, language: { code: t.Hebrew, name: "Hebrew", native: "" }, name: "Hebrew (Israel)", native_name: "", rtl: true };
var kl = { id: e.Hindi, language: { code: t.Hindi, name: "Hindi", native: "\u0939\u093F\u0928\u094D\u0926\u0940" }, name: "Hindi", native_name: "\u0939\u093F\u0928\u094D\u0926\u0940", rtl: false };
var Ml = { country: { code: r.India, name: "India", native: "\u092D\u093E\u0930\u0924" }, id: e.HindiIndia, language: { code: t.Hindi, name: "Hindi", native: "\u092D\u093E\u0930\u0924\u0940\u092F" }, name: "Hindi (India)", native_name: "\u092D\u093E\u0930\u0924\u0940\u092F", rtl: false };
var yl = { id: e.Hungarian, language: { code: t.Hungarian, name: "Hungarian", native: "Magyar" }, name: "Hungarian", native_name: "Magyar", rtl: false };
var Fl = { country: { code: r.Hungary, name: "Hungary", native: "Magyarorsz\xE1g" }, id: e.HungarianHungary, language: { code: t.Hungarian, name: "Hungarian", native: "Magyar" }, name: "Hungarian (Hungary)", native_name: "Magyar (Magyarorsz\xE1g)", rtl: false };
var Ll = { id: e.Icelandic, language: { code: t.Icelandic, name: "Icelandic", native: "\xCDslenska" }, name: "Icelandic", native_name: "\xCDslenska", rtl: false };
var ql = { country: { code: r.Iceland, name: "Iceland", native: "\xCDsland" }, id: e.IcelandicIceland, language: { code: t.Icelandic, name: "Icelandic", native: "\xCDslenska" }, name: "Icelandic (Iceland)", native_name: "\xCDslenska (\xCDsland)", rtl: false };
var Gl = { id: e.Igbo, language: { code: t.Igbo, name: "Igbo", native: "Igbo" }, name: "Igbo", native_name: "Igbo", rtl: false };
var wl = { id: e.Indonesian, language: { code: t.Indonesian, name: "Indonesian", native: "Bahasa Indonesia" }, name: "Indonesian", native_name: "Bahasa Indonesia", rtl: false };
var Kl = { country: { code: r.Indonesia, name: "Indonesia", native: "Indonesia" }, id: e.IndonesianIndonesia, language: { code: t.Indonesian, name: "Indonesian", native: "Bahasa Indonesia" }, name: "Indonesian (Indonesia)", native_name: "Bahasa Indonesia (Indonesia)", rtl: false };
var xl = { id: e.Irish, language: { code: t.Irish, name: "Irish", native: "Gaeilge" }, name: "Irish", native_name: "Gaeilge", rtl: false };
var Ol = { country: { code: r.Ireland, name: "Ireland", native: "\xC9ire" }, id: e.IrishIreland, language: { code: t.Irish, name: "Irish", native: "Gaeilge" }, name: "Irish (Ireland)", native_name: "Gaeilge (\xC9ire)", rtl: false };
var Hl = { id: e.Italian, language: { code: t.Italian, name: "Italian", native: "Italiano" }, name: "Italian", native_name: "Italiano", rtl: false };
var jl = { country: { code: r.Italy, name: "Italy", native: "Italia" }, id: e.ItalianItaly, language: { code: t.Italian, name: "Italian", native: "Italiano" }, name: "Italian (Italy)", native_name: "Italiano (Italia)", rtl: false };
var Vl = { country: { code: r.Switzerland, name: "Switzerland", native: "Schweiz" }, id: e.ItalianSwitzerland, language: { code: t.Italian, name: "Italian", native: "Italiano" }, name: "Italian (Switzerland)", native_name: "Italiano (Svizzera)", rtl: false };
var zl = { id: e.Japanese, language: { code: t.Japanese, name: "Japanese", native: "\u65E5\u672C\u8A9E" }, name: "Japanese", native_name: "\u65E5\u672C\u8A9E", rtl: false };
var Wl = { country: { code: r.Japan, name: "Japan", native: "\u65E5\u672C" }, id: e.JapaneseJapan, language: { code: t.Japanese, name: "Japanese", native: "\u65E5\u672C\u8A9E" }, name: "Japanese (Japan)", native_name: "\u65E5\u672C\u8A9E (\u65E5\u672C)", rtl: false };
var Rl = { id: e.Kannada, language: { code: t.Kannada, name: "Kannada", native: "\u0C95\u0CA8\u0CCD\u0CA8\u0CA1" }, name: "Kannada", native_name: "\u0C95\u0CA8\u0CCD\u0CA8\u0CA1", rtl: false };
var Jl = { country: { code: r.India, name: "India", native: "\u0CAD\u0CBE\u0CB0\u0CA4" }, id: e.KannadaIndia, language: { code: t.Kannada, name: "Kannada", native: "\u0C95\u0CA8\u0CCD\u0CA8\u0CA1" }, name: "Kannada (India)", native_name: "\u0C95\u0CA8\u0CCD\u0CA8\u0CA1 (\u0CAD\u0CBE\u0CB0\u0CA4)", rtl: false };
var Zl = { id: e.Kazakh, language: { code: t.Kazakh, name: "Kazakh", native: "\u049A\u0430\u0437\u0430\u049B \u0442\u0456\u043B\u0456" }, name: "Kazakh", native_name: "\u049A\u0430\u0437\u0430\u049B \u0442\u0456\u043B\u0456", rtl: false };
var Yl = { country: { code: r.Kazakhstan, name: "Kazakhstan", native: "\u049A\u0430\u0437\u0430\u049B\u0441\u0442\u0430\u043D" }, id: e.KazakhKazakhstan, language: { code: t.Kazakh, name: "Kazakh", native: "\u049A\u0430\u0437\u0430\u049B \u0442\u0456\u043B\u0456" }, name: "Kazakh (Kazakhstan)", native_name: "\u049A\u0430\u0437\u0430\u049B \u0442\u0456\u043B\u0456 (\u049A\u0430\u0437\u0430\u049B\u0441\u0442\u0430\u043D)", rtl: false };
var $l = { id: e.Khmer, language: { code: t.Khmer, name: "Khmer", native: "\u1797\u17B6\u179F\u17B6\u1781\u17D2\u1798\u17C2\u179A" }, name: "Khmer", native_name: "\u1797\u17B6\u179F\u17B6\u1781\u17D2\u1798\u17C2\u179A", rtl: false };
var Ql = { country: { code: r.Cambodia, name: "Cambodia", native: "\u1780\u1798\u17D2\u1796\u17BB\u1787\u17B6" }, id: e.KhmerCambodia, language: { code: t.Khmer, name: "Khmer", native: "\u1797\u17B6\u179F\u17B6\u1781\u17D2\u1798\u17C2\u179A" }, name: "Khmer (Cambodia)", native_name: "\u1797\u17B6\u179F\u17B6\u1781\u17D2\u1798\u17C2\u179A (\u1780\u1798\u17D2\u1796\u17BB\u1787\u17B6)", rtl: false };
var Xl = { id: e.Konkani, language: { code: t.Konkani, name: "Konkani", native: "\u0915\u094B\u0902\u0915\u0923\u0940" }, name: "Konkani", native_name: "\u0915\u094B\u0902\u0915\u0923\u0940", rtl: false };
var Cl = { country: { code: r.India, name: "India", native: "\u092D\u093E\u0930\u0924" }, id: e.KonkaniIndia, language: { code: t.Konkani, name: "Konkani", native: "\u0915\u094B\u0902\u0915\u0923\u0940" }, name: "Konkani (India)", native_name: "\u0915\u094B\u0902\u0915\u0923\u0940 (\u092D\u093E\u0930\u0924)", rtl: false };
var a0 = { id: e.Korean, language: { code: t.Korean, name: "Korean", native: "\uD55C\uAD6D\uC5B4" }, name: "Korean", native_name: "\uD55C\uAD6D\uC5B4", rtl: false };
var e0 = { country: { code: r.SouthKorea, name: "South Korea", native: "\uB300\uD55C\uBBFC\uAD6D" }, id: e.KoreanSouthKorea, language: { code: t.Korean, name: "Korean", native: "\uD55C\uAD6D\uC5B4" }, name: "Korean (South Korea)", native_name: "\uD55C\uAD6D\uC5B4 (\uB300\uD55C\uBBFC\uAD6D)", rtl: false };
var i0 = { id: e.Kurdish, language: { code: t.Kurdish, name: "Kurdish", native: "Kurd\xEE" }, name: "Kurdish", native_name: "Kurd\xEE", rtl: false };
var n0 = { country: { code: r.Iraq, name: "Iraq", native: "\u0627\u0644\u0639\u0631\u0627\u0642" }, id: e.KurdishIraq, language: { code: t.Kurdish, name: "Kurdish", native: "Kurd\xEE" }, name: "Kurdish (Iraq)", native_name: "Kurd\xEE (\u0627\u0644\u0639\u0631\u0627\u0642)", rtl: false };
var s0 = { country: { code: r.Turkey, name: "Turkey", native: "T\xFCrkiye" }, id: e.KurdishTurkey, language: { code: t.Kurdish, name: "Kurdish", native: "Kurd\xEE" }, name: "Kurdish (Turkey)", native_name: "Kurd\xEE (T\xFCrkiye)", rtl: false };
var u0 = { id: e.Kyrgyz, language: { code: t.Kyrgyz, name: "Kyrgyz", native: "\u041A\u044B\u0440\u0433\u044B\u0437\u0447\u0430" }, name: "Kyrgyz", native_name: "\u041A\u044B\u0440\u0433\u044B\u0437\u0447\u0430", rtl: false };
var r0 = { country: { code: r.Kyrgyzstan, name: "Kyrgyzstan", native: "\u041A\u044B\u0440\u0433\u044B\u0437\u0441\u0442\u0430\u043D" }, id: e.KyrgyzKyrgyzstan, language: { code: t.Kyrgyz, name: "Kyrgyz", native: "\u041A\u044B\u0440\u0433\u044B\u0437\u0447\u0430" }, name: "Kyrgyz (Kyrgyzstan)", native_name: "\u041A\u044B\u0440\u0433\u044B\u0437\u0447\u0430 (\u041A\u044B\u0440\u0433\u044B\u0437\u0441\u0442\u0430\u043D)", rtl: false };
var t0 = { id: e.Lao, language: { code: t.Lao, name: "Lao", native: "\u0EA5\u0EB2\u0EA7" }, name: "Lao", native_name: "\u0EA5\u0EB2\u0EA7", rtl: false };
var l0 = { country: { code: r.Laos, name: "Laos", native: "\u0EAA.\u0E9B.\u0E9B\u0EB0\u0E8A\u0EB2\u0E97\u0EB4\u0E9B\u0EB0\u0EC4\u0E95" }, id: e.LaoLaos, language: { code: t.Lao, name: "Lao", native: "\u0EA5\u0EB2\u0EA7" }, name: "Lao (Laos)", native_name: "\u0EA5\u0EB2\u0EA7 (\u0EAA.\u0E9B.\u0E9B\u0EB0\u0E8A\u0EB2\u0E97\u0EB4\u0E9B\u0EB0\u0EC4\u0E95)", rtl: false };
var m0 = { id: e.Latvian, language: { code: t.Latvian, name: "Latvian", native: "Latvie\u0161u" }, name: "Latvian", native_name: "Latvie\u0161u", rtl: false };
var o0 = { country: { code: r.Latvia, name: "Latvia", native: "Latvija" }, id: e.LatvianLatvia, language: { code: t.Latvian, name: "Latvian", native: "Latvie\u0161u" }, name: "Latvian (Latvia)", native_name: "Latvie\u0161u (Latvija)", rtl: false };
var c0 = { id: e.Lithuanian, language: { code: t.Lithuanian, name: "Lithuanian", native: "Lietuvi\u0173" }, name: "Lithuanian", native_name: "Lietuvi\u0173", rtl: false };
var A0 = { country: { code: r.Lithuania, name: "Lithuania", native: "Lietuva" }, id: e.LithuanianLithuania, language: { code: t.Lithuanian, name: "Lithuanian", native: "Lietuvi\u0173" }, name: "Lithuanian (Lithuania)", native_name: "Lietuvi\u0173 (Lietuva)", rtl: false };
var d0 = { id: e.Luxembourgish, language: { code: t.Luxembourgish, name: "Luxembourgish", native: "L\xEBtzebuergesch" }, name: "Luxembourgish", native_name: "L\xEBtzebuergesch", rtl: false };
var I0 = { country: { code: r.Belgium, name: "Belgium", native: "Belgi\xEB" }, id: e.LuxembourgishBelgium, language: { code: t.Luxembourgish, name: "Luxembourgish", native: "L\xEBtzebuergesch" }, name: "Luxembourgish (Belgium)", native_name: "L\xEBtzebuergesch (Belgi\xEB)", rtl: false };
var h0 = { country: { code: r.Luxembourg, name: "Luxembourg", native: "Luxembourg" }, id: e.LuxembourgishLuxembourg, language: { code: t.Luxembourgish, name: "Luxembourgish", native: "L\xEBtzebuergesch" }, name: "Luxembourgish (Luxembourg)", native_name: "L\xEBtzebuergesch (Luxembourg)", rtl: false };
var g0 = { id: e.Macedonian, language: { code: t.Macedonian, name: "Macedonian", native: "\u041C\u0430\u043A\u0435\u0434\u043E\u043D\u0441\u043A\u0438" }, name: "Macedonian", native_name: "\u041C\u0430\u043A\u0435\u0434\u043E\u043D\u0441\u043A\u0438", rtl: false };
var f0 = { country: { code: r.NorthMacedonia, name: "Macedonia", native: "\u0421\u0435\u0432\u0435\u0440\u043D\u0430 \u041C\u0430\u043A\u0435\u0434\u043E\u043D\u0438\u0458\u0430" }, id: e.MacedonianNorthMacedonia, language: { code: t.Macedonian, name: "Macedonian", native: "\u041C\u0430\u043A\u0435\u0434\u043E\u043D\u0441\u043A\u0438" }, name: "Macedonian (North Macedonia)", native_name: "\u041C\u0430\u043A\u0435\u0434\u043E\u043D\u0441\u043A\u0438 (\u0421\u0435\u0432\u0435\u0440\u043D\u0430 \u041C\u0430\u043A\u0435\u0434\u043E\u043D\u0438\u0458\u0430)", rtl: false };
var _0 = { id: e.Malay, language: { code: t.Malay, name: "Malay", native: "Bahasa Melayu" }, name: "Malay", native_name: "Bahasa Melayu", rtl: false };
var E0 = { country: { code: r.Brunei, name: "Brunei", native: "Negara Brunei Darussalam" }, id: e.MalayBrunei, language: { code: t.Malay, name: "Malay", native: "Bahasa Melayu" }, name: "Malay (Brunei)", native_name: "Bahasa Melayu (Negara Brunei Darussalam)", rtl: false };
var S0 = { country: { code: r.Malaysia, name: "Malaysia", native: "Malaysia" }, id: e.MalayMalaysia, language: { code: t.Malay, name: "Malay", native: "Bahasa Melayu" }, name: "Malay (Malaysia)", native_name: "Bahasa Melayu (Malaysia)", rtl: false };
var T0 = { country: { code: r.Singapore, name: "Singapore", native: "Singapore" }, id: e.MalaySingapore, language: { code: t.Malay, name: "Malay", native: "Bahasa Melayu" }, name: "Malay (Singapore)", native_name: "Bahasa Melayu (Singapore)", rtl: false };
var p0 = { country: { code: r.India, name: "India", native: "\u092D\u093E\u0930\u0924" }, id: e.MalayIndia, language: { code: t.Malay, name: "Malay", native: "Bahasa Melayu" }, name: "Malay (India)", native_name: "Bahasa Melayu (\u092D\u093E\u0930\u0924)", rtl: false };
var b0 = { id: e.Maltese, language: { code: t.Maltese, name: "Maltese", native: "Malti" }, name: "Maltese", native_name: "Malti", rtl: false };
var v0 = { country: { code: r.Malta, name: "Malta", native: "Malta" }, id: e.MalteseMalta, language: { code: t.Maltese, name: "Maltese", native: "Malti" }, name: "Maltese (Malta)", native_name: "Malti (Malta)", rtl: false };
var B0 = { id: e.Maori, language: { code: t.Maori, name: "Maori", native: "M\u0101ori" }, name: "Maori", native_name: "M\u0101ori", rtl: false };
var N0 = { country: { code: r.NewZealand, name: "New Zealand", native: "New Zealand" }, id: e.MaoriNewZealand, language: { code: t.Maori, name: "Maori", native: "M\u0101ori" }, name: "Maori (New Zealand)", native_name: "M\u0101ori (New Zealand)", rtl: false };
var U0 = { id: e.Marathi, language: { code: t.Marathi, name: "Marathi", native: "\u092E\u0930\u093E\u0920\u0940" }, name: "Marathi", native_name: "\u092E\u0930\u093E\u0920\u0940", rtl: false };
var D0 = { country: { code: r.India, name: "India", native: "\u092D\u093E\u0930\u0924" }, id: e.MarathiIndia, language: { code: t.Marathi, name: "Marathi", native: "\u092E\u0930\u093E\u0920\u0940" }, name: "Marathi (India)", native_name: "\u092E\u0930\u093E\u0920\u0940 (\u092D\u093E\u0930\u0924)", rtl: false };
var P0 = { id: e.Mongolian, language: { code: t.Mongolian, name: "Mongolian", native: "\u041C\u043E\u043D\u0433\u043E\u043B" }, name: "Mongolian", native_name: "\u041C\u043E\u043D\u0433\u043E\u043B", rtl: false };
var k0 = { country: { code: r.Mongolia, name: "Mongolia", native: "\u041C\u043E\u043D\u0433\u043E\u043B \u0443\u043B\u0441" }, id: e.MongolianMongolia, language: { code: t.Mongolian, name: "Mongolian", native: "\u041C\u043E\u043D\u0433\u043E\u043B" }, name: "Mongolian (Mongolia)", native_name: "\u041C\u043E\u043D\u0433\u043E\u043B (\u041C\u043E\u043D\u0433\u043E\u043B \u0443\u043B\u0441)", rtl: false };
var M0 = { id: e.Montenegrin, language: { code: t.Montenegrin, name: "Montenegrin", native: "\u0426\u0440\u043D\u0430 \u0413\u043E\u0440\u0430\u043A" }, name: "Montenegrin", native_name: "\u0426\u0440\u043D\u0430 \u0413\u043E\u0440\u0430\u043A", rtl: false };
var y0 = { country: { code: r.Montenegro, name: "Montenegro", native: "\u0426\u0440\u043D\u0430 \u0413\u043E\u0440\u0430\u043A" }, id: e.MontenegrinMontenegro, language: { code: t.Montenegrin, name: "Montenegrin", native: "\u0426\u0440\u043D\u0430 \u0413\u043E\u0440\u0430\u043A" }, name: "Montenegrin (Montenegro)", native_name: "\u0426\u0440\u043D\u0430 \u0413\u043E\u0440\u0430\u043A (\u0426\u0440\u043D\u0430 \u0413\u043E\u0440\u0430\u043A)", rtl: false };
var F0 = { id: e.Nepali, language: { code: t.Nepali, name: "Nepali", native: "\u0928\u0947\u092A\u093E\u0932\u0940" }, name: "Nepali", native_name: "\u0928\u0947\u092A\u093E\u0932\u0940", rtl: false };
var L0 = { country: { code: r.Nepal, name: "Nepal", native: "\u0928\u0947\u092A\u093E\u0932" }, id: e.NepaliNepal, language: { code: t.Nepali, name: "Nepali", native: "\u0928\u0947\u092A\u093E\u0932\u0940" }, name: "Nepali (Nepal)", native_name: "\u0928\u0947\u092A\u093E\u0932\u0940 (\u0928\u0947\u092A\u093E\u0932)", rtl: false };
var q0 = { id: e.NorthernSotho, language: { code: t.NorthernSotho, name: "Northern Sotho", native: "Sesotho sa Leboa" }, name: "Northern Sotho", native_name: "Sesotho sa Leboa", rtl: false };
var G0 = { country: { code: r.SouthAfrica, name: "South Africa", native: "South Africa" }, id: e.NorthernSothoSouthAfrica, language: { code: t.NorthernSotho, name: "Northern Sotho", native: "Sesotho sa Leboa" }, name: "Northern Sotho (South Africa)", native_name: "Sesotho sa Leboa (South Africa)", rtl: false };
var w0 = { id: e.Norwegian, language: { code: t.Norwegian, name: "Norwegian", native: "Norsk" }, name: "Norwegian", native_name: "Norsk", rtl: false };
var K0 = { country: { code: r.Norway, name: "Norway", native: "Norge" }, id: e.NorwegianBokmalNorway, language: { code: t.NorwegianBokmal, name: "Norwegian", native: "Norsk" }, name: "Norwegian (Bokmal)", native_name: "Norsk (Bokm\xE5l)", rtl: false };
var x0 = { country: { code: r.Norway, name: "Norway", native: "Norge" }, id: e.NorwegianNynorskNorway, language: { code: t.NorwegianNynorsk, name: "Norwegian", native: "Norsk" }, name: "Norwegian (Nynorsk)", native_name: "Norsk (Nynorsk)", rtl: false };
var O0 = { id: e.Oriya, language: { code: t.Oriya, name: "Oriya", native: "\u0B13\u0B21\u0B3C\u0B3F\u0B06" }, name: "Oriya", native_name: "\u0B13\u0B21\u0B3C\u0B3F\u0B06", rtl: false };
var H0 = { country: { code: r.India, name: "India", native: "\u0B87\u0BA8\u0BCD\u0BA4\u0BBF\u0BAF\u0BBE" }, id: e.OriyaIndia, language: { code: t.Oriya, name: "Oriya", native: "\u0B13\u0B21\u0B3C\u0B3F\u0B06" }, name: "Oriya (India)", native_name: "\u0B13\u0B21\u0B3C\u0B3F\u0B06 (\u0B2D\u0B3E\u0B30\u0B24)", rtl: false };
var j0 = { id: e.Pashto, language: { code: t.Pashto, name: "Pashto", native: "\u067E\u069A\u062A\u0648" }, name: "Pashto", native_name: "\u067E\u069A\u062A\u0648", rtl: true };
var V0 = { country: { code: r.Afghanistan, name: "Afghanistan", native: "\u0627\u0641\u063A\u0627\u0646\u0633\u062A\u0627\u0646" }, id: e.PashtoAfghanistan, language: { code: t.Pashto, name: "Pashto", native: "\u067E\u069A\u062A\u0648" }, name: "Pashto (Afghanistan)", native_name: "\u067E\u069A\u062A\u0648 (\u0627\u0641\u063A\u0627\u0646\u0633\u062A\u0627\u0646)", rtl: true };
var z0 = { id: e.Persian, language: { code: t.Persian, name: "Persian", native: "\u0641\u0627\u0631\u0633\u06CC" }, name: "Persian", native_name: "\u0641\u0627\u0631\u0633\u06CC", rtl: true };
var W0 = { country: { code: r.Iran, name: "Iran", native: "\u0627\u06CC\u0631\u0627\u0646" }, id: e.PersianIran, language: { code: t.Persian, name: "Persian", native: "\u0641\u0627\u0631\u0633\u06CC" }, name: "Persian (Iran)", native_name: "\u0641\u0627\u0631\u0633\u06CC (\u0627\u06CC\u0631\u0627\u0646)", rtl: true };
var R0 = { id: e.Polish, language: { code: t.Polish, name: "Polish", native: "Polski" }, name: "Polish", native_name: "Polski", rtl: false };
var J0 = { country: { code: r.Poland, name: "Poland", native: "Polska" }, id: e.PolishPoland, language: { code: t.Polish, name: "Polish", native: "Polski" }, name: "Polish (Poland)", native_name: "Polski (Polska)", rtl: false };
var Z0 = { id: e.Portuguese, language: { code: t.Portuguese, name: "Portuguese", native: "Portugu\xEAs" }, name: "Portuguese", native_name: "Portugu\xEAs", rtl: false };
var Y0 = { country: { code: r.Brazil, name: "Brazil", native: "Brasil" }, id: e.PortugueseBrazil, language: { code: t.Portuguese, name: "Portuguese", native: "Portugu\xEAs" }, name: "Portuguese (Brazil)", native_name: "Portugu\xEAs (Brasil)", rtl: false };
var $0 = { country: { code: r.Portugal, name: "Portugal", native: "Portugal" }, id: e.PortuguesePortugal, language: { code: t.Portuguese, name: "Portuguese", native: "Portugu\xEAs" }, name: "Portuguese (Portugal)", native_name: "Portugu\xEAs (Portugal)", rtl: false };
var Q0 = { id: e.Punjabi, language: { code: t.Punjabi, name: "Punjabi", native: "\u0A2A\u0A70\u0A1C\u0A3E\u0A2C\u0A40" }, name: "Punjabi", native_name: "\u0A2A\u0A70\u0A1C\u0A3E\u0A2C\u0A40", rtl: true };
var X0 = { country: { code: r.Pakistan, name: "Pakistan", native: "\u067E\u0627\u06A9\u0633\u062A\u0627\u0646" }, id: e.PunjabiPakistan, language: { code: t.Punjabi, name: "Punjabi", native: "\u0A2A\u0A70\u0A1C\u0A3E\u0A2C\u0A40" }, name: "Punjabi (Pakistan)", native_name: "\u0A2A\u0A70\u0A1C\u0A3E\u0A2C\u0A40 (\u067E\u0627\u06A9\u0633\u062A\u0627\u0646)", rtl: true };
var C0 = { country: { code: r.India, name: "India", native: "\u0A2D\u0A3E\u0A30\u0A24" }, id: e.PunjabiIndia, language: { code: t.Punjabi, name: "Punjabi", native: "\u0A2A\u0A70\u0A1C\u0A3E\u0A2C\u0A40" }, name: "Punjabi (India)", native_name: "\u0A2A\u0A70\u0A1C\u0A3E\u0A2C\u0A40 (\u0A2D\u0A3E\u0A30\u0A24)", rtl: true };
var am = { id: e.Quechua, language: { code: t.Quechua, name: "Quechua", native: "Runa Simi" }, name: "Quechua", native_name: "Runa Simi", rtl: false };
var em = { country: { code: r.Bolivia, name: "Bolivia", native: "Bolivia" }, id: e.QuechuaBolivia, language: { code: t.Quechua, name: "Quechua", native: "Runa Simi" }, name: "Quechua (Bolivia)", native_name: "Runa Simi (Bolivia)", rtl: false };
var im = { country: { code: r.Ecuador, name: "Ecuador", native: "Ecuador" }, id: e.QuechuaEcuador, language: { code: t.Quechua, name: "Quechua", native: "Runa Simi" }, name: "Quechua (Ecuador)", native_name: "Runa Simi (Ecuador)", rtl: false };
var nm = { country: { code: r.Peru, name: "Peru", native: "Per\xFA" }, id: e.QuechuaPeru, language: { code: t.Quechua, name: "Quechua", native: "Runa Simi" }, name: "Quechua (Peru)", native_name: "Runa Simi (Per\xFA)", rtl: false };
var sm = { id: e.Romanian, language: { code: t.Romanian, name: "Romanian", native: "Rom\xE2n\u0103" }, name: "Romanian", native_name: "Rom\xE2n\u0103", rtl: false };
var um = { country: { code: r.Romania, name: "Romania", native: "Rom\xE2nia" }, id: e.RomanianRomania, language: { code: t.Romanian, name: "Romanian", native: "Rom\xE2n\u0103" }, name: "Romanian (Romania)", native_name: "Rom\xE2n\u0103 (Rom\xE2nia)", rtl: false };
var rm = { id: e.Russian, language: { code: t.Russian, name: "Russian", native: "\u0420\u0443\u0441\u0441\u043A\u0438\u0439" }, name: "Russian", native_name: "\u0420\u0443\u0441\u0441\u043A\u0438\u0439", rtl: false };
var tm = { country: { code: r.RussianFederation, name: "Russian Federation", native: "\u0420\u043E\u0441\u0441\u0438\u044F" }, id: e.RussianRussia, language: { code: t.Russian, name: "Russian", native: "\u0420\u0443\u0441\u0441\u043A\u0438\u0439" }, name: "Russian (Russia)", native_name: "\u0420\u0443\u0441\u0441\u043A\u0438\u0439 (\u0420\u043E\u0441\u0441\u0438\u044F)", rtl: false };
var lm = { country: { code: r.Ukraine, name: "Ukraine", native: "\u0423\u043A\u0440\u0430\u0457\u043D\u0430" }, id: e.RussianUkraine, language: { code: t.Russian, name: "Russian", native: "\u0420\u0443\u0441\u0441\u043A\u0438\u0439" }, name: "Russian (Ukraine)", native_name: "\u0420\u0443\u0441\u0441\u043A\u0438\u0439 (\u0423\u043A\u0440\u0430\u0457\u043D\u0430)", rtl: false };
var mm = { country: { code: r.Kazakhstan, name: "Kazakhstan", native: "\u049A\u0430\u0437\u0430\u049B\u0441\u0442\u0430\u043D" }, id: e.RussianKazakhstan, language: { code: t.Russian, name: "Russian", native: "\u0420\u0443\u0441\u0441\u043A\u0438\u0439" }, name: "Russian (Kazakhstan)", native_name: "\u0420\u0443\u0441\u0441\u043A\u0438\u0439 (\u049A\u0430\u0437\u0430\u049B\u0441\u0442\u0430\u043D)", rtl: false };
var om = { country: { code: r.Kyrgyzstan, name: "Kyrgyzstan", native: "\u041A\u044B\u0440\u0433\u044B\u0437\u0447\u0430" }, id: e.RussianKyrgyzstan, language: { code: t.Russian, name: "Russian", native: "\u0420\u0443\u0441\u0441\u043A\u0438\u0439" }, name: "Russian (Kyrgyzstan)", native_name: "\u0420\u0443\u0441\u0441\u043A\u0438\u0439 (\u041A\u044B\u0440\u0433\u044B\u0437\u0447\u0430)", rtl: false };
var cm = { id: e.Sanskrit, language: { code: t.Sanskrit, name: "Sanskrit", native: "\u0938\u0902\u0938\u094D\u0915\u0943\u0924\u092E\u094D" }, name: "Sanskrit", native_name: "\u0938\u0902\u0938\u094D\u0915\u0943\u0924\u092E\u094D", rtl: false };
var Am = { country: { code: r.India, name: "India", native: "\u092D\u093E\u0930\u0924" }, id: e.SanskritIndia, language: { code: t.Sanskrit, name: "Sanskrit", native: "\u0938\u0902\u0938\u094D\u0915\u0943\u0924\u092E\u094D" }, name: "Sanskrit (India)", native_name: "\u0938\u0902\u0938\u094D\u0915\u0943\u0924\u092E\u094D (\u092D\u093E\u0930\u0924)", rtl: false };
var dm = { id: e.Sami, language: { code: t.Sami, name: "Sami", native: "S\xE1megiella" }, name: "Sami", native_name: "S\xE1megiella", rtl: false };
var Im = { country: { code: r.Finland, name: "Finland", native: "Suomi" }, id: e.SamiFinland, language: { code: t.Sami, name: "Sami", native: "S\xE1megiella" }, name: "Sami (Finland)", native_name: "S\xE1megiella (Suomi)", rtl: false };
var hm = { country: { code: r.Norway, name: "Norway", native: "Norge" }, id: e.SamiNorway, language: { code: t.Sami, name: "Sami", native: "S\xE1megiella" }, name: "Sami (Norway)", native_name: "S\xE1megiella (Norge)", rtl: false };
var gm = { country: { code: r.Sweden, name: "Sweden", native: "Sverige" }, id: e.SamiSweden, language: { code: t.Sami, name: "Sami", native: "S\xE1megiella" }, name: "Sami (Sweden)", native_name: "S\xE1megiella (Sverige)", rtl: false };
var fm = { id: e.Samoan, language: { code: t.Samoan, name: "Samoan", native: "Gagana fa\u2019a S\u0101moa" }, name: "Samoan", native_name: "Gagana fa\u2019a S\u0101moa", rtl: false };
var _m = { country: { code: r.Samoa, name: "Samoa", native: "Samoa" }, id: e.SamoanSamoa, language: { code: t.Samoan, name: "Samoan", native: "Gagana fa\u2019a S\u0101moa" }, name: "Samoan (Samoa)", native_name: "Gagana fa\u2019a S\u0101moa (Samoa)", rtl: false };
var Em = { id: e.Serbian, language: { code: t.Serbian, name: "Serbian (Latin)", native: "Srpski (Latinica)" }, name: "Serbian (Latin)", native_name: "Srpski (Latinica)", rtl: false };
var Sm = { country: { code: r.BosniaAndHerzegovina, name: "Bosnia and Herzegovina", native: "Bosna i Hercegovina" }, id: e.SerbianBosniaAndHerzegovina, language: { code: t.Serbian, name: "Serbian (Latin)", native: "Srpski (Latinica)" }, name: "Serbian (Latin) (Bosnia and Herzegovina)", native_name: "Srpski (Latinica) (Bosna i Hercegovina)", rtl: false };
var Tm = { country: { code: r.SerbiaAndMontenegro, name: "Serbia and Montenegro", native: "Srbija i Crna Gora" }, id: e.SerbianSerbiaAndMontenegro, language: { code: t.Serbian, name: "Serbian (Latin)", native: "Srpski (Latinica)" }, name: "Serbian (Latin) (Serbia and Montenegro)", native_name: "Srpski (Latinica) (Srbija i Crna Gora)", rtl: false };
var pm = { id: e.SerbianCyrillic, language: { code: t.SerbianCyrillic, name: "Serbian", native: "\u0421\u0440\u043F\u0441\u043A\u0438" }, name: "Serbian (Cyrillic)", native_name: "\u0421\u0440\u043F\u0441\u043A\u0438 (\u040B\u0438\u0440\u0438\u043B\u0438\u0446\u0430)", rtl: false };
var bm = { country: { code: r.BosniaAndHerzegovina, name: "Bosnia and Herzegovina", native: "\u0411\u043E\u0441\u043D\u0430 \u0438 \u0425\u0435\u0440\u0446\u0435\u0433\u043E\u0432\u0438\u043D\u0430" }, id: e.SerbianCyrillicBosniaAndHerzegovina, language: { code: t.SerbianCyrillic, name: "Serbian", native: "\u0421\u0440\u043F\u0441\u043A\u0438" }, name: "Serbian (Cyrillic, Bosnia and Herzegovina)", native_name: "\u0421\u0440\u043F\u0441\u043A\u0438 (\u040B\u0438\u0440\u0438\u043B\u0438\u0446\u0430, \u0411\u043E\u0441\u043D\u0430 \u0438 \u0425\u0435\u0440\u0446\u0435\u0433\u043E\u0432\u0438\u043D\u0430)", rtl: false };
var vm = { country: { code: r.SerbiaAndMontenegro, name: "Serbia and Montenegro", native: "\u0421\u0440\u0431\u0438\u0458\u0430 \u0438 \u0426\u0440\u043D\u0430 \u0413\u043E\u0440\u0430" }, id: e.SerbianCyrillicSerbiaAndMontenegro, language: { code: t.SerbianCyrillic, name: "Serbian", native: "\u0421\u0440\u043F\u0441\u043A\u0438" }, name: "Serbian (Cyrillic, Serbia and Montenegro)", native_name: "\u0421\u0440\u043F\u0441\u043A\u0438 (\u040B\u0438\u0440\u0438\u043B\u0438\u0446\u0430, \u0421\u0440\u0431\u0438\u0458\u0430 \u0438 \u0426\u0440\u043D\u0430 \u0413\u043E\u0440\u0430)", rtl: false };
var Bm = { id: e.Slovak, language: { code: t.Slovak, name: "Slovak", native: "Sloven\u010Dina" }, name: "Slovak", native_name: "Sloven\u010Dina", rtl: false };
var Nm = { country: { code: r.Slovakia, name: "Slovakia", native: "Slovensko" }, id: e.SlovakSlovakia, language: { code: t.Slovak, name: "Slovak", native: "Sloven\u010Dina" }, name: "Slovak (Slovakia)", native_name: "Sloven\u010Dina (Slovensko)", rtl: false };
var Um = { id: e.Slovenian, language: { code: t.Slovenian, name: "Slovenian", native: "Sloven\u0161\u010Dina" }, name: "Slovenian", native_name: "Sloven\u0161\u010Dina", rtl: false };
var Dm = { country: { code: r.Slovenia, name: "Slovenia", native: "Slovenija" }, id: e.SlovenianSlovenia, language: { code: t.Slovenian, name: "Slovenian", native: "Sloven\u0161\u010Dina" }, name: "Slovenian (Slovenia)", native_name: "Sloven\u0161\u010Dina (Slovenija)", rtl: false };
var Pm = { id: e.Somali, language: { code: t.Somali, name: "Somali", native: "Soomaaliga" }, name: "Somali", native_name: "Soomaaliga", rtl: true };
var km = { country: { code: r.Somalia, name: "Somalia", native: "Soomaaliya" }, id: e.SomaliSomalia, language: { code: t.Somali, name: "Somali", native: "Soomaaliga" }, name: "Somali (Somalia)", native_name: "Soomaaliga (Soomaaliya)", rtl: true };
var Mm = { id: e.Spanish, language: { code: t.Spanish, name: "Spanish", native: "Espa\xF1ol" }, name: "Spanish", native_name: "Espa\xF1ol", rtl: false };
var ym = { country: { code: r.Argentina, name: "Argentina", native: "Argentina" }, id: e.SpanishArgentina, language: { code: t.Spanish, name: "Spanish", native: "Espa\xF1ol" }, name: "Spanish (Argentina)", native_name: "Espa\xF1ol (Argentina)", rtl: false };
var Fm = { country: { code: r.Bolivia, name: "Bolivia", native: "Bolivia" }, id: e.SpanishBolivia, language: { code: t.Spanish, name: "Spanish", native: "Espa\xF1ol" }, name: "Spanish (Bolivia)", native_name: "Espa\xF1ol (Bolivia)", rtl: false };
var Lm = { country: { code: r.Chile, name: "Chile", native: "Chile" }, id: e.SpanishChile, language: { code: t.Spanish, name: "Spanish", native: "Espa\xF1ol" }, name: "Spanish (Chile)", native_name: "Espa\xF1ol (Chile)", rtl: false };
var qm = { country: { code: r.Colombia, name: "Colombia", native: "Colombia" }, id: e.SpanishColombia, language: { code: t.Spanish, name: "Spanish", native: "Espa\xF1ol" }, name: "Spanish (Colombia)", native_name: "Espa\xF1ol (Colombia)", rtl: false };
var Gm = { country: { code: r.CostaRica, name: "Costa Rica", native: "Costa Rica" }, id: e.SpanishCostaRica, language: { code: t.Spanish, name: "Spanish", native: "Espa\xF1ol" }, name: "Spanish (Costa Rica)", native_name: "Espa\xF1ol (Costa Rica)", rtl: false };
var wm = { country: { code: r.Cuba, name: "Cuba", native: "Cuba" }, id: e.SpanishCuba, language: { code: t.Spanish, name: "Spanish", native: "Espa\xF1ol" }, name: "Spanish (Cuba)", native_name: "Espa\xF1ol (Cuba)", rtl: false };
var Km = { country: { code: r.DominicanRepublic, name: "Dominican Republic", native: "Rep\xFAblica Dominicana" }, id: e.SpanishDominicanRepublic, language: { code: t.Spanish, name: "Spanish", native: "Espa\xF1ol" }, name: "Spanish (Dominican Republic)", native_name: "Espa\xF1ol (Rep\xFAblica Dominicana)", rtl: false };
var xm = { country: { code: r.Ecuador, name: "Ecuador", native: "Ecuador" }, id: e.SpanishEcuador, language: { code: t.Spanish, name: "Spanish", native: "Espa\xF1ol" }, name: "Spanish (Ecuador)", native_name: "Espa\xF1ol (Ecuador)", rtl: false };
var Om = { country: { code: r.ElSalvador, name: "El Salvador", native: "El Salvador" }, id: e.SpanishElSalvador, language: { code: t.Spanish, name: "Spanish", native: "Espa\xF1ol" }, name: "Spanish (El Salvador)", native_name: "Espa\xF1ol (El Salvador)", rtl: false };
var Hm = { country: { code: r.EquatorialGuinea, name: "Equatorial Guinea", native: "Guinea Ecuatorial" }, id: e.SpanishEquatorialGuinea, language: { code: t.Spanish, name: "Spanish", native: "Espa\xF1ol" }, name: "Spanish (Equatorial Guinea)", native_name: "Espa\xF1ol (Guinea Ecuatorial)", rtl: false };
var jm = { country: { code: r.Guatemala, name: "Guatemala", native: "Guatemala" }, id: e.SpanishGuatemala, language: { code: t.Spanish, name: "Spanish", native: "Espa\xF1ol" }, name: "Spanish (Guatemala)", native_name: "Espa\xF1ol (Guatemala)", rtl: false };
var Vm = { country: { code: r.Honduras, name: "Honduras", native: "Honduras" }, id: e.SpanishHonduras, language: { code: t.Spanish, name: "Spanish", native: "Espa\xF1ol" }, name: "Spanish (Honduras)", native_name: "Espa\xF1ol (Honduras)", rtl: false };
var zm = { country: { code: r.Mexico, name: "Mexico", native: "M\xE9xico" }, id: e.SpanishMexico, language: { code: t.Spanish, name: "Spanish", native: "Espa\xF1ol" }, name: "Spanish (Mexico)", native_name: "Espa\xF1ol (M\xE9xico)", rtl: false };
var Wm = { country: { code: r.Nicaragua, name: "Nicaragua", native: "Nicaragua" }, id: e.SpanishNicaragua, language: { code: t.Spanish, name: "Spanish", native: "Espa\xF1ol" }, name: "Spanish (Nicaragua)", native_name: "Espa\xF1ol (Nicaragua)", rtl: false };
var Rm = { country: { code: r.Panama, name: "Panama", native: "Panam\xE1" }, id: e.SpanishPanama, language: { code: t.Spanish, name: "Spanish", native: "Espa\xF1ol" }, name: "Spanish (Panama)", native_name: "Espa\xF1ol (Panam\xE1)", rtl: false };
var Jm = { country: { code: r.Paraguay, name: "Paraguay", native: "Paraguay" }, id: e.SpanishParaguay, language: { code: t.Spanish, name: "Spanish", native: "Espa\xF1ol" }, name: "Spanish (Paraguay)", native_name: "Espa\xF1ol (Paraguay)", rtl: false };
var Zm = { country: { code: r.Peru, name: "Peru", native: "Per\xFA" }, id: e.SpanishPeru, language: { code: t.Spanish, name: "Spanish", native: "Espa\xF1ol" }, name: "Spanish (Peru)", native_name: "Espa\xF1ol (Per\xFA)", rtl: false };
var Ym = { country: { code: r.PuertoRico, name: "Puerto Rico", native: "Puerto Rico" }, id: e.SpanishPuertoRico, language: { code: t.Spanish, name: "Spanish", native: "Espa\xF1ol" }, name: "Spanish (Puerto Rico)", native_name: "Espa\xF1ol (Puerto Rico)", rtl: false };
var $m = { country: { code: r.Uruguay, name: "Uruguay", native: "Uruguay" }, id: e.SpanishUruguay, language: { code: t.Spanish, name: "Spanish", native: "Espa\xF1ol" }, name: "Spanish (Uruguay)", native_name: "Espa\xF1ol (Uruguay)", rtl: false };
var Qm = { country: { code: r.Venezuela, name: "Venezuela", native: "Venezuela" }, id: e.SpanishVenezuela, language: { code: t.Spanish, name: "Spanish", native: "Espa\xF1ol" }, name: "Spanish (Venezuela)", native_name: "Espa\xF1ol (Venezuela)", rtl: false };
var Xm = { country: { code: r.SouthAfrica, name: "South Africa", native: "South Africa" }, id: e.SutuSouthAfrica, language: { code: t.Sutu, name: "Sutu", native: "Sesotho" }, name: "Sutu (South Africa)", native_name: "Sesotho (Afrika Borwa)", rtl: false };
var Cm = { id: e.Swahili, language: { code: t.Swahili, name: "Swahili", native: "Kiswahili" }, name: "Swahili", native_name: "Kiswahili", rtl: false };
var ao = { country: { code: r.Kenya, name: "Kenya", native: "Kenya" }, id: e.SwahiliKenya, language: { code: t.Swahili, name: "Swahili", native: "Kiswahili" }, name: "Swahili (Kenya)", native_name: "Kiswahili (Kenya)", rtl: false };
var eo = { id: e.Swedish, language: { code: t.Swedish, name: "Swedish", native: "Svenska" }, name: "Swedish", native_name: "Svenska", rtl: false };
var io = { country: { code: r.Finland, name: "Finland", native: "Suomi" }, id: e.SwedishFinland, language: { code: t.Swedish, name: "Swedish", native: "Svenska" }, name: "Swedish (Finland)", native_name: "Svenska (Finland)", rtl: false };
var no = { country: { code: r.Sweden, name: "Sweden", native: "Sverige" }, id: e.SwedishSweden, language: { code: t.Swedish, name: "Swedish", native: "Svenska" }, name: "Swedish (Sweden)", native_name: "Svenska (Sverige)", rtl: false };
var so = { id: e.Syriac, language: { code: t.Syriac, name: "Syriac", native: "\u0723\u0718\u072A\u071D\u071D\u0710" }, name: "Syriac", native_name: "\u0723\u0718\u072A\u071D\u071D\u0710", rtl: true };
var uo = { country: { code: r.Syria, name: "Syria", native: "\u0633\u0648\u0631\u064A\u0627" }, id: e.SyriacSyria, language: { code: t.Syriac, name: "Syriac", native: "\u0723\u0718\u072A\u071D\u071D\u0710" }, name: "Syriac (Syria)", native_name: "\u0723\u0718\u072A\u071D\u071D\u0710 (\u0633\u0648\u0631\u064A\u0627)", rtl: true };
var ro = { id: e.Tajik, language: { code: t.Tajik, name: "Tajik", native: "\u0422\u043E\u04B7\u0438\u043A\u04E3" }, name: "Tajik", native_name: "\u0422\u043E\u04B7\u0438\u043A\u04E3", rtl: false };
var to = { country: { code: r.Tajikistan, name: "Tajikistan", native: "\u0422\u043E\u04B7\u0438\u043A\u0438\u0441\u0442\u043E\u043D" }, id: e.TajikTajikistan, language: { code: t.Tajik, name: "Tajik", native: "\u0422\u043E\u04B7\u0438\u043A\u04E3" }, name: "Tajik (Tajikistan)", native_name: "\u0422\u043E\u04B7\u0438\u043A\u04E3 (\u0422\u043E\u04B7\u0438\u043A\u0438\u0441\u0442\u043E\u043D)", rtl: false };
var lo = { id: e.Tagalog, language: { code: t.Tagalog, name: "Tagalog", native: "Tagalog" }, name: "Tagalog", native_name: "Tagalog", rtl: false };
var mo = { country: { code: r.Philippines, name: "Philippines", native: "Pilipinas" }, id: e.TagalogPhilippines, language: { code: t.Tagalog, name: "Tagalog", native: "Tagalog" }, name: "Tagalog (Philippines)", native_name: "Tagalog (Pilipinas)", rtl: false };
var oo = { id: e.Tamil, language: { code: t.Tamil, name: "Tamil", native: "\u0BA4\u0BAE\u0BBF\u0BB4\u0BCD" }, name: "Tamil", native_name: "\u0BA4\u0BAE\u0BBF\u0BB4\u0BCD", rtl: false };
var co = { country: { code: r.India, name: "India", native: "\u0B87\u0BA8\u0BCD\u0BA4\u0BBF\u0BAF\u0BBE" }, id: e.TamilIndia, language: { code: t.Tamil, name: "Tamil", native: "\u0BA4\u0BAE\u0BBF\u0BB4\u0BCD" }, name: "Tamil (India)", native_name: "\u0BA4\u0BAE\u0BBF\u0BB4\u0BCD (\u0B87\u0BA8\u0BCD\u0BA4\u0BBF\u0BAF\u0BBE)", rtl: false };
var Ao = { id: e.Telugu, language: { code: t.Telugu, name: "Telugu", native: "\u0C24\u0C46\u0C32\u0C41\u0C17\u0C41" }, name: "Telugu", native_name: "\u0C24\u0C46\u0C32\u0C41\u0C17\u0C41", rtl: false };
var Io = { country: { code: r.India, name: "India", native: "\u0C2D\u0C3E\u0C30\u0C24\u0C26\u0C47\u0C36\u0C02" }, id: e.TeluguIndia, language: { code: t.Telugu, name: "Telugu", native: "\u0C24\u0C46\u0C32\u0C41\u0C17\u0C41" }, name: "Telugu (India)", native_name: "\u0C24\u0C46\u0C32\u0C41\u0C17\u0C41 (\u0C2D\u0C3E\u0C30\u0C24\u0C26\u0C47\u0C36\u0C02)", rtl: false };
var ho = { id: e.Thai, language: { code: t.Thai, name: "Thai", native: "\u0E44\u0E17\u0E22" }, name: "Thai", native_name: "\u0E44\u0E17\u0E22", rtl: false };
var go = { country: { code: r.Thailand, name: "Thailand", native: "\u0E1B\u0E23\u0E30\u0E40\u0E17\u0E28\u0E44\u0E17\u0E22" }, id: e.ThaiThailand, language: { code: t.Thai, name: "Thai", native: "\u0E44\u0E17\u0E22" }, name: "Thai (Thailand)", native_name: "\u0E44\u0E17\u0E22 (\u0E1B\u0E23\u0E30\u0E40\u0E17\u0E28\u0E44\u0E17\u0E22)", rtl: false };
var fo = { id: e.Tibetan, language: { code: t.Tibetan, name: "Tibetan", native: "\u0F56\u0F7C\u0F51\u0F0B\u0F61\u0F72\u0F42" }, name: "Tibetan", native_name: "\u0F56\u0F7C\u0F51\u0F0B\u0F61\u0F72\u0F42", rtl: false };
var _o = { country: { code: r.China, name: "China", native: "\u4E2D\u56FD" }, id: e.TibetanChina, language: { code: t.Tibetan, name: "Tibetan", native: "\u0F56\u0F7C\u0F51\u0F0B\u0F61\u0F72\u0F42" }, name: "Tibetan (China)", native_name: "\u0F56\u0F7C\u0F51\u0F0B\u0F61\u0F72\u0F42 (\u0F62\u0F92\u0FB1\u0F0B\u0F53\u0F42)", rtl: false };
var Eo = { country: { code: r.Bhutan, name: "Bhutan", native: "\u0F60\u0F56\u0FB2\u0F74\u0F42\u0F0B\u0F61\u0F74\u0F63\u0F0B\u0F66\u0FA4\u0FB1\u0F72\u0F0B\u0F63\u0F7A\u0F53\u0F4C\u0F0D" }, id: e.TibetanBhutan, language: { code: t.Tibetan, name: "Tibetan", native: "\u0F56\u0F7C\u0F51\u0F0B\u0F61\u0F72\u0F42" }, name: "Tibetan (Bhutan)", native_name: "\u0F56\u0F7C\u0F51\u0F0B\u0F61\u0F72\u0F42 (\u0F60\u0F56\u0FB2\u0F74\u0F42\u0F0B\u0F61\u0F74\u0F63\u0F0B\u0F66\u0FA4\u0FB1\u0F72\u0F0B\u0F63\u0F7A\u0F53\u0F4C\u0F0D)", rtl: false };
var So = { country: { code: r.India, name: "India", native: "\u0B87\u0BA8\u0BCD\u0BA4\u0BBF\u0BAF\u0BBE" }, id: e.TibetanIndia, language: { code: t.Tibetan, name: "Tibetan", native: "\u0F56\u0F7C\u0F51\u0F0B\u0F61\u0F72\u0F42" }, name: "Tibetan (India)", native_name: "\u0F56\u0F7C\u0F51\u0F0B\u0F61\u0F72\u0F42 (\u0B87\u0BA8\u0BCD\u0BA4\u0BBF\u0BAF\u0BBE)", rtl: false };
var To = { id: e.Tsonga, language: { code: t.Tsonga, name: "Tsonga", native: "Xitsonga" }, name: "Tsonga", native_name: "Xitsonga", rtl: false };
var po = { id: e.Tswana, language: { code: t.Tswana, name: "Tswana", native: "Setswana" }, name: "Tswana", native_name: "Setswana", rtl: false };
var bo = { country: { code: r.SouthAfrica, name: "South Africa", native: "South Africa" }, id: e.TswanaSouthAfrica, language: { code: t.Tswana, name: "Tswana", native: "Setswana" }, name: "Tswana (South Africa)", native_name: "Setswana (South Africa)", rtl: false };
var vo = { id: e.Turkish, language: { code: t.Turkish, name: "Turkish", native: "T\xFCrk\xE7e" }, name: "Turkish", native_name: "T\xFCrk\xE7e", rtl: false };
var Bo = { country: { code: r.Turkey, name: "Turkey", native: "T\xFCrkiye" }, id: e.TurkishTurkey, language: { code: t.Turkish, name: "Turkish", native: "T\xFCrk\xE7e" }, name: "Turkish (Turkey)", native_name: "T\xFCrk\xE7e (T\xFCrkiye)", rtl: false };
var No = { id: e.Ukrainian, language: { code: t.Ukrainian, name: "Ukrainian", native: "\u0423\u043A\u0440\u0430\u0457\u043D\u0441\u044C\u043A\u0430" }, name: "Ukrainian", native_name: "\u0423\u043A\u0440\u0430\u0457\u043D\u0441\u044C\u043A\u0430", rtl: false };
var Uo = { country: { code: r.Ukraine, name: "Ukraine", native: "\u0423\u043A\u0440\u0430\u0457\u043D\u0430" }, id: e.UkrainianUkraine, language: { code: t.Ukrainian, name: "Ukrainian", native: "\u0423\u043A\u0440\u0430\u0457\u043D\u0441\u044C\u043A\u0430" }, name: "Ukrainian (Ukraine)", native_name: "\u0423\u043A\u0440\u0430\u0457\u043D\u0441\u044C\u043A\u0430 (\u0423\u043A\u0440\u0430\u0457\u043D\u0430)", rtl: false };
var Do = { id: e.Urdu, language: { code: t.Urdu, name: "Urdu", native: "\u0627\u0631\u062F\u0648" }, name: "Urdu", native_name: "\u0627\u0631\u062F\u0648", rtl: true };
var Po = { country: { code: r.Afghanistan, name: "Afghanistan", native: "\u0627\u0641\u063A\u0627\u0646\u0633\u062A\u0627\u0646" }, id: e.UrduAfghanistan, language: { code: t.Urdu, name: "Urdu", native: "\u0627\u0631\u062F\u0648" }, name: "Urdu (Afghanistan)", native_name: "\u0627\u0631\u062F\u0648 (\u0627\u0641\u063A\u0627\u0646\u0633\u062A\u0627\u0646)", rtl: true };
var ko = { country: { code: r.India, name: "India", native: "\u092D\u093E\u0930\u0924" }, id: e.UrduIndia, language: { code: t.Urdu, name: "Urdu", native: "\u0627\u0631\u062F\u0648" }, name: "Urdu (India)", native_name: "\u0627\u0631\u062F\u0648 (\u092D\u093E\u0930\u0924)", rtl: true };
var Mo = { country: { code: r.Pakistan, name: "Pakistan", native: "\u067E\u0627\u06A9\u0633\u062A\u0627\u0646" }, id: e.UrduPakistan, language: { code: t.Urdu, name: "Urdu", native: "\u0627\u0631\u062F\u0648" }, name: "Urdu (Pakistan)", native_name: "\u0627\u0631\u062F\u0648 (\u067E\u0627\u06A9\u0633\u062A\u0627\u0646)", rtl: true };
var yo = { id: e.Uzbek, language: { code: t.Uzbek, name: "Uzbek", native: "O\u02BBzbekcha" }, name: "Uzbek", native_name: "O\u02BBzbekcha", rtl: false };
var Fo = { country: { code: r.Uzbekistan, name: "Uzbekistan", native: "O\u02BBzbekiston" }, id: e.UzbekUzbekistan, language: { code: t.Uzbek, name: "Uzbek", native: "O\u02BBzbekcha" }, name: "Uzbek (Latin, Uzbekistan)", native_name: "O\u02BBzbekcha (O\u02BBzbekiston)", rtl: false };
var Lo = { country: { code: r.Uzbekistan, name: "Uzbekistan", native: "\u040E\u0437\u0431\u0435\u043A\u0438\u0441\u0442\u043E\u043D" }, id: e.UzbekCyrillic, language: { code: t.Uzbek, name: "Uzbek", native: "\u040E\u0437\u0431\u0435\u043A\u0438\u0441\u0442\u043E\u043D" }, name: "Uzbek (Cyrillic)", native_name: "\u040E\u0437\u0431\u0435\u043A\u0438\u0441\u0442\u043E\u043D (\u040E\u0437\u0431\u0435\u043A\u0438\u0441\u0442\u043E\u043D)", rtl: false };
var qo = { id: e.Vietnamese, language: { code: t.Vietnamese, name: "Vietnamese", native: "Ti\u1EBFng Vi\u1EC7t" }, name: "Vietnamese", native_name: "Ti\u1EBFng Vi\u1EC7t", rtl: false };
var Go = { country: { code: r.Vietnam, name: "Vietnam", native: "Vi\u1EC7t Nam" }, id: e.VietnameseVietnam, language: { code: t.Vietnamese, name: "Vietnamese", native: "Ti\u1EBFng Vi\u1EC7t" }, name: "Vietnamese (Vietnam)", native_name: "Ti\u1EBFng Vi\u1EC7t (Vi\u1EC7t Nam)", rtl: false };
var wo = { id: e.Welsh, language: { code: t.Welsh, name: "Welsh", native: "Cymraeg" }, name: "Welsh", native_name: "Cymraeg", rtl: false };
var Ko = { country: { code: r.UnitedKingdom, name: "United Kingdom", native: "United Kingdom" }, id: e.WelshUnitedKingdom, language: { code: t.Welsh, name: "Welsh", native: "Cymraeg" }, name: "Welsh (United Kingdom)", native_name: "Cymraeg (United Kingdom)", rtl: false };
var xo = { id: e.Xhosa, language: { code: t.Xhosa, name: "Xhosa", native: "isiXhosa" }, name: "Xhosa", native_name: "isiXhosa", rtl: false };
var Oo = { country: { code: r.SouthAfrica, name: "South Africa", native: "South Africa" }, id: e.XhosaSouthAfrica, language: { code: t.Xhosa, name: "Xhosa", native: "isiXhosa" }, name: "Xhosa (South Africa)", native_name: "isiXhosa (South Africa)", rtl: false };
var Ho = { id: e.Yiddish, language: { code: t.Yiddish, name: "Yiddish", native: "\u05D9\u05D9\u05B4\u05D3\u05D9\u05E9" }, name: "Yiddish", native_name: "\u05D9\u05D9\u05B4\u05D3\u05D9\u05E9", rtl: false };
var jo = { id: e.Yoruba, language: { code: t.Yoruba, name: "Yoruba", native: "Yor\xF9b\xE1" }, name: "Yoruba", native_name: "Yor\xF9b\xE1", rtl: false };
var Vo = { country: { code: r.Nigeria, name: "Nigeria", native: "Nigeria" }, id: e.YorubaNigeria, language: { code: t.Yoruba, name: "Yoruba", native: "Yor\xF9b\xE1" }, name: "Yoruba (Nigeria)", native_name: "Yor\xF9b\xE1 (Nigeria)", rtl: false };
var zo = { id: e.Zulu, language: { code: t.Zulu, name: "Zulu", native: "isiZulu" }, name: "Zulu", native_name: "isiZulu", rtl: false };
var Wo = { country: { code: r.SouthAfrica, name: "South Africa", native: "South Africa" }, id: e.ZuluSouthAfrica, language: { code: t.Zulu, name: "Zulu", native: "isiZulu" }, name: "Zulu (South Africa)", native_name: "isiZulu (South Africa)", rtl: false };
var Ro = { id: u.AfricaAbidjan, name: "Africa/Abidjan", offset: n.UTC_0, timezone: s.CoordinatedUniversalTime };
var Jo = { id: u.AfricaAccra, name: "Africa/Accra", offset: n.UTC_0, timezone: s.CoordinatedUniversalTime };
var Zo = { id: u.AfricaAddisAbaba, name: "Africa/Addis_Ababa", offset: n.UTC_PLUS_3, timezone: s.EastAfricaTime };
var Yo = { id: u.AfricaAlgiers, name: "Africa/Algiers", offset: n.UTC_PLUS_1, timezone: s.CentralEuropeanTime };
var $o = { id: u.AfricaAsmara, name: "Africa/Asmara", offset: n.UTC_PLUS_3, timezone: s.EastAfricaTime };
var Qo = { id: u.AfricaBamako, name: "Africa/Bamako", offset: n.UTC_0, timezone: s.CoordinatedUniversalTime };
var Xo = { id: u.AfricaBangui, name: "Africa/Bangui", offset: n.UTC_PLUS_1, timezone: s.WestAfricaTime };
var Co = { id: u.AfricaBanjul, name: "Africa/Banjul", offset: n.UTC_0, timezone: s.CoordinatedUniversalTime };
var ac = { id: u.AfricaBissau, name: "Africa/Bissau", offset: n.UTC_0, timezone: s.CoordinatedUniversalTime };
var ec = { id: u.AfricaBlantyre, name: "Africa/Blantyre", offset: n.UTC_PLUS_2, timezone: s.CentralAfricaTime };
var ic = { id: u.AfricaBrazzaville, name: "Africa/Brazzaville", offset: n.UTC_PLUS_1, timezone: s.WestAfricaTime };
var nc = { id: u.AfricaBujumbura, name: "Africa/Bujumbura", offset: n.UTC_PLUS_2, timezone: s.CentralAfricaTime };
var sc = { id: u.AfricaCairo, name: "Africa/Cairo", offset: n.UTC_PLUS_2, timezone: s.EasternEuropeanTime };
var uc = { id: u.AfricaCasablanca, name: "Africa/Casablanca", offset: n.UTC_PLUS_1, timezone: s.WesternEuropeanTime };
var rc = { id: u.AfricaCeuta, name: "Africa/Ceuta", offset: n.UTC_PLUS_1, timezone: s.CentralEuropeanTime };
var tc = { id: u.AfricaConakry, name: "Africa/Conakry", offset: n.UTC_0, timezone: s.CoordinatedUniversalTime };
var lc = { id: u.AfricaDakar, name: "Africa/Dakar", offset: n.UTC_0, timezone: s.CoordinatedUniversalTime };
var mc = { id: u.AfricaDarEsSalaam, name: "Africa/Dar_es_Salaam", offset: n.UTC_PLUS_3, timezone: s.EastAfricaTime };
var oc = { id: u.AfricaDjibouti, name: "Africa/Djibouti", offset: n.UTC_PLUS_3, timezone: s.EastAfricaTime };
var cc = { id: u.AfricaDouala, name: "Africa/Douala", offset: n.UTC_PLUS_1, timezone: s.WestAfricaTime };
var Ac = { id: u.AfricaElAaiun, name: "Africa/El_Aaiun", offset: n.UTC_PLUS_1, timezone: s.WestAfricaTime };
var dc = { id: u.AfricaFreetown, name: "Africa/Freetown", offset: n.UTC_0, timezone: s.CoordinatedUniversalTime };
var Ic = { id: u.AfricaGaborone, name: "Africa/Gaborone", offset: n.UTC_PLUS_2, timezone: s.CentralAfricaTime };
var hc = { id: u.AfricaHarare, name: "Africa/Harare", offset: n.UTC_PLUS_2, timezone: s.CentralAfricaTime };
var gc = { id: u.AfricaJohannesburg, name: "Africa/Johannesburg", offset: n.UTC_PLUS_2, timezone: s.SouthAfricanStandardTime };
var fc = { id: u.AfricaJuba, name: "Africa/Juba", offset: n.UTC_PLUS_3, timezone: s.EastAfricaTime };
var _c = { id: u.AfricaKampala, name: "Africa/Kampala", offset: n.UTC_PLUS_3, timezone: s.EastAfricaTime };
var Ec = { id: u.AfricaKhartoum, name: "Africa/Khartoum", offset: n.UTC_PLUS_2, timezone: s.EastAfricaTime };
var Sc = { id: u.AfricaKigali, name: "Africa/Kigali", offset: n.UTC_PLUS_2, timezone: s.CentralAfricaTime };
var Tc = { id: u.AfricaKinshasa, name: "Africa/Kinshasa", offset: n.UTC_PLUS_1, timezone: s.WestAfricaTime };
var pc = { id: u.AfricaLagos, name: "Africa/Lagos", offset: n.UTC_PLUS_1, timezone: s.WestAfricaTime };
var bc = { id: u.AfricaLibreville, name: "Africa/Libreville", offset: n.UTC_PLUS_1, timezone: s.WestAfricaTime };
var vc = { id: u.AfricaLome, name: "Africa/Lome", offset: n.UTC_0, timezone: s.CoordinatedUniversalTime };
var Bc = { id: u.AfricaLuanda, name: "Africa/Luanda", offset: n.UTC_PLUS_1, timezone: s.WestAfricaTime };
var Nc = { id: u.AfricaLubumbashi, name: "Africa/Lubumbashi", offset: n.UTC_PLUS_2, timezone: s.CentralAfricaTime };
var Uc = { id: u.AfricaLusaka, name: "Africa/Lusaka", offset: n.UTC_PLUS_2, timezone: s.CentralAfricaTime };
var Dc = { id: u.AfricaMalabo, name: "Africa/Malabo", offset: n.UTC_PLUS_1, timezone: s.WestAfricaTime };
var Pc = { id: u.AfricaMaputo, name: "Africa/Maputo", offset: n.UTC_PLUS_2, timezone: s.CentralAfricaTime };
var kc = { id: u.AfricaMaseru, name: "Africa/Maseru", offset: n.UTC_PLUS_2, timezone: s.SouthAfricanStandardTime };
var Mc = { id: u.AfricaMbabane, name: "Africa/Mbabane", offset: n.UTC_PLUS_2, timezone: s.SouthAfricanStandardTime };
var yc = { id: u.AfricaMogadishu, name: "Africa/Mogadishu", offset: n.UTC_PLUS_3, timezone: s.EastAfricaTime };
var Fc = { id: u.AfricaMonrovia, name: "Africa/Monrovia", offset: n.UTC_0, timezone: s.CoordinatedUniversalTime };
var Lc = { id: u.AfricaNairobi, name: "Africa/Nairobi", offset: n.UTC_PLUS_3, timezone: s.EastAfricaTime };
var qc = { id: u.AfricaNdjamena, name: "Africa/Ndjamena", offset: n.UTC_PLUS_1, timezone: s.WestAfricaTime };
var Gc = { id: u.AfricaNiamey, name: "Africa/Niamey", offset: n.UTC_PLUS_1, timezone: s.WestAfricaTime };
var wc = { id: u.AfricaNouakchott, name: "Africa/Nouakchott", offset: n.UTC_0, timezone: s.GreenwichMeanTime };
var Kc = { id: u.AfricaOuagadougou, name: "Africa/Ouagadougou", offset: n.UTC_0, timezone: s.CoordinatedUniversalTime };
var xc = { id: u.AfricaPortoNovo, name: "Africa/Porto-Novo", offset: n.UTC_PLUS_1, timezone: s.WestAfricaTime };
var Oc = { id: u.AfricaSaoTome, name: "Africa/SaoTome", offset: n.UTC_0, timezone: s.CoordinatedUniversalTime };
var Hc = { id: u.AfricaTripoli, name: "Africa/Tripoli", offset: n.UTC_0, timezone: s.CoordinatedUniversalTime };
var jc = { id: u.AfricaTunis, name: "Africa/Tunis", offset: n.UTC_0, timezone: s.CoordinatedUniversalTime };
var Vc = { id: u.AfricaWindhoek, name: "Africa/Windhoek", offset: n.UTC_PLUS_2, timezone: s.WestAfricaTime };
var zc = { id: u.AmericaAdak, name: "America/Adak", offset: n.UTC_PLUS_10, timezone: s.HawaiiAleutianStandardTime };
var Wc = { id: u.AmericaAnchorage, name: "America/Anchorage", offset: n.UTC_PLUS_9, timezone: s.AlaskaStandardTime };
var Rc = { id: u.AmericaAnguilla, name: "America/Anguilla", offset: n.UTC_0, timezone: s.AtlanticStandardTime };
var Jc = { id: u.AmericaAntigua, name: "America/Antigua", offset: n.UTC_0, timezone: s.AtlanticStandardTime };
var Zc = { id: u.AmericaAraguaina, name: "America/Araguaina", offset: n.UTC_MINUS_3, timezone: s.BrasiliaTime };
var Yc = { id: u.AmericaArgentinaBuenosAires, name: "America/Argentina/Buenos_Aires", offset: n.UTC_MINUS_3, timezone: s.ArgentinaTime };
var $c = { id: u.AmericaArgentinaCatamarca, name: "America/Argentina/Catamarca", offset: n.UTC_MINUS_3, timezone: s.ArgentinaTime };
var Qc = { id: u.AmericaArgentinaCordoba, name: "America/Argentina/Cordoba", offset: n.UTC_MINUS_3, timezone: s.ArgentinaTime };
var Xc = { id: u.AmericaArgentinaJujuy, name: "America/Argentina/Jujuy", offset: n.UTC_MINUS_3, timezone: s.ArgentinaTime };
var Cc = { id: u.AmericaArgentinaLaRioja, name: "America/Argentina/La_Rioja", offset: n.UTC_MINUS_3, timezone: s.ArgentinaTime };
var aA = { id: u.AmericaArgentinaMendoza, name: "America/Argentina/Mendoza", offset: n.UTC_MINUS_3, timezone: s.ArgentinaTime };
var eA = { id: u.AmericaArgentinaRioGallegos, name: "America/Argentina/Rio_Gallegos", offset: n.UTC_MINUS_3, timezone: s.ArgentinaTime };
var iA = { id: u.AmericaArgentinaSalta, name: "America/Argentina/Salta", offset: n.UTC_MINUS_3, timezone: s.ArgentinaTime };
var nA = { id: u.AmericaArgentinaSanJuan, name: "America/Argentina/San_Juan", offset: n.UTC_MINUS_3, timezone: s.ArgentinaTime };
var sA = { id: u.AmericaArgentinaSanLuis, name: "America/Argentina/San_Luis", offset: n.UTC_MINUS_3, timezone: s.ArgentinaTime };
var uA = { id: u.AmericaArgentinaTucuman, name: "America/Argentina/Tucuman", offset: n.UTC_MINUS_3, timezone: s.ArgentinaTime };
var rA = { id: u.AmericaArgentinaUshuaia, name: "America/Argentina/Ushuaia", offset: n.UTC_MINUS_3, timezone: s.ArgentinaTime };
var tA = { id: u.AmericaAruba, name: "America/Aruba", offset: n.UTC_0, timezone: s.AtlanticStandardTime };
var lA = { id: u.AmericaAsuncion, name: "America/Asuncion", offset: n.UTC_MINUS_4, timezone: s.ParaguayTime };
var mA = { id: u.AmericaAtikokan, name: "America/Atikokan", offset: n.UTC_0, timezone: s.EasternStandardTime };
var oA = { id: u.AmericaAtka, name: "America/Atka", offset: n.UTC_MINUS_10, timezone: s.HawaiiAleutianStandardTime };
var cA = { id: u.AmericaBahia, name: "America/Bahia", offset: n.UTC_MINUS_3, timezone: s.BrasiliaTime };
var AA = { id: u.AmericaBahiaBanderas, name: "America/Bahia_Banderas", offset: n.UTC_MINUS_6, timezone: s.CentralStandardTime };
var dA = { id: u.AmericaBarbados, name: "America/Barbados", offset: n.UTC_MINUS_4, timezone: s.AtlanticStandardTime };
var IA = { id: u.AmericaBelem, name: "America/Belem", offset: n.UTC_MINUS_3, timezone: s.BrasiliaTime };
var hA = { id: u.AmericaBelize, name: "America/Belize", offset: n.UTC_MINUS_6, timezone: s.CentralStandardTime };
var gA = { id: u.AmericaBlancSablon, name: "America/Blanc-Sablon", offset: n.UTC_MINUS_4, timezone: s.AtlanticStandardTime };
var fA = { id: u.AmericaBoaVista, name: "America/Boa_Vista", offset: n.UTC_MINUS_4, timezone: s.AmazonTime };
var _A = { id: u.AmericaBogota, name: "America/Bogota", offset: n.UTC_MINUS_5, timezone: s.ColombiaTime };
var EA = { id: u.AmericaBoise, name: "America/Boise", offset: n.UTC_MINUS_7, timezone: s.MountainStandardTime };
var SA = { id: u.AmericaCambridgeBay, name: "America/Cambridge_Bay", offset: n.UTC_MINUS_7, timezone: s.MountainStandardTime };
var TA = { id: u.AmericaCampoGrande, name: "America/Campo_Grande", offset: n.UTC_MINUS_4, timezone: s.AmazonTime };
var pA = { id: u.AmericaCancun, name: "America/Cancun", offset: n.UTC_MINUS_5, timezone: s.EasternStandardTime };
var bA = { id: u.AmericaCaracas, name: "America/Caracas", offset: n.UTC_MINUS_4, timezone: s.VenezuelaStandardTime };
var vA = { id: u.AmericaCayenne, name: "America/Cayenne", offset: n.UTC_MINUS_3, timezone: s.FrenchGuianaTime };
var BA = { id: u.AmericaCayman, name: "America/Cayman", offset: n.UTC_0, timezone: s.AtlanticStandardTime };
var NA = { id: u.AmericaChicago, name: "America/Chicago", offset: n.UTC_MINUS_6, timezone: s.CentralStandardTime };
var UA = { id: u.AmericaChihuahua, name: "America/Chihuahua", offset: n.UTC_MINUS_7, timezone: s.MountainStandardTime };
var DA = { id: u.AmericaCoralHarbour, name: "America/Coral_Harbour", offset: n.UTC_MINUS_5, timezone: s.EasternStandardTime };
var PA = { id: u.AmericaCordoba, name: "America/Cordoba", offset: n.UTC_MINUS_3, timezone: s.ArgentinaTime };
var kA = { id: u.AmericaCostaRica, name: "America/Costa_Rica", offset: n.UTC_MINUS_6, timezone: s.CentralStandardTime };
var MA = { id: u.AmericaCreston, name: "America/Creston", offset: n.UTC_MINUS_7, timezone: s.MountainStandardTime };
var yA = { id: u.AmericaCuiaba, name: "America/Cuiaba", offset: n.UTC_MINUS_4, timezone: s.AmazonTime };
var FA = { id: u.AmericaCuracao, name: "America/Curacao", offset: n.UTC_MINUS_4, timezone: s.AtlanticStandardTime };
var LA = { id: u.AmericaDanmarkshavn, name: "America/Danmarkshavn", offset: n.UTC_0, timezone: s.GreenwichMeanTime };
var qA = { id: u.AmericaDawson, name: "America/Dawson", offset: n.UTC_MINUS_8, timezone: s.PacificStandardTime };
var GA = { id: u.AmericaDawsonCreek, name: "America/Dawson_Creek", offset: n.UTC_MINUS_8, timezone: s.PacificStandardTime };
var wA = { id: u.AmericaDenver, name: "America/Denver", offset: n.UTC_MINUS_7, timezone: s.MountainStandardTime };
var KA = { id: u.AmericaDetroit, name: "America/Detroit", offset: n.UTC_MINUS_5, timezone: s.EasternStandardTime };
var xA = { id: u.AmericaDominica, name: "America/Dominica", offset: n.UTC_0, timezone: s.AtlanticStandardTime };
var OA = { id: u.AmericaEdmonton, name: "America/Edmonton", offset: n.UTC_MINUS_7, timezone: s.MountainStandardTime };
var HA = { id: u.AmericaEirunepe, name: "America/Eirunepe", offset: n.UTC_MINUS_5, timezone: s.AcreTime };
var jA = { id: u.AmericaElSalvador, name: "America/El_Salvador", offset: n.UTC_MINUS_6, timezone: s.CentralStandardTime };
var VA = { id: u.AmericaFortaleza, name: "America/Fortaleza", offset: n.UTC_MINUS_3, timezone: s.BrasiliaTime };
var zA = { id: u.AmericaGlaceBay, name: "America/Glace_Bay", offset: n.UTC_0, timezone: s.AtlanticStandardTime };
var WA = { id: u.AmericaGodthab, name: "America/Godthab", offset: n.UTC_MINUS_3, timezone: s.WestGreenlandTime };
var RA = { id: u.AmericaGooseBay, name: "America/Goose_Bay", offset: n.UTC_0, timezone: s.AtlanticStandardTime };
var JA = { id: u.AmericaGrandTurk, name: "America/Grand_Turk", offset: n.UTC_0, timezone: s.AtlanticStandardTime };
var ZA = { id: u.AmericaGrenada, name: "America/Grenada", offset: n.UTC_0, timezone: s.AtlanticStandardTime };
var YA = { id: u.AmericaGuadeloupe, name: "America/Guadeloupe", offset: n.UTC_0, timezone: s.AtlanticStandardTime };
var $A = { id: u.AmericaGuatemala, name: "America/Guatemala", offset: n.UTC_MINUS_6, timezone: s.CentralStandardTime };
var QA = { id: u.AmericaGuayaquil, name: "America/Guayaquil", offset: n.UTC_MINUS_5, timezone: s.EcuadorTime };
var XA = { id: u.AmericaGuyana, name: "America/Guyana", offset: n.UTC_0, timezone: s.AtlanticStandardTime };
var CA = { id: u.AmericaHalifax, name: "America/Halifax", offset: n.UTC_0, timezone: s.AtlanticStandardTime };
var ad = { id: u.AmericaHavana, name: "America/Havana", offset: n.UTC_MINUS_5, timezone: s.CubaStandardTime };
var ed = { id: u.AmericaHermosillo, name: "America/Hermosillo", offset: n.UTC_MINUS_7, timezone: s.MountainStandardTime };
var id = { id: u.AmericaIndianaIndianapolis, name: "America/Indiana/Indianapolis", offset: n.UTC_MINUS_5, timezone: s.EasternStandardTime };
var nd = { id: u.AmericaIndianaKnox, name: "America/Indiana/Knox", offset: n.UTC_MINUS_6, timezone: s.CentralStandardTime };
var sd = { id: u.AmericaIndianaMarengo, name: "America/Indiana/Marengo", offset: n.UTC_MINUS_5, timezone: s.EasternStandardTime };
var ud = { id: u.AmericaIndianaPetersburg, name: "America/Indiana/Petersburg", offset: n.UTC_MINUS_5, timezone: s.EasternStandardTime };
var rd = { id: u.AmericaIndianaTellCity, name: "America/Indiana/Tell_City", offset: n.UTC_MINUS_6, timezone: s.CentralStandardTime };
var td = { id: u.AmericaIndianaVevay, name: "America/Indiana/Vevay", offset: n.UTC_MINUS_5, timezone: s.EasternStandardTime };
var ld = { id: u.AmericaIndianaVincennes, name: "America/Indiana/Vincennes", offset: n.UTC_MINUS_5, timezone: s.EasternStandardTime };
var md = { id: u.AmericaIndianaWinamac, name: "America/Indiana/Winamac", offset: n.UTC_MINUS_5, timezone: s.EasternStandardTime };
var od = { id: u.AmericaInuvik, name: "America/Inuvik", offset: n.UTC_MINUS_7, timezone: s.MountainStandardTime };
var cd = { id: u.AmericaIqaluit, name: "America/Iqaluit", offset: n.UTC_0, timezone: s.EasternStandardTime };
var Ad = { id: u.AmericaJamaica, name: "America/Jamaica", offset: n.UTC_MINUS_4, timezone: s.AtlanticStandardTime };
var dd = { id: u.AmericaJuneau, name: "America/Juneau", offset: n.UTC_MINUS_9, timezone: s.AlaskaStandardTime };
var Id = { id: u.AmericaKentuckyLouisville, name: "America/Kentucky/Louisville", offset: n.UTC_MINUS_5, timezone: s.EasternStandardTime };
var hd = { id: u.AmericaKentuckyMonticello, name: "America/Kentucky/Monticello", offset: n.UTC_MINUS_5, timezone: s.EasternStandardTime };
var gd = { id: u.AmericaKralendijk, name: "America/Kralendijk", offset: n.UTC_MINUS_4, timezone: s.AtlanticStandardTime };
var fd = { id: u.AmericaLaPaz, name: "America/La_Paz", offset: n.UTC_MINUS_4, timezone: s.BoliviaTime };
var _d = { id: u.AmericaLima, name: "America/Lima", offset: n.UTC_MINUS_5, timezone: s.PeruTime };
var Ed = { id: u.AmericaLosAngeles, name: "America/Los_Angeles", offset: n.UTC_MINUS_8, timezone: s.PacificStandardTime };
var Sd = { id: u.AmericaLouisville, name: "America/Louisville", offset: n.UTC_MINUS_5, timezone: s.EasternStandardTime };
var Td = { id: u.AmericaLowerPrinces, name: "America/Lower_Princes", offset: n.UTC_MINUS_4, timezone: s.AtlanticStandardTime };
var pd = { id: u.AmericaMaceio, name: "America/Maceio", offset: n.UTC_MINUS_3, timezone: s.BrasiliaTime };
var bd = { id: u.AmericaManagua, name: "America/Managua", offset: n.UTC_MINUS_6, timezone: s.CentralStandardTime };
var vd = { id: u.AmericaManaus, name: "America/Manaus", offset: n.UTC_MINUS_4, timezone: s.AmazonTime };
var Bd = { id: u.AmericaMarigot, name: "America/Marigot", offset: n.UTC_MINUS_4, timezone: s.AtlanticStandardTime };
var Nd = { id: u.AmericaMartinique, name: "America/Martinique", offset: n.UTC_MINUS_4, timezone: s.AtlanticStandardTime };
var Ud = { id: u.AmericaMatamoros, name: "America/Matamoros", offset: n.UTC_MINUS_6, timezone: s.CentralStandardTime };
var Dd = { id: u.AmericaMazatlan, name: "America/Mazatlan", offset: n.UTC_MINUS_7, timezone: s.MountainStandardTime };
var Pd = { id: u.AmericaMenominee, name: "America/Menominee", offset: n.UTC_MINUS_5, timezone: s.CentralStandardTime };
var kd = { id: u.AmericaMerida, name: "America/Merida", offset: n.UTC_MINUS_6, timezone: s.CentralStandardTime };
var Md = { id: u.AmericaMetlakatla, name: "America/Metlakatla", offset: n.UTC_MINUS_9, timezone: s.AlaskaStandardTime };
var yd = { id: u.AmericaMexicoCity, name: "America/Mexico_City", offset: n.UTC_MINUS_6, timezone: s.CentralStandardTime };
var Fd = { id: u.AmericaMiquelon, name: "America/Miquelon", offset: n.UTC_MINUS_3, timezone: s.SaintPierreAndMiquelonStandardTime };
var Ld = { id: u.AmericaMoncton, name: "America/Moncton", offset: n.UTC_MINUS_4, timezone: s.AtlanticStandardTime };
var qd = { id: u.AmericaMonterrey, name: "America/Monterrey", offset: n.UTC_MINUS_6, timezone: s.CentralStandardTime };
var Gd = { id: u.AmericaMontevideo, name: "America/Montevideo", offset: n.UTC_MINUS_3, timezone: s.UruguayStandardTime };
var wd = { id: u.AmericaMontreal, name: "America/Montreal", offset: n.UTC_MINUS_5, timezone: s.EasternStandardTime };
var Kd = { id: u.AmericaMontserrat, name: "America/Montserrat", offset: n.UTC_MINUS_4, timezone: s.AtlanticStandardTime };
var xd = { id: u.AmericaNassau, name: "America/Nassau", offset: n.UTC_MINUS_5, timezone: s.EasternStandardTime };
var Od = { id: u.AmericaNewYork, name: "America/New_York", offset: n.UTC_MINUS_5, timezone: s.EasternStandardTime };
var Hd = { id: u.AmericaNipigon, name: "America/Nipigon", offset: n.UTC_MINUS_5, timezone: s.EasternStandardTime };
var jd = { id: u.AmericaNome, name: "America/Nome", offset: n.UTC_MINUS_9, timezone: s.AlaskaStandardTime };
var Vd = { id: u.AmericaNoronha, name: "America/Noronha", offset: n.UTC_MINUS_2, timezone: s.FernandoDeNoronhaTime };
var zd = { id: u.AmericaNorthDakotaBeulah, name: "America/North_Dakota/Beulah", offset: n.UTC_MINUS_6, timezone: s.CentralStandardTime };
var Wd = { id: u.AmericaNorthDakotaCenter, name: "America/North_Dakota/Center", offset: n.UTC_MINUS_6, timezone: s.CentralStandardTime };
var Rd = { id: u.AmericaNorthDakotaNewSalem, name: "America/North_Dakota/New_Salem", offset: n.UTC_MINUS_6, timezone: s.CentralStandardTime };
var Jd = { id: u.AmericaOjinaga, name: "America/Ojinaga", offset: n.UTC_MINUS_7, timezone: s.MountainStandardTime };
var Zd = { id: u.AmericaPanama, name: "America/Panama", offset: n.UTC_MINUS_5, timezone: s.EasternStandardTime };
var Yd = { id: u.AmericaPangnirtung, name: "America/Pangnirtung", offset: n.UTC_MINUS_5, timezone: s.EasternStandardTime };
var $d = { id: u.AmericaParamaribo, name: "America/Paramaribo", offset: n.UTC_MINUS_3, timezone: s.SurinameTime };
var Qd = { id: u.AmericaPhoenix, name: "America/Phoenix", offset: n.UTC_MINUS_7, timezone: s.MountainStandardTime };
var Xd = { id: u.AmericaPortAuPrince, name: "America/Port-au-Prince", offset: n.UTC_MINUS_5, timezone: s.EasternStandardTime };
var Cd = { id: u.AmericaPortOfSpain, name: "America/Port_of_Spain", offset: n.UTC_MINUS_4, timezone: s.AtlanticStandardTime };
var aI = { id: u.AmericaPortoVelho, name: "America/Porto_Velho", offset: n.UTC_MINUS_4, timezone: s.AmazonTime };
var eI = { id: u.AmericaPuertoRico, name: "America/Puerto_Rico", offset: n.UTC_MINUS_4, timezone: s.AtlanticStandardTime };
var iI = { id: u.AmericaRainyRiver, name: "America/Rainy_River", offset: n.UTC_MINUS_6, timezone: s.CentralStandardTime };
var nI = { id: u.AmericaRankinInlet, name: "America/Rankin_Inlet", offset: n.UTC_MINUS_6, timezone: s.CentralStandardTime };
var sI = { id: u.AmericaRecife, name: "America/Recife", offset: n.UTC_MINUS_3, timezone: s.BrasiliaTime };
var uI = { id: u.AmericaRegina, name: "America/Regina", offset: n.UTC_MINUS_6, timezone: s.CentralStandardTime };
var rI = { id: u.AmericaResolute, name: "America/Resolute", offset: n.UTC_MINUS_6, timezone: s.CentralStandardTime };
var tI = { id: u.AmericaRioBranco, name: "America/Rio_Branco", offset: n.UTC_MINUS_5, timezone: s.AcreTime };
var lI = { id: u.AmericaSantaIsabel, name: "America/Santa_Isabel", offset: n.UTC_MINUS_8, timezone: s.PacificStandardTime };
var mI = { id: u.AmericaSantarem, name: "America/Santarem", offset: n.UTC_MINUS_3, timezone: s.BrasiliaTime };
var oI = { id: u.AmericaSantiago, name: "America/Santiago", offset: n.UTC_MINUS_4, timezone: s.ChileStandardTime };
var cI = { id: u.AmericaSantoDomingo, name: "America/Santo_Domingo", offset: n.UTC_MINUS_4, timezone: s.AtlanticStandardTime };
var AI = { id: u.AmericaSaoPaulo, name: "America/Sao_Paulo", offset: n.UTC_MINUS_3, timezone: s.BrasiliaTime };
var dI = { id: u.AmericaScoresbysund, name: "America/Scoresbysund", offset: n.UTC_MINUS_1, timezone: s.EasternGreenlandTime };
var II = { id: u.AmericaShiprock, name: "America/Shiprock", offset: n.UTC_MINUS_7, timezone: s.MountainStandardTime };
var hI = { id: u.AmericaSitka, name: "America/Sitka", offset: n.UTC_MINUS_9, timezone: s.AlaskaStandardTime };
var gI = { id: u.AmericaStBarthelemy, name: "America/St_Barthelemy", offset: n.UTC_MINUS_4, timezone: s.AtlanticStandardTime };
var fI = { id: u.AmericaStJohns, name: "America/St_Johns", offset: n.UTC_MINUS_3, timezone: s.NewfoundlandStandardTime };
var _I = { id: u.AmericaStKitts, name: "America/St_Kitts", offset: n.UTC_MINUS_4, timezone: s.AtlanticStandardTime };
var EI = { id: u.AmericaStLucia, name: "America/St_Lucia", offset: n.UTC_MINUS_4, timezone: s.AtlanticStandardTime };
var SI = { id: u.AmericaStThomas, name: "America/St_Thomas", offset: n.UTC_MINUS_4, timezone: s.AtlanticStandardTime };
var TI = { id: u.AmericaStVincent, name: "America/St_Vincent", offset: n.UTC_MINUS_4, timezone: s.AtlanticStandardTime };
var pI = { id: u.AmericaSwiftCurrent, name: "America/Swift_Current", offset: n.UTC_MINUS_6, timezone: s.CentralStandardTime };
var bI = { id: u.AmericaTegucigalpa, name: "America/Tegucigalpa", offset: n.UTC_MINUS_6, timezone: s.CentralStandardTime };
var vI = { id: u.AmericaThule, name: "America/Thule", offset: n.UTC_MINUS_4, timezone: s.AtlanticStandardTime };
var BI = { id: u.AmericaThunderBay, name: "America/Thunder_Bay", offset: n.UTC_MINUS_4, timezone: s.EasternStandardTime };
var NI = { id: u.AmericaTijuana, name: "America/Tijuana", offset: n.UTC_MINUS_8, timezone: s.PacificStandardTime };
var UI = { id: u.AmericaToronto, name: "America/Toronto", offset: n.UTC_MINUS_5, timezone: s.EasternStandardTime };
var DI = { id: u.AmericaTortola, name: "America/Tortola", offset: n.UTC_MINUS_4, timezone: s.AtlanticStandardTime };
var PI = { id: u.AmericaVancouver, name: "America/Vancouver", offset: n.UTC_MINUS_8, timezone: s.PacificStandardTime };
var kI = { id: u.AmericaWhitehorse, name: "America/Whitehorse", offset: n.UTC_MINUS_8, timezone: s.PacificStandardTime };
var MI = { id: u.AmericaWinnipeg, name: "America/Winnipeg", offset: n.UTC_MINUS_6, timezone: s.CentralStandardTime };
var yI = { id: u.AmericaYakutat, name: "America/Yakutat", offset: n.UTC_MINUS_9, timezone: s.AlaskaStandardTime };
var FI = { id: u.AmericaYellowknife, name: "America/Yellowknife", offset: n.UTC_MINUS_6, timezone: s.MountainStandardTime };
var LI = { id: u.AntarcticaCasey, name: "Antarctica/Casey", offset: n.UTC_MINUS_8, timezone: s.WesternStandardTime };
var qI = { id: u.AntarcticaDavis, name: "Antarctica/Davis", offset: n.UTC_MINUS_7, timezone: s.NewfoundlandStandardTime };
var GI = { id: u.AntarcticaDumontDUrville, name: "Antarctica/DumontDUrville", offset: n.UTC_MINUS_10, timezone: s.CentralStandardTime };
var wI = { id: u.AntarcticaMacquarie, name: "Antarctica/Macquarie", offset: n.UTC_MINUS_11, timezone: s.CentralStandardTime };
var KI = { id: u.AntarcticaMawson, name: "Antarctica/Mawson", offset: n.UTC_MINUS_6, timezone: s.CentralStandardTime };
var xI = { id: u.AntarcticaMcMurdo, name: "Antarctica/McMurdo", offset: n.UTC_MINUS_12, timezone: s.NewZealandStandardTime };
var OI = { id: u.AntarcticaPalmer, name: "Antarctica/Palmer", offset: n.UTC_MINUS_4, timezone: s.ChathamStandardTime };
var HI = { id: u.AntarcticaRothera, name: "Antarctica/Rothera", offset: n.UTC_MINUS_3, timezone: s.RotheraResearchStationTime };
var jI = { id: u.AntarcticaSyowa, name: "Antarctica/Syowa", offset: n.UTC_MINUS_3, timezone: s.ShowaStationTime };
var VI = { id: u.AntarcticaTroll, name: "Antarctica/Troll", offset: n.UTC_MINUS_2, timezone: s.CentralStandardTime };
var zI = { id: u.AntarcticaVostok, name: "Antarctica/Vostok", offset: n.UTC_MINUS_6, timezone: s.CentralStandardTime };
var WI = { id: u.ArcticLongyearbyen, name: "Arctic/Longyearbyen", offset: n.UTC_MINUS_1, timezone: s.CentralEuropeanTime };
var RI = { id: u.AsiaAden, name: "Asia/Aden", offset: n.UTC_PLUS_3, timezone: s.ArabiaStandardTime };
var JI = { id: u.AsiaAlmaty, name: "Asia/Almaty", offset: n.UTC_PLUS_6, timezone: s.AlmaAtaTime };
var ZI = { id: u.AsiaAmman, name: "Asia/Amman", offset: n.UTC_PLUS_2, timezone: s.EasternEuropeanTime };
var YI = { id: u.AsiaAnadyr, name: "Asia/Anadyr", offset: n.UTC_PLUS_12, timezone: s.NewCaledoniaTime };
var $I = { id: u.AsiaAqtau, name: "Asia/Aqtau", offset: n.UTC_PLUS_5, timezone: s.AqtobeTime };
var QI = { id: u.AsiaAqtobe, name: "Asia/Aqtobe", offset: n.UTC_PLUS_5, timezone: s.AqtobeTime };
var XI = { id: u.AsiaAshgabat, name: "Asia/Ashgabat", offset: n.UTC_PLUS_5, timezone: s.TurkmenistanTime };
var CI = { id: u.AsiaBaghdad, name: "Asia/Baghdad", offset: n.UTC_PLUS_3, timezone: s.ArabiaStandardTime };
var ah = { id: u.AsiaBahrain, name: "Asia/Bahrain", offset: n.UTC_PLUS_3, timezone: s.ArabiaStandardTime };
var eh = { id: u.AsiaBaku, name: "Asia/Baku", offset: n.UTC_PLUS_4, timezone: s.AzerbaijanTime };
var ih = { id: u.AsiaBangkok, name: "Asia/Bangkok", offset: n.UTC_PLUS_7, timezone: s.IndochinaTime };
var nh = { id: u.AsiaBarnaul, name: "Asia/Barnaul", offset: n.UTC_PLUS_7, timezone: s.KrasnoyarskTime };
var sh = { id: u.AsiaBeirut, name: "Asia/Beirut", offset: n.UTC_PLUS_2, timezone: s.EasternEuropeanTime };
var uh = { id: u.AsiaBishkek, name: "Asia/Bishkek", offset: n.UTC_PLUS_6, timezone: s.KyrgyzstanTime };
var rh = { id: u.AsiaBrunei, name: "Asia/Brunei", offset: n.UTC_PLUS_8, timezone: s.BruneiTime };
var th = { id: u.AsiaChita, name: "Asia/Chita", offset: n.UTC_PLUS_9, timezone: s.YakutskTime };
var lh = { id: u.AsiaChoibalsan, name: "Asia/Choibalsan", offset: n.UTC_PLUS_8, timezone: s.ChoibalsanStandardTime };
var mh = { id: u.AsiaColombo, name: "Asia/Colombo", offset: n.UTC_PLUS_5, timezone: s.IndianStandardTime };
var oh = { id: u.AsiaDamascus, name: "Asia/Damascus", offset: n.UTC_PLUS_2, timezone: s.EasternEuropeanTime };
var ch = { id: u.AsiaDhaka, name: "Asia/Dhaka", offset: n.UTC_PLUS_6, timezone: s.BangladeshStandardTime };
var Ah = { id: u.AsiaDili, name: "Asia/Dili", offset: n.UTC_PLUS_9, timezone: s.JapanStandardTime };
var dh = { id: u.AsiaDubai, name: "Asia/Dubai", offset: n.UTC_PLUS_4, timezone: s.GulfStandardTime };
var Ih = { id: u.AsiaDushanbe, name: "Asia/Dushanbe", offset: n.UTC_PLUS_5, timezone: s.TajikistanTime };
var hh = { id: u.AsiaFamagusta, name: "Asia/Famagusta", offset: n.UTC_PLUS_2, timezone: s.EasternEuropeanTime };
var gh = { id: u.AsiaGaza, name: "Asia/Gaza", offset: n.UTC_PLUS_2, timezone: s.EasternEuropeanTime };
var fh = { id: u.AsiaHebron, name: "Asia/Hebron", offset: n.UTC_PLUS_2, timezone: s.EasternEuropeanTime };
var _h = { id: u.AsiaHoChiMinh, name: "Asia/Ho_Chi_Minh", offset: n.UTC_PLUS_7, timezone: s.IndochinaTime };
var Eh = { id: u.AsiaHongKong, name: "Asia/Hong_Kong", offset: n.UTC_PLUS_8, timezone: s.HongKongTime };
var Sh = { id: u.AsiaHovd, name: "Asia/Hovd", offset: n.UTC_PLUS_7, timezone: s.HovdTime };
var Th = { id: u.AsiaIrkutsk, name: "Asia/Irkutsk", offset: n.UTC_PLUS_8, timezone: s.IrkutskTime };
var ph = { id: u.AsiaJakarta, name: "Asia/Jakarta", offset: n.UTC_PLUS_7, timezone: s.WesternIndonesianTime };
var bh = { id: u.AsiaJayapura, name: "Asia/Jayapura", offset: n.UTC_PLUS_9, timezone: s.JapanStandardTime };
var vh = { id: u.AsiaJerusalem, name: "Asia/Jerusalem", offset: n.UTC_PLUS_2, timezone: s.EasternEuropeanTime };
var Bh = { id: u.AsiaKabul, name: "Asia/Kabul", offset: n.UTC_PLUS_4, timezone: s.AfghanistanTime };
var Nh = { id: u.AsiaKamchatka, name: "Asia/Kamchatka", offset: n.UTC_PLUS_12, timezone: s.KamchatkaTime };
var Uh = { id: u.AsiaKarachi, name: "Asia/Karachi", offset: n.UTC_PLUS_5, timezone: s.PakistanStandardTime };
var Dh = { id: u.AsiaKathmandu, name: "Asia/Kathmandu", offset: n.UTC_PLUS_5, timezone: s.NepalTime };
var Ph = { id: u.AsiaKhandyga, name: "Asia/Khandyga", offset: n.UTC_PLUS_9, timezone: s.YakutskTime };
var kh = { id: u.AsiaKolkata, name: "Asia/Kolkata", offset: n.UTC_PLUS_5, timezone: s.IndianStandardTime };
var Mh = { id: u.AsiaKrasnoyarsk, name: "Asia/Krasnoyarsk", offset: n.UTC_PLUS_7, timezone: s.KrasnoyarskTime };
var yh = { id: u.AsiaKualaLumpur, name: "Asia/Kuala_Lumpur", offset: n.UTC_PLUS_8, timezone: s.MalaysiaStandardTime };
var Fh = { id: u.AsiaKuching, name: "Asia/Kuching", offset: n.UTC_PLUS_8, timezone: s.MalaysiaStandardTime };
var Lh = { id: u.AsiaKuwait, name: "Asia/Kuwait", offset: n.UTC_PLUS_3, timezone: s.ArabiaStandardTime };
var qh = { id: u.AsiaMacau, name: "Asia/Macau", offset: n.UTC_PLUS_8, timezone: s.ChinaStandardTime };
var Gh = { id: u.AsiaMagadan, name: "Asia/Magadan", offset: n.UTC_PLUS_11, timezone: s.MagadanTime };
var wh = { id: u.AsiaMakassar, name: "Asia/Makassar", offset: n.UTC_PLUS_8, timezone: s.MalaysiaTime };
var Kh = { id: u.AsiaManila, name: "Asia/Manila", offset: n.UTC_PLUS_8, timezone: s.PhilippineTime };
var xh = { id: u.AsiaMuscat, name: "Asia/Muscat", offset: n.UTC_PLUS_4, timezone: s.GulfStandardTime };
var Oh = { id: u.AsiaNovokuznetsk, name: "Asia/Novokuznetsk", offset: n.UTC_PLUS_6, timezone: s.NovosibirskTime };
var Hh = { id: u.AsiaNovosibirsk, name: "Asia/Novosibirsk", offset: n.UTC_PLUS_6, timezone: s.NovosibirskTime };
var jh = { id: u.AsiaOmsk, name: "Asia/Omsk", offset: n.UTC_PLUS_6, timezone: s.OmskTime };
var Vh = { id: u.AsiaOral, name: "Asia/Oral", offset: n.UTC_PLUS_5, timezone: s.OralTime };
var zh = { id: u.AsiaPhnomPenh, name: "Asia/Phnom_Penh", offset: n.UTC_PLUS_7, timezone: s.IndochinaTime };
var Wh = { id: u.AsiaPontianak, name: "Asia/Pontianak", offset: n.UTC_PLUS_7, timezone: s.WesternIndonesianTime };
var Rh = { id: u.AsiaPyongyang, name: "Asia/Pyongyang", offset: n.UTC_PLUS_9, timezone: s.KoreaStandardTime };
var Jh = { id: u.AsiaQatar, name: "Asia/Qatar", offset: n.UTC_PLUS_3, timezone: s.ArabiaStandardTime };
var Zh = { id: u.AsiaQyzylorda, name: "Asia/Qyzylorda", offset: n.UTC_PLUS_5, timezone: s.WestKazakhstanTime };
var Yh = { id: u.AsiaRangoon, name: "Asia/Rangoon", offset: n.UTC_PLUS_6, timezone: s.MyanmarStandardTime };
var $h = { id: u.AsiaRiyadh, name: "Asia/Riyadh", offset: n.UTC_PLUS_3, timezone: s.ArabiaStandardTime };
var Qh = { id: u.AsiaSakhalin, name: "Asia/Sakhalin", offset: n.UTC_PLUS_11, timezone: s.SakhalinIslandTime };
var Xh = { id: u.AsiaSamarkand, name: "Asia/Samarkand", offset: n.UTC_PLUS_5, timezone: s.UzbekistanTime };
var Ch = { id: u.AsiaSeoul, name: "Asia/Seoul", offset: n.UTC_PLUS_9, timezone: s.KoreaStandardTime };
var ag = { id: u.AsiaShanghai, name: "Asia/Shanghai", offset: n.UTC_PLUS_8, timezone: s.ChinaStandardTime };
var eg = { id: u.AsiaSingapore, name: "Asia/Singapore", offset: n.UTC_PLUS_8, timezone: s.SingaporeStandardTime };
var ig = { id: u.AsiaSrednekolymsk, name: "Asia/Srednekolymsk", offset: n.UTC_PLUS_11, timezone: s.SrednekolymskTime };
var ng = { id: u.AsiaTaipei, name: "Asia/Taipei", offset: n.UTC_PLUS_8, timezone: s.ChinaStandardTime };
var sg = { id: u.AsiaTashkent, name: "Asia/Tashkent", offset: n.UTC_PLUS_5, timezone: s.UzbekistanTime };
var ug = { id: u.AsiaTbilisi, name: "Asia/Tbilisi", offset: n.UTC_PLUS_4, timezone: s.GeorgiaStandardTime };
var rg = { id: u.AsiaTehran, name: "Asia/Tehran", offset: n.UTC_PLUS_3, timezone: s.IranStandardTime };
var tg = { id: u.AsiaThimphu, name: "Asia/Thimphu", offset: n.UTC_PLUS_6, timezone: s.BhutanTime };
var lg = { id: u.AsiaTokyo, name: "Asia/Tokyo", offset: n.UTC_PLUS_9, timezone: s.JapanStandardTime };
var mg = { id: u.AsiaTomsk, name: "Asia/Tomsk", offset: n.UTC_PLUS_6, timezone: s.KrasnoyarskTime };
var og = { id: u.AsiaUlaanbaatar, name: "Asia/Ulaanbaatar", offset: n.UTC_PLUS_8, timezone: s.UlaanbaatarStandardTime };
var cg = { id: u.AsiaUrumqi, name: "Asia/Urumqi", offset: n.UTC_PLUS_8, timezone: s.ChinaStandardTime };
var Ag = { id: u.AsiaUstNera, name: "Asia/Ust-Nera", offset: n.UTC_PLUS_10, timezone: s.VladivostokTime };
var dg = { id: u.AsiaVientiane, name: "Asia/Vientiane", offset: n.UTC_PLUS_7, timezone: s.IndochinaTime };
var Ig = { id: u.AsiaVladivostok, name: "Asia/Vladivostok", offset: n.UTC_PLUS_10, timezone: s.VladivostokTime };
var hg = { id: u.AsiaYakutsk, name: "Asia/Yakutsk", offset: n.UTC_PLUS_9, timezone: s.YakutskTime };
var gg = { id: u.AsiaYekaterinburg, name: "Asia/Yekaterinburg", offset: n.UTC_PLUS_5, timezone: s.YekaterinburgTime };
var fg = { id: u.AsiaYerevan, name: "Asia/Yerevan", offset: n.UTC_PLUS_4, timezone: s.ArmeniaTime };
var _g = { id: u.AtlanticAzores, name: "Atlantic/Azores", offset: n.UTC_MINUS_1, timezone: s.AzoresStandardTime };
var Eg = { id: u.AtlanticBermuda, name: "Atlantic/Bermuda", offset: n.UTC_MINUS_4, timezone: s.AtlanticStandardTime };
var Sg = { id: u.AtlanticCanary, name: "Atlantic/Canary", offset: n.UTC_MINUS_1, timezone: s.WesternEuropeanTime };
var Tg = { id: u.AtlanticCapeVerde, name: "Atlantic/Cape_Verde", offset: n.UTC_0, timezone: s.CapeVerdeTime };
var pg = { id: u.AtlanticFaroe, name: "Atlantic/Faroe", offset: n.UTC_0, timezone: s.GreenwichMeanTime };
var bg = { id: u.AtlanticMadeira, name: "Atlantic/Madeira", offset: n.UTC_0, timezone: s.WesternEuropeanTime };
var vg = { id: u.AtlanticReykjavik, name: "Atlantic/Reykjavik", offset: n.UTC_0, timezone: s.GreenwichMeanTime };
var Bg = { id: u.AtlanticSouthGeorgia, name: "Atlantic/South_Georgia", offset: n.UTC_0, timezone: s.CoordinatedUniversalTime };
var Ng = { id: u.AtlanticStHelena, name: "Atlantic/St_Helena", offset: n.UTC_0, timezone: s.GreenwichMeanTime };
var Ug = { id: u.AtlanticStanley, name: "Atlantic/Stanley", offset: n.UTC_0, timezone: s.FalklandIslandsTime };
var Dg = { id: u.AustraliaAdelaide, name: "Australia/Adelaide", offset: n.UTC_PLUS_9_30, timezone: s.AustralianCentralStandardTime };
var Pg = { id: u.AustraliaBrisbane, name: "Australia/Brisbane", offset: n.UTC_PLUS_10, timezone: s.AustralianEasternStandardTime };
var kg = { id: u.AustraliaBrokenHill, name: "Australia/Broken_Hill", offset: n.UTC_PLUS_9_30, timezone: s.AustralianCentralStandardTime };
var Mg = { id: u.AustraliaCanberra, name: "Australia/Canberra", offset: n.UTC_PLUS_10, timezone: s.AustralianEasternStandardTime };
var yg = { id: u.AustraliaCurrie, name: "Australia/Currie", offset: n.UTC_PLUS_10, timezone: s.AustralianEasternStandardTime };
var Fg = { id: u.AustraliaDarwin, name: "Australia/Darwin", offset: n.UTC_PLUS_9_30, timezone: s.AustralianCentralStandardTime };
var Lg = { id: u.AustraliaEucla, name: "Australia/Eucla", offset: n.UTC_PLUS_8_45, timezone: s.AustralianCentralWesternStandardTime };
var qg = { id: u.AustraliaHobart, name: "Australia/Hobart", offset: n.UTC_PLUS_10, timezone: s.AustralianEasternStandardTime };
var Gg = { id: u.AustraliaLindeman, name: "Australia/Lindeman", offset: n.UTC_PLUS_10, timezone: s.AustralianEasternStandardTime };
var wg = { id: u.AustraliaLordHowe, name: "Australia/Lord_Howe", offset: n.UTC_PLUS_10_30, timezone: s.LordHoweStandardTime };
var Kg = { id: u.AustraliaMelbourne, name: "Australia/Melbourne", offset: n.UTC_PLUS_10, timezone: s.AustralianEasternStandardTime };
var xg = { id: u.AustraliaPerth, name: "Australia/Perth", offset: n.UTC_PLUS_8, timezone: s.AustralianWesternStandardTime };
var Og = { id: u.AustraliaSydney, name: "Australia/Sydney", offset: n.UTC_PLUS_10, timezone: s.AustralianEasternStandardTime };
var Hg = { id: u.EuropeAmsterdam, name: "Europe/Amsterdam", offset: n.UTC_PLUS_1, timezone: s.CentralEuropeanTime };
var jg = { id: u.EuropeAndorra, name: "Europe/Andorra", offset: n.UTC_PLUS_1, timezone: s.CentralEuropeanTime };
var Vg = { id: u.EuropeAthens, name: "Europe/Athens", offset: n.UTC_PLUS_2, timezone: s.EasternEuropeanTime };
var zg = { id: u.EuropeBelgrade, name: "Europe/Belgrade", offset: n.UTC_PLUS_1, timezone: s.CentralEuropeanTime };
var Wg = { id: u.EuropeBerlin, name: "Europe/Berlin", offset: n.UTC_PLUS_1, timezone: s.CentralEuropeanTime };
var Rg = { id: u.EuropeBratislava, name: "Europe/Bratislava", offset: n.UTC_PLUS_1, timezone: s.CentralEuropeanTime };
var Jg = { id: u.EuropeBrussels, name: "Europe/Brussels", offset: n.UTC_PLUS_1, timezone: s.CentralEuropeanTime };
var Zg = { id: u.EuropeBucharest, name: "Europe/Bucharest", offset: n.UTC_PLUS_2, timezone: s.EasternEuropeanTime };
var Yg = { id: u.EuropeBudapest, name: "Europe/Budapest", offset: n.UTC_PLUS_1, timezone: s.CentralEuropeanTime };
var $g = { id: u.EuropeBusingen, name: "Europe/Busingen", offset: n.UTC_PLUS_1, timezone: s.CentralEuropeanTime };
var Qg = { id: u.EuropeChisinau, name: "Europe/Chisinau", offset: n.UTC_PLUS_2, timezone: s.EasternEuropeanTime };
var Xg = { id: u.EuropeCopenhagen, name: "Europe/Copenhagen", offset: n.UTC_PLUS_1, timezone: s.CentralEuropeanTime };
var Cg = { id: u.EuropeDublin, name: "Europe/Dublin", offset: n.UTC_0, timezone: s.GreenwichMeanTime };
var a4 = { id: u.EuropeGibraltar, name: "Europe/Gibraltar", offset: n.UTC_PLUS_1, timezone: s.CentralEuropeanTime };
var e4 = { id: u.EuropeGuernsey, name: "Europe/Guernsey", offset: n.UTC_PLUS_1, timezone: s.CentralEuropeanTime };
var i4 = { id: u.EuropeHelsinki, name: "Europe/Helsinki", offset: n.UTC_PLUS_2, timezone: s.EasternEuropeanTime };
var n4 = { id: u.EuropeIsleOfMan, name: "Europe/Isle_of_Man", offset: n.UTC_0, timezone: s.GreenwichMeanTime };
var s4 = { id: u.EuropeIstanbul, name: "Europe/Istanbul", offset: n.UTC_PLUS_3, timezone: s.EasternEuropeanTime };
var u4 = { id: u.EuropeJersey, name: "Europe/Jersey", offset: n.UTC_PLUS_1, timezone: s.CentralEuropeanTime };
var r4 = { id: u.EuropeKaliningrad, name: "Europe/Kaliningrad", offset: n.UTC_PLUS_2, timezone: s.EasternEuropeanTime };
var t4 = { id: u.EuropeKiev, name: "Europe/Kiev", offset: n.UTC_PLUS_2, timezone: s.EasternEuropeanTime };
var l4 = { id: u.EuropeLisbon, name: "Europe/Lisbon", offset: n.UTC_0, timezone: s.GreenwichMeanTime };
var m4 = { id: u.EuropeLjubljana, name: "Europe/Ljubljana", offset: n.UTC_PLUS_1, timezone: s.CentralEuropeanTime };
var o4 = { id: u.EuropeLondon, name: "Europe/London", offset: n.UTC_0, timezone: s.GreenwichMeanTime };
var c4 = { id: u.EuropeLuxembourg, name: "Europe/Luxembourg", offset: n.UTC_PLUS_1, timezone: s.CentralEuropeanTime };
var A4 = { id: u.EuropeMadrid, name: "Europe/Madrid", offset: n.UTC_PLUS_1, timezone: s.CentralEuropeanTime };
var d4 = { id: u.EuropeMalta, name: "Europe/Malta", offset: n.UTC_PLUS_1, timezone: s.CentralEuropeanTime };
var I4 = { id: u.EuropeMariehamn, name: "Europe/Mariehamn", offset: n.UTC_PLUS_2, timezone: s.EasternEuropeanTime };
var h4 = { id: u.EuropeMinsk, name: "Europe/Minsk", offset: n.UTC_PLUS_3, timezone: s.EasternEuropeanTime };
var g4 = { id: u.EuropeMonaco, name: "Europe/Monaco", offset: n.UTC_PLUS_1, timezone: s.CentralEuropeanTime };
var f4 = { id: u.EuropeMoscow, name: "Europe/Moscow", offset: n.UTC_PLUS_3, timezone: s.EasternEuropeanTime };
var _4 = { id: u.EuropeOslo, name: "Europe/Oslo", offset: n.UTC_PLUS_1, timezone: s.CentralEuropeanTime };
var E4 = { id: u.EuropeParis, name: "Europe/Paris", offset: n.UTC_PLUS_1, timezone: s.CentralEuropeanTime };
var S4 = { id: u.EuropePodgorica, name: "Europe/Podgorica", offset: n.UTC_PLUS_1, timezone: s.CentralEuropeanTime };
var T4 = { id: u.EuropePrague, name: "Europe/Prague", offset: n.UTC_PLUS_1, timezone: s.CentralEuropeanTime };
var p4 = { id: u.EuropeRiga, name: "Europe/Riga", offset: n.UTC_PLUS_2, timezone: s.EasternEuropeanTime };
var b4 = { id: u.EuropeRome, name: "Europe/Rome", offset: n.UTC_PLUS_1, timezone: s.CentralEuropeanTime };
var v4 = { id: u.EuropeSamara, name: "Europe/Samara", offset: n.UTC_PLUS_4, timezone: s.EasternEuropeanTime };
var B4 = { id: u.EuropeSanMarino, name: "Europe/San_Marino", offset: n.UTC_PLUS_1, timezone: s.CentralEuropeanTime };
var N4 = { id: u.EuropeSarajevo, name: "Europe/Sarajevo", offset: n.UTC_PLUS_1, timezone: s.CentralEuropeanTime };
var U4 = { id: u.EuropeSimferopol, name: "Europe/Simferopol", offset: n.UTC_PLUS_3, timezone: s.EasternEuropeanTime };
var D4 = { id: u.EuropeSkopje, name: "Europe/Skopje", offset: n.UTC_PLUS_1, timezone: s.CentralEuropeanTime };
var P4 = { id: u.EuropeSofia, name: "Europe/Sofia", offset: n.UTC_PLUS_2, timezone: s.EasternEuropeanTime };
var k4 = { id: u.EuropeStockholm, name: "Europe/Stockholm", offset: n.UTC_PLUS_1, timezone: s.CentralEuropeanTime };
var M4 = { id: u.EuropeTallinn, name: "Europe/Tallinn", offset: n.UTC_PLUS_2, timezone: s.EasternEuropeanTime };
var y4 = { id: u.EuropeTirane, name: "Europe/Tirane", offset: n.UTC_PLUS_1, timezone: s.CentralEuropeanTime };
var F4 = { id: u.EuropeUzhgorod, name: "Europe/Uzhgorod", offset: n.UTC_PLUS_2, timezone: s.EasternEuropeanTime };
var L4 = { id: u.EuropeVaduz, name: "Europe/Vaduz", offset: n.UTC_PLUS_1, timezone: s.CentralEuropeanTime };
var q4 = { id: u.EuropeVatican, name: "Europe/Vatican", offset: n.UTC_PLUS_1, timezone: s.CentralEuropeanTime };
var G4 = { id: u.EuropeVienna, name: "Europe/Vienna", offset: n.UTC_PLUS_1, timezone: s.CentralEuropeanTime };
var w4 = { id: u.EuropeVilnius, name: "Europe/Vilnius", offset: n.UTC_PLUS_2, timezone: s.EasternEuropeanTime };
var K4 = { id: u.EuropeVolgograd, name: "Europe/Volgograd", offset: n.UTC_PLUS_4, timezone: s.EasternEuropeanTime };
var x4 = { id: u.EuropeWarsaw, name: "Europe/Warsaw", offset: n.UTC_PLUS_1, timezone: s.CentralEuropeanTime };
var O4 = { id: u.EuropeZagreb, name: "Europe/Zagreb", offset: n.UTC_PLUS_1, timezone: s.CentralEuropeanTime };
var H4 = { id: u.EuropeZaporozhye, name: "Europe/Zaporozhye", offset: n.UTC_PLUS_2, timezone: s.EasternEuropeanTime };
var j4 = { id: u.EuropeZurich, name: "Europe/Zurich", offset: n.UTC_PLUS_1, timezone: s.CentralEuropeanTime };
var V4 = { id: u.IndianAntananarivo, name: "Indian/Antananarivo", offset: n.UTC_PLUS_3, timezone: s.EastAfricaTime };
var z4 = { id: u.IndianChagos, name: "Indian/Chagos", offset: n.UTC_PLUS_6, timezone: s.IndianOceanTime };
var W4 = { id: u.IndianChristmas, name: "Indian/Christmas", offset: n.UTC_PLUS_7, timezone: s.ChristmasIslandTime };
var R4 = { id: u.IndianCocos, name: "Indian/Cocos", offset: n.UTC_PLUS_6, timezone: s.CocosIslandsTime };
var J4 = { id: u.IndianComoro, name: "Indian/Comoro", offset: n.UTC_PLUS_3, timezone: s.EastAfricaTime };
var Z4 = { id: u.IndianKerguelen, name: "Indian/Kerguelen", offset: n.UTC_PLUS_5, timezone: s.FrenchSouthernAndAntarcticTime };
var Y4 = { id: u.IndianMahe, name: "Indian/Mahe", offset: n.UTC_PLUS_4, timezone: s.SeychellesTime };
var $4 = { id: u.IndianMaldives, name: "Indian/Maldives", offset: n.UTC_PLUS_5, timezone: s.MaldivesTime };
var Q4 = { id: u.IndianMauritius, name: "Indian/Mauritius", offset: n.UTC_PLUS_4, timezone: s.MauritiusTime };
var X4 = { id: u.IndianMayotte, name: "Indian/Mayotte", offset: n.UTC_PLUS_3, timezone: s.EastAfricaTime };
var C4 = { id: u.IndianReunion, name: "Indian/Reunion", offset: n.UTC_PLUS_4, timezone: s.ReunionTime };
var af = { id: u.PacificApia, name: "Pacific/Apia", offset: n.UTC_PLUS_13, timezone: s.SamoaStandardTime };
var ef = { id: u.PacificAuckland, name: "Pacific/Auckland", offset: n.UTC_PLUS_13, timezone: s.NewZealandStandardTime };
var nf = { id: u.PacificChatham, name: "Pacific/Chatham", offset: n.UTC_PLUS_13, timezone: s.ChathamStandardTime };
var sf = { id: u.PacificEaster, name: "Pacific/Easter", offset: n.UTC_PLUS_6, timezone: s.EasterIslandStandardTime };
var uf = { id: u.PacificEfate, name: "Pacific/Efate", offset: n.UTC_PLUS_11, timezone: s.VanuatuTime };
var rf = { id: u.PacificEnderbury, name: "Pacific/Enderbury", offset: n.UTC_PLUS_13, timezone: s.TongaTime };
var tf = { id: u.PacificFakaofo, name: "Pacific/Fakaofo", offset: n.UTC_PLUS_13, timezone: s.TongaTime };
var lf = { id: u.PacificFiji, name: "Pacific/Fiji", offset: n.UTC_PLUS_12, timezone: s.FijiTime };
var mf = { id: u.PacificFunafuti, name: "Pacific/Funafuti", offset: n.UTC_PLUS_12, timezone: s.TuvaluTime };
var of = { id: u.PacificGalapagos, name: "Pacific/Galapagos", offset: n.UTC_PLUS_6, timezone: s.GalapagosTime };
var cf = { id: u.PacificGambier, name: "Pacific/Gambier", offset: n.UTC_PLUS_9, timezone: s.GambierIslandTime };
var Af = { id: u.PacificGuadalcanal, name: "Pacific/Guadalcanal", offset: n.UTC_PLUS_11, timezone: s.SolomonIslandsTime };
var df = { id: u.PacificGuam, name: "Pacific/Guam", offset: n.UTC_PLUS_10, timezone: s.ChamorroStandardTime };
var If = { id: u.PacificHonolulu, name: "Pacific/Honolulu", offset: n.UTC_PLUS_10, timezone: s.HawaiiAleutianStandardTime };
var hf = { id: u.PacificJohnston, name: "Pacific/Johnston", offset: n.UTC_PLUS_10, timezone: s.HawaiiAleutianStandardTime };
var gf = { id: u.PacificKiritimati, name: "Pacific/Kiritimati", offset: n.UTC_PLUS_14, timezone: s.LineIslandsTime };
var ff = { id: u.PacificKosrae, name: "Pacific/Kosrae", offset: n.UTC_PLUS_11, timezone: s.KosraeTime };
var _f = { id: u.PacificKwajalein, name: "Pacific/Kwajalein", offset: n.UTC_PLUS_12, timezone: s.MarshallIslandsTime };
var Ef = { id: u.PacificMajuro, name: "Pacific/Majuro", offset: n.UTC_PLUS_12, timezone: s.MarshallIslandsTime };
var Sf = { id: u.PacificMarquesas, name: "Pacific/Marquesas", offset: n.UTC_PLUS_9, timezone: s.MarquesasIslandsTime };
var Tf = { id: u.PacificMidway, name: "Pacific/Midway", offset: n.UTC_PLUS_11, timezone: s.SamoaStandardTime };
var pf = { id: u.PacificNauru, name: "Pacific/Nauru", offset: n.UTC_PLUS_12, timezone: s.NauruTime };
var bf = { id: u.PacificNiue, name: "Pacific/Niue", offset: n.UTC_PLUS_11, timezone: s.NiueTime };
var vf = { id: u.PacificNorfolk, name: "Pacific/Norfolk", offset: n.UTC_PLUS_11, timezone: s.NorfolkIslandTime };
var Bf = { id: u.PacificNoumea, name: "Pacific/Noumea", offset: n.UTC_PLUS_11, timezone: s.NewCaledoniaTime };
var Nf = { id: u.PacificPagoPago, name: "Pacific/Pago_Pago", offset: n.UTC_PLUS_11, timezone: s.SamoaStandardTime };
var Uf = { id: u.PacificPalau, name: "Pacific/Palau", offset: n.UTC_PLUS_9, timezone: s.PalauTime };
var Df = { id: u.PacificPitcairn, name: "Pacific/Pitcairn", offset: n.UTC_PLUS_8, timezone: s.PitcairnTime };
var Pf = { id: u.PacificPonape, name: "Pacific/Ponape", offset: n.UTC_PLUS_11, timezone: s.PohnpeiStandardTime };
var kf = { id: u.PacificPortMoresby, name: "Pacific/Port_Moresby", offset: n.UTC_PLUS_10, timezone: s.PapuaNewGuineaTime };
var Mf = { id: u.PacificRarotonga, name: "Pacific/Rarotonga", offset: n.UTC_PLUS_10, timezone: s.CookIslandTime };
var yf = { id: u.PacificSaipan, name: "Pacific/Saipan", offset: n.UTC_PLUS_10, timezone: s.ChamorroStandardTime };
var Ff = { id: u.PacificTahiti, name: "Pacific/Tahiti", offset: n.UTC_PLUS_10, timezone: s.TahitiTime };
var Lf = { id: u.PacificTarawa, name: "Pacific/Tarawa", offset: n.UTC_PLUS_12, timezone: s.GilbertIslandTime };
var qf = { id: u.PacificTongatapu, name: "Pacific/Tongatapu", offset: n.UTC_PLUS_13, timezone: s.TongaTime };
var Gf = { id: u.PacificChuuk, name: "Pacific/Chuuk", offset: n.UTC_PLUS_10, timezone: s.ChuukTime };
var wf = { id: u.PacificPohnpei, name: "Pacific/Pohnpei", offset: n.UTC_PLUS_11, timezone: s.PohnpeiStandardTime };
var Kf = { id: u.PacificYap, name: "Pacific/Yap", offset: n.UTC_PLUS_10, timezone: s.ChuukTime };
var ye = (a = 21) => {
  let l = "", c = crypto.getRandomValues(new Uint8Array(a));
  for (; a--; ) {
    let A = c[a] & 63;
    A < 36 ? l += A.toString(36) : A < 62 ? l += (A - 26).toString(36).toUpperCase() : A < 63 ? l += "_" : l += "-";
  }
  return l;
};
var Ai = [{ property: "name", enumerable: false }, { property: "message", enumerable: false }, { property: "stack", enumerable: false }, { property: "code", enumerable: true }];
var y = Symbol(".toJSON was called");
var di = (a) => {
  a[y] = true;
  let l = a.toJSON();
  return delete a[y], l;
};
var Fe = ({ from: a, seen: l, to_: c, forceEnumerable: A, maxDepth: o, depth: I }) => {
  let d = c || (Array.isArray(a) ? [] : {});
  if (l.push(a), I >= o)
    return d;
  if (typeof a.toJSON == "function" && a[y] !== true)
    return di(a);
  for (let [g, E] of Object.entries(a)) {
    ...
    if (typeof E != "function") {
      ...
      if (!l.includes(a[g])) {
        I++, d[g] = Fe({ from: a[g], seen: [...l], forceEnumerable: A, maxDepth: o, depth: I });
        continue;
      }
      d[g] = "[Circular]";
    }
  }
  for (let { property: g, enumerable: E } of Ai)
    typeof a[g] == "string" && Object.defineProperty(d, g, { value: a[g], enumerable: A ? true : E, configurable: true, writable: true });
  return d;
};
function Le(a, l = {}) {
  let { maxDepth: c = Number.POSITIVE_INFINITY } = l;
  return typeof a == "object" && a !== null ? Fe({ from: a, seen: [], forceEnumerable: true, maxDepth: c, depth: 0 }) : typeof a == "function" ? `[Function: ${a.name || "anonymous"}]` : a;
}
var b;
(function(a) {
...
var D = class extends Error {
  constructor(l, c) {
    ...
    if (this.__proto__ = A, Error.captureStackTrace && Error.captureStackTrace((o = c == null ? void 0 : c.cause) != null ? o : this, D), this.id = ye(), this.name = this.constructor.name, this.created = new Date().toString(), this.description = (I = c == null ? void 0 : c.description) != null ? I : this.description, this.remediation = (d = c == null ? void 0 : c.remediation) != null ? d : this.remediation, this.scope = (g = c == null ? void 0 : c.scope) != null ? g : this.scope, c) {
      let { cause: E, context: Je, data: Ze, model: Ye, form: $e, origin: Qe, pii: Xe, request: Ce, response: ai, tags: ei, task: ii, user: ni } = c;
...
var N = L(We(), 1);
function Si(a, l) {
  return Object.entries(l).filter((A) => {
    if (!A)
      return false;
    let o = A[0];
    if (!Object.values(i).includes(o))
      throw new k(`Configuration property "${A[0]}" is not supported.`, {});
    return true;
  }).map(([A, o]) => {
    let I = (d, g) => ({ condition: d, message: Ti(d, g), value: a });
    switch (A) {
      case i.IsRequired:
        if (typeof o != "boolean")
      ...
      case i.HasLetterCount:
        {
          ...
          let d = new N.default();
          if (o === 0 || o === false ? d.has().not().letters() : d.has().letters(o), !a || typeof a != "string" || !d.validate(a))
            return I(A, { requirement: o });
        }
        break;
      case i.HasLowercaseCount:
        {
          ...
          let d = new N.default();
          if (o === 0 ? d.has().not().lowercase() : d.has().lowercase(o), !a || typeof a != "string" || !d.validate(a))
            return I(A, { requirement: o });
        }
        break;
      case i.HasNumberCount:
        {
          ...
          let d = new N.default();
          if (o === 0 ? d.has().not().digits() : d.has().digits(o), !a || typeof a != "string" || !d.validate(a))
            return I(A, { requirement: o });
        }
        break;
      case i.HasSymbolCount:
        {
          ...
          let d = new N.default();
          if (o === 0 ? d.has().not().symbols() : d.has().symbols(o), !a || typeof a != "string" || !d.validate(a))
            return I(A, { requirement: o });
        }
        break;
      case i.HasUppercaseCount:
        {
          ...
          let d = new N.default();
          if (o === 0 ? d.has().not().uppercase() : d.has().uppercase(o), !a || typeof a != "string" || !d.validate(a))
            return I(A, { requirement: o });
        }
        break;
...
function Ti(a, l) {
  switch (a) {
    ...
    case i.IsAfter:
      return { long: `Value is not after ${l == null ? void 0 : l.requirement}`, short: `Is not after ${l == null ? void 0 : l.requirement}` };
    case i.IsAfterOrEqual:
      return { long: `Value is not after or equal to ${l == null ? void 0 : l.requirement}`, short: `Is not equal or after ${l == null ? void 0 : l.requirement}` };
    case i.IsAirport:
    ...
    case i.IsBefore:
      return { long: `Value is not before ${l == null ? void 0 : l.requirement}.`, short: `Not before ${l == null ? void 0 : l.requirement}` };
    case i.IsBeforeOrAfter:
      return { long: `Value is not before or after ${l == null ? void 0 : l.requirement}.`, short: `Not before or after to ${l == null ? void 0 : l.requirement}` };
    case i.IsBeforeOrEqual:
      return { long: `Value is not before or equal to${l == null ? void 0 : l.requirement}.`, short: `Not before or equal to ${l == null ? void 0 : l.requirement}` };
    case i.IsBetween:
      return { long: `Value is not between ${l == null ? void 0 : l.requirement}.`, short: `Value is not between ${l == null ? void 0 : l.requirement}` };
    case i.IsBIC:
    ...
    case i.IsDivisibleBy:
      return { long: `Not divisible by ${l == null ? void 0 : l.requirement}.`, short: `Not divisible by ${l == null ? void 0 : l.requirement}` };
    case i.IsDomainName:
    ...
    case i.IsEqual:
      return { long: `Value is not equal to ${l == null ? void 0 : l.requirement}.`, short: `Not equal to ${l == null ? void 0 : l.requirement}` };
    case i.IsEvenNumber:
    ...
    case i.IsGreaterThan:
      return { long: `Value is not greater than ${l == null ? void 0 : l.requirement}.`, short: `Not greater than ${l == null ? void 0 : l.requirement}` };
    case i.IsGreaterThanOrEqual:
      return { long: `Value is not greater than or equal to ${l == null ? void 0 : l.requirement}`, short: `Not greater or equal to ${l == null ? void 0 : l.requirement}` };
    case i.IsHSLColor:
    ...
    case i.IsInIPAddressRange:
      return { long: `Value is not within ${l == null ? void 0 : l.requirement} IP range`, short: "Not in IP range" };
    case i.IsInList:
    ...
    case i.IsLengthEqual:
      return { long: `Length of value is not equal to ${l == null ? void 0 : l.requirement}.`, short: `Length not equal to ${l == null ? void 0 : l.requirement}` };
    case i.IsLengthGreaterThan:
      return { long: `Length of value is not greater than ${l == null ? void 0 : l.requirement}.`, short: "Not long enough" };
    case i.IsLengthGreaterThanOrEqual:
      return { long: `Length of value is not greater than or equal to ${l == null ? void 0 : l.requirement}.`, short: "Not long enough" };
    case i.IsLengthLessThan:
      return { long: `Length of value is not less than ${l == null ? void 0 : l.requirement}.`, short: "Too long" };
    case i.IsLengthLessThanOrEqual:
      return { long: `Length of value is not less than or equal to ${l == null ? void 0 : l.requirement}.`, short: "Too long" };
    case i.IsLessThan:
      return { long: `Value is not less than ${l == null ? void 0 : l.requirement}.`, short: `Not less than ${l == null ? void 0 : l.requirement}` };
    case i.IsLessThanOrEqual:
      return { long: `Value is not less than or equal to ${l == null ? void 0 : l.requirement}.`, short: `Not less or equal to ${l == null ? void 0 : l.requirement}` };
    ...
    case i.IsNotEqual:
      return { long: `Value is equal to ${l == null ? void 0 : l.requirement}.`, short: `Can't be equal to ${l == null ? void 0 : l.requirement}` };
...
export {
  pi as objectHasProperty,
  Si as validate
};
//# sourceMappingURL=@srclaunch_validation.js.map
