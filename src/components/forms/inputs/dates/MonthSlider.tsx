...
const MonthSlider = memo((): ReactElement => {
  ...
  return (
    <Container data-testid="month-slider">
      <Content>
        <Month>
          <OverflowContainer>
            <PreviousMonth />
            {/* <CurrentMonth>{selectedDate.format('MMMM YYYY')}</CurrentMonth> */}
            <NextMonth />
          </OverflowContainer>
        </Month>
        <NavButton
        ...
        >
          <Icon name={BasicIcons.ChevronRight} />
        </NavButton>
        <NavButton
          className="next"
          onClick={() => {
