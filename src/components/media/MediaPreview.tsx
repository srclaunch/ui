...
import { Align, Amount, BackgroundColors, BackgroundSize, Orientation, Overflow } from '../../types';
...
export const MediaPreview = memo(
  ({ borderRadius = Amount.Less, className= '', height = 220, media, orientation = Orientation.Vertical, ...props }: MediaPreviewProps): ReactElement => {
